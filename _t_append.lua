...
t("spell", "sortilège", "talent category")
t("horror spells", "sortilèges d'horreur", "talent type")
...
t([[Une morsure sauvage qui inflige %d%% de dégâts d'arme, réduit les soins reçus par la cible de %d%%, et provoque un saignement de %d%% de dégâts d'arme sur 5 tours.
		Utilisable uniquement en état de frénésie.]], [[Une morsure sauvage qui inflige %d%% de dégâts d'arme, réduit les soins reçus par la cible de %d%%, et provoque un saignement de %d%% de dégâts d'arme sur 5 tours.
...
t([[Bondit vers une cible à portée.
		Utilisable uniquement en état de frénésie.]], [[Bondit vers une cible à portée.
		Utilisable uniquement en état de frénésie.]], "tformat")
...
t([[Mord la cible pour %d%% de dégâts d'arme, provoquant potentiellement un saignement de %d%% de dégâts d'arme sur cinq tours.
		...
		La frénésie augmente la vitesse globale de %d%%, les chances de critique physique de %d%%, et empêche la mort jusqu'à -%d%% de vie.]], [[Mord la cible pour %d%% de dégâts d'arme, provoquant potentiellement un saignement de %d%% de dégâts d'arme sur cinq tours.
		Si la cible est affectée par le saignement, cela plonge le dévoreur dans une frénésie pour %d tours (ce qui, à son tour, plonge les autres dévoreurs proches dans la frénésie).
...
t("Abyssal Shroud", "Linceul abyssal", "talent name")
...
t("Not enough space to summon!", "Pas assez d'espace pour invoquer !", "logPlayer")
...
t([[Invoque une tempête de lames tourbillonnantes pour trancher vos ennemis, infligeant %d dégâts physiques et un saignement à quiconque s'approche pendant %d tours.
		Les dégâts et la durée augmentent avec votre Puissance Mentale.]], [[Invoque une tempête de lames tourbillonnantes pour trancher vos ennemis, infligeant %d dégâts physiques et un saignement à quiconque s'approche pendant %d tours.
		Les dégâts et la durée augmentent avec votre Puissance Mentale.]], "tformat")
t("Psionic Pull", "Attraction psionique", "talent name")
t("%s is pulled in!", "%s est attiré !", "logSeen")
t([[Attire tous les ennemis vers vous dans un rayon de 5 tout en infligeant %d dégâts physiques.
		Les dégâts augmentent avec votre puissance mentale.]], [[Attire tous les ennemis vers vous dans un rayon de 5 tout en infligeant %d dégâts physiques.
		Les dégâts augmentent avec votre puissance mentale.]], "tformat")
t("Razor Knife", "Couteau-rasoir", "talent name")
t([[Lance un couteau avec une intensité extrême infligeant %0.2f dégâts physiques à toutes les cibles en ligne.
		Les dégâts augmentent avec votre Puissance Mentale]], [[Lance un couteau avec une intensité extrême infligeant %0.2f dégâts physiques à toutes les cibles en ligne.
		Les dégâts augmentent avec votre Puissance Mentale]], "tformat")
t("Slime Wave", "Vague de limon", "talent name")
t([[Un mur de limon suinte du lanceur avec un rayon de 1, augmentant une fois tous les deux tours jusqu'à un rayon maximum de %d, infligeant %0.2f dégâts de limon pendant %d tours.
		Les dégâts et la durée augmentent avec votre Puissance Mentale.]], [[Un mur de limon suinte du lanceur avec un rayon de 1, augmentant une fois tous les deux tours jusqu'à un rayon maximum de %d, infligeant %0.2f dégâts de limon pendant %d tours.
		Les dégâts et la durée augmentent avec votre Puissance Mentale.]], "tformat")
t("Tentacle Grab", "Saisie tentaculaire", "talent name")
t("%s resists the grab!", "%s résiste à la saisie !", "logSeen")
t([[Attrape une cible et la traîne à vos côtés, la maintenant en place et réduisant au silence les non-morts-vivants et les créatures ayant besoin de respirer pendant %d tours.
		La saisie inflige également %0.2f dégâts de limon par tour.
		Les dégâts augmentent avec votre Puissance Mentale.]], [[Attrape une cible et la traîne à vos côtés, la maintenant en place et réduisant au silence les non-morts-vivants et les créatures ayant besoin de respirer pendant %d tours.
		La saisie inflige également %0.2f dégâts de limon par tour.
		Les dégâts augmentent avec votre Puissance Mentale.]], "tformat")
t("Ooze Spit", "Crachat de vase", "talent name")
t([[Crache de la vase sur votre cible, infligeant %0.2f dégâts de nature et la ralentissant de 30%% pendant 3 tours.
		Les dégâts augmentent avec la statistique Dextérité]], [[Crache de la vase sur votre cible, infligeant %0.2f dégâts de nature et la ralentissant de 30%% pendant 3 tours.
		Les dégâts augmentent avec la statistique Dextérité]], "tformat")
...
t("Not enough space to invoke!", "Pas assez d'espace pour invoquer !", "logPlayer")
...
t([[Lance une vague d'eau tout autour de vous avec un rayon de %d, rendant toutes les créatures Trempées pendant 10 tours.
		Les dégâts augmentent avec votre Puissance Magique.]], [[Lance une vague d'eau tout autour de vous avec un rayon de %d, rendant toutes les créatures Trempées pendant 10 tours.
		Les dégâts augmentent avec votre Puissance Magique.]], "tformat")
...
t([[S'agrippe à la cible et suce son sang, infligeant %0.2f dégâts physiques et %0.2f dégâts d'acide par tour.
...
Ses effets augmentent avec votre attribut %s.", "tformat")
t("Infusion: Regeneration", "Infusion : Régénération", "talent name")
t("Activate the infusion to heal yourself for %d life over %d turns.", "Active l'infusion pour vous soigner de %d vie sur %d tours.", "tformat")
t("heal %d; %d cd", "soin : %d; rec. : %d", "tformat")
t("Infusion: Healing", "Infusion : Soin", "talent name")
t("Activate the infusion to instantly heal yourself for %d then cleanse 1 wound, poison, and disease effect.", "Active l'infusion pour vous soigner instantanément de %d puis supprimer 1 effet de blessure, poison et maladie.", "tformat")
t("heal %d; cd %d", "soin : %d; rec. : %d", "tformat")
t("Infusion: Wild", "Infusion : Sauvage", "talent name")
...
Also removes cross-tier effects of the affected types for free.]], [[Active l'infusion pour vous débarrasser d'un effet %s aléatoire et réduire tous les dégâts subis de %d%% pendant %d tours.
Supprime également les effets trans-palier du type correspondant.]], "tformat")
t("res %d%%; %s; dur %d; cd %d", "résistance : %d%%; %s; durée : %d; rec. : %d", "tformat")
t("Infusion: Primal", "Infusion : Primale", "talent name")
t("Activate the infusion to heal for %d%% of all damage taken (calculated before resistances) and reduce the duration of a random debuff by %d each turn for %d turns.", "Active l'infusion pour vous soigner de %d%% de tous les dégâts subis (calculé avant les résistances) et réduire la durée d'un malus aléatoire de %d à chaque tour pendant %d tours.", "tformat")
t("affinity %d%%; reduction %d; dur %d; cd %d", "affinité : %d%%; réduction : %d; durée : %d; rec. : %d", "tformat")
t("Infusion: Movement", "Infusion : Mouvement", "talent name")
t([[Activate the infusion to increase movement speed by %d%% for 1 game turn.
		...
		Note: since you will be moving very fast, game turns will pass very slowly.]], [[Active l'infusion pour augmenter la vitesse de déplacement de %d%% pendant 1 tour de jeu.
		Vous gagnez 100%% d'immunité à l'étourdissement, à l'hébètement et à l'immobilisation pendant l'effet.
...
t("speed %d%%; cd %d", "vitesse : %d%%; rec. : %d", "tformat")
t("Infusion: Heroism", "Infusion : Héroïsme", "talent name")
t([[Activate the infusion to endure even the most grievous of wounds for %d turns.
		...
		If your life is below 0 when this effect wears off it will be set to 1.]], [[Active l'infusion pour endurer même les blessures les plus graves pendant %d tours.
...
t("die at -%d; dur %d; cd %d", "mort à -%d; durée : %d; rec. : %d", "tformat")
t("Infusion: Wild Growth", "Infusion : Croissance Sauvage", "talent name")
t([[Causes thick vines to spring from the ground and entangle all targets within %d squares for %d turns, pinning them in place for 5 turns and dealing %0.2f physical damage and %0.2f nature damage.
		...
		Les vignes poussent également autour de vous, augmentant votre armure de %d et la solidité de l'armure de %d.]], "tformat")
...
t("range %d; cd %d", "portée : %d; rec. : %d", "tformat")
...
t("absorb %d; dur %d; cd %d", "absorbe : %d; durée : %d; rec. : %d", "tformat")
...
t("absorb and reflect %d; dur %d; cd %d", "absorbe et réfléchit : %d; durée : %d; rec. : %d", "tformat")
...
t("damage %d; dur %d; cd %d", "dégâts : %d; durée : %d; rec. : %d", "tformat")
...
t("Rune: Manasurge", "Rune : Surcharge de Mana", "talent name")
...
t([[Activate the rune to unleash a manasurge upon yourself, increasing mana regeneration by %d%% for %d turns (%d total) and instantly restoring %d mana.
			Also when resting your mana will regenerate at 0.5 per turn.]], [[Active la rune pour déclencher une surcharge de mana sur vous-même, augmentant la régénération de mana de %d%% pendant %d tours (%d au total) et restaurant instantanément %d mana.
			De plus, lorsque vous vous reposez, votre mana se régénérera à 0.5 par tour.]], "tformat")
t("regen %d%% over %d turns; mana %d; cd %d", "régén. : %d%% sur %d tours; mana : %d; rec. : %d", "tformat")
t("Rune of the Rift", "Rune de Faille", "talent name")
...
t("Rune: Blink", "Rune : Translocateur", "talent name")
...
t("range %d; phase %d; cd %d", "portée : %d; phase : %d; rec. : %d", "tformat")
...
t("power %d; resist %d%%; move %d%%; dur %d; cd %d", "puissance : %d; résistance : %d%%; vitesse : %d%%; durée : %d; rec. : %d", "tformat")
t("Rune: Stormshield", "Rune : Bouclier de Tempête", "talent name")
...
t("threshold %d; blocks %d; dur %d; cd %d", "seuil : %d; blocages : %d; durée : %d; rec. : %d", "tformat")
...
t("You cannot summon; you are suppressed!", "Vous ne pouvez pas invoquer ; vous êtes supprimé !", "logPlayer")
...
t([[Activate the rune to create up to 3 images of yourself that taunt nearby enemies each turn and immediately after being summoned.
			...
			Les images héritent de toute votre vie, résistance, armure, défense et solidité d'armure.]], "tformat")
t("dur %d; cd %d", "durée : %d; rec. : %d", "tformat")
t("Rune: Shatter Afflictions", "Rune : Brise-Afflictions", "talent name")
...
t("absorb %d; cd %d", "absorbe : %d; rec. : %d", "tformat")
t("Rune: Dissipation", "Rune : Dissipation", "talent name")
t("Activate the rune to remove 8 beneficial magical sustains from an enemy target or all magical debuffs from you.", "Active la rune pour retirer 8 sustens magiques bénéfiques d'une cible ennemie ou tous les malus magiques de vous.", "tformat")
t("Taint: Devourer", "Impureté : Dévoreur", "talent name")
t("Activate the taint on a foe, removing up to %d magical or physical effects or sustains from it and healing you for %d for each effect.", "Active l'impureté sur un ennemi, lui retirant jusqu'à %d effets ou sustens magiques ou physiques et vous soignant de %d pour chaque effet.", "tformat")
t("%d effects / %d heal", "effets : %d / soin : %d", "tformat")
t("Taint: Purging", "Impureté : Purge", "talent name")
t([[Activate the taint to purge your body of physical afflictions for %d turns.
			Each turn the purge will attempt to cleanse 1 physical debuff from you, and if one is removed, increase its duration by 1.]], [[Active l'impureté pour purger votre corps des afflictions physiques pendant %d tours.
			À chaque tour, la purge tentera de supprimer 1 malus physique de vous et, si l'un est supprimé, augmentera sa durée de 1.]], "tformat")
t("%d turns", "tours : %d", "tformat")
t("Infusion: Sun", "Infusion : Soleil", "talent name")
t([[Activate the infusion to brighten the area in a radius of %d and illuminate stealthy creatures, possibly revealing them (reduces stealth power by %d).%s
		It will also blind any creatures caught inside (power %d) for %d turns.]], [[Active l'infusion pour illuminer la zone dans un rayon de %d et éclairer les créatures furtives, les révélant potentiellement (réduit le pouvoir de furtivité de %d).%s
...
t("Taint: Telepathy", "Impureté : Télépathie", "talent name")
...
t("Infusion: Insidious Poison", "Infusion : Venin Insidieux", "talent name")
t([[Activate the infusion to spit a bolt of poison doing %0.2f nature damage per turn for 7 turns, and reducing the target's healing received by %d%%.
		The sudden stream of natural forces also strips you of one random detrimental magical effect.]], [[Active l'infusion pour cracher un rayon de venin infligeant %0.2f dégâts de Nature par tour pendant 7 tours et réduisant le soin reçu par la cible de %d%%.
...
t("The various racial bonuses a character can have.", "Les divers bonus raciaux qu'un personnage peut avoir.", "_t")
t("inscriptions", "inscriptions", "talent category")
t("infusions", "infusions", "talent type")
t("Infusions are not class abilities, you must find them or learn them from other people.", "Les infusions ne sont pas des capacités de classe, vous devez les trouver ou les apprendre auprès d'autres personnes.", "_t")
...
t("taints", "impuretés", "talent type")
t("Taints are not class abilities, you must find them or learn them from other people.", "Les impuretés ne sont pas des capacités de classe, vous devez les trouver ou les apprendre auprès d'autres personnes.", "_t")
...
t("Positive Pool", "Réserve d'É. Positive ", "talent name")
t("Negative Pool", "Réserve d'É. Négative ", "talent name")
...
t("Timeport: Point Zero", "Tempoportation : Point Zéro", "talent name")
t([[Allows a chronomancer to timeport to Point Zero.
	...
	Vous avez étudié la chronomance là-bas et avez reçu un sort de portail spécial pour vous téléporter en retour.
	Ce sort doit être gardé secret ; il ne doit jamais être utilisé à vue de témoins non initiés.
	Le sort prend 40 tours pour s'activer, et vous devez être hors de vue de toute autre créature lorsque vous le lancez et lorsque la tempoportation prend effet.]], "_t")
...
t([[Not the Master himself, nor all the orcs in fallen Reknor, nor even the terrifying unknown beyond Reknor's portal could slow your pursuit of the Staff of Absorption.
		...
		%s]], "tformat")
t("Teleport to the ground", "Téléportation vers la Surface", "talent name")
...
t("Mana Gale", "Rafale de Mana", "talent name")
...
t("Telekinetic Punt", "Coup Télékinétique", "talent name")
t("%s is knocked back by the telekinetic blow!", "%s est repoussé par le coup télékinétique !", "logSeen")
t("%s holds its ground!", "%s tient bon !", "logSeen")
t("Knock the target backwards with a powerful telekinetic blow.", "Repousse la cible en arrière avec un puissant coup télékinétique.", "tformat")
t("Blink", "Téléportation", "talent name")
...
t("chronomancy", "chronomance", "talent category")
t("spell", "sort", "talent category")
t("corruption", "corruption", "talent category")
t("wild-gift", "don sauvage", "talent category")
t("psionic", "psiônique", "talent category")
t("other", "autre", "talent category")
...
t("Crawl onto the target, doing %d%% damage and covering it in poison.", "Rampe vers la cible, lui infligeant %d%% de dégâts et la recouvrant de venin.", "tformat")
t("Acidic Crawl", "Rampement Acide", "talent name")
t("@Source@ envelops @target@ with acid.", "@Source@ enveloppe @target@ d'acide.", "_t")
t("Crawl onto the target, covering it in acid.", "Rampe vers la cible, la recouvrant d'acide.", "tformat")
...
t("Releases poisonous spores at the target, doing %d%% damage and poisoning it.", "Libère des spores vénéneux sur la cible, lui infligeant %d%% de dégâts et l'empoisonnant.", "tformat")
t("Stun", "Étourdissement", "talent name")
t("%s resists the stunning blow!", "%s résiste au coup étourdissant !", "logSeen")
t([[Hits the target doing %d%% damage. If the attack hits, the target is stunned for %d turns.
		The chance to stun improves with your Physical Power.]], [[Frappe la cible, infligeant %d%% de dégâts. Si l'attaque touche, la cible est étourdissante pendant %d tours.
		La chance d'étourdir s'améliore avec votre Puissance physique.]], "tformat")
t("Disarm", "Désarmer", "talent name")
t("%s resists the blow!", "%s résiste au coup !", "logSeen")
t("Hits the target doing %d%% damage and trying to disarm the target for %d turns. The chance improves with your Physical Power.", "Frappe la cible, infligeant %d%% de dégâts et tentant de la désarmer pendant %d tours. La chance s'améliore avec votre Puissance physique.", "tformat")
...
t([[Hits the target doing %d%% damage. If the attack hits, the target is constricted for %d turns.
		The constriction power improves with your Physical Power.]], [[Frappe la cible, infligeant %d%% de dégâts. Si l'attaque touche, la cible est constrictée pendant %d tours.
		La puissance de constriction s'améliore avec votre Puissance physique.]], "tformat")
t("Knockback", "Repoussage", "talent name")
t("%s resists the knockback!", "%s résiste au repoussage !", "logSeen")
t("Hits the target with your weapon doing %d%% damage. If the attack hits, the target is knocked back up to 4 grids.  The chance improves with your Physical Power.", "Frappe la cible avec votre arme, infligeant %d%% de dégâts. Si l'attaque touche, la cible est repoussée jusqu'à 4 cases. La chance s'améliore avec votre Puissance physique.", "tformat")
...
t("Bites the target (an unarmed attack), doing %d%% damage and injecting it with poison.", "Mord la cible (une attaque à mains nues), lui infligeant %d%% de dégâts et lui injectant du venin.", "tformat")
...
t("Rotting Disease", "Maladie Pourrissante", "talent name")
...
t("Hits the target doing %d%% damage. If the attack hits, the target is afflicted with a disease, inflicting %0.2f blight damage per turn for %d turns and reducing constitution by 10%% + 4.  The disease damage increases with your Strength, and the chance to apply it increases with your Physical Power.", "Frappe la cible, infligeant %d%% de dégâts. Si l'attaque touche, la cible est affectée par une maladie, infligeant %0.2f dégâts de Maladie par tour pendant %d tours et réduisant la Constitution de 10%% + 4. Les dégâts de la maladie augmentent avec votre Force, et la chance de l'appliquer augmente avec votre Puissance physique.", "tformat")
t("Decrepitude Disease", "Maladie de Décrépitude", "talent name")
t("Hits the target doing %d%% damage. If the attack hits, the target is afflicted with a disease, inflicting %0.2f blight damage per turn for %d turns and reducing dexterity by 10%% + 4.  The disease damage increases with your Strength, and the chance to apply it increases with your Physical Power.", "Frappe la cible, infligeant %d%% de dégâts. Si l'attaque touche, la cible est affectée par une maladie, infligeant %0.2f dégâts de Maladie par tour pendant %d turns et réduisant la Dextérité de 10%% + 4. Les dégâts de la maladie augmentent avec votre Force, et la chance de l'appliquer augmente avec votre Puissance physique.", "tformat")
t("Weakness Disease", "Maladie de Faiblesse", "talent name")
t("Hits the target doing %d%% damage. If the attack hits, the target is afflicted with a disease, inflicting %0.2f blight damage per turn for %d turns and reducing strength by 10%% + 4.  The disease damage increases with your Strength, and the chance to apply it increases with your Physical Power.", "Frappe la cible, infligeant %d%% de dégâts. Si l'attaque touche, la cible est affectée par une maladie, infligeant %0.2f dégâts de Maladie par tour pendant %d tours et réduisant la Force de 10%% + 4. Les dégâts de la maladie augmentent avec votre Force, et la chance de l'appliquer augmente avec votre Puissance physique.", "tformat")
...
t([[Hurl ice shard at the target dealing %0.2f ice damage.
		...
		Les dégâts augmentent avec votre Puissance des sorts.]], "tformat")
t("Blight Bolt", "Rayon de Maladie", "talent name")
t([[Projects a bolt of pure blight, doing %0.2f blight damage.
		This spell has an improved critical strike chance of +%0.2f%%.
		The damage will increase with your Spellpower.]], [[Projette un rayon de maladie pure, infligeant %0.2f dégâts de Maladie.
...
t([[Call upon the forces of nature to regenerate your body for %d life every turn for 10 turns.
		...
		Le soin augmente avec votre Puissance des sorts.]], "tformat")
t("Grab", "Saisie", "talent name")
t("%s resists the grab!", "%s résiste à la saisie !", "logSeen")
t("Hits the target doing %d%% damage; if the attack hits, the target is pinned to the ground for %d turns.  The chance to pin improves with Physical Power.", "Frappe la cible, infligeant %d%% de dégâts ; si l'attaque touche, la cible est immobilisée au sol pendant %d tours. La chance d'immobiliser s'améliore avec la Puissance physique.", "tformat")
...
t([[Spit poison at your target, doing %0.2f poison damage over six turns.
		...
		Les dégâts augmentent avec votre Force ou Dextérité (selon la plus élevée).]], "tformat")
...
t([[Strike your target with poison, doing %0.2f poison damage over six turns.
		...
		Les dégâts augmentent avec votre puissance mentale.]], "tformat")
t("Spit Blight", "Cracher la Maladie", "talent name")
t([[Spit blight at your target doing %0.2f blight damage.
		The damage will increase with your Magic.]], [[Crache de la maladie sur votre cible, lui infligeant %0.2f dégâts de Maladie.
		Les dégâts augmentent avec votre Magie.]], "tformat")
...
t("Throw Bones", "Lancer des Os", "talent name")
t([[Throws a pack of bones at your target doing %0.2f physical damage as bleeding within radius %d.
		...
		Les dégâts augmentent avec votre Force.]], "tformat")
...
t("Throw Boulder", "Lancer un Rocher", "talent name")
...
t("Hits the target with a mighty blow to the legs doing %d%% weapon damage. If the attack hits, the target is unable to move for %d turns.", "Frappe la cible d'un puissant coup aux jambes, infligeant %d%% de dégâts. Si l'attaque touche, la cible sera incapable de se déplacer pendant %d tours.", "tformat")
...
t([[Sends a telekinetic attack, knocking back the target up to 3 grids and doing %0.2f physical damage.
		...
		Les dégâts augmentent avec la Puissance mentale.]], "tformat")
t("Blightzone", "Zone de Maladie", "talent name")
t([[Corrupted vapour rises at the target location (radius 4) doing %0.2f blight damage every turn for %d turns.
		The damage increases with Spellpower.]], [[De la vapeur corrompue s'élève à l'emplacement cible (rayon 4), infligeant %0.2f dégâts de Maladie à chaque tour pendant %d tours.
		Les dégâts augmentent avec la Puissance des sorts.]], "tformat")
...
t("Fire a slow bolt of a random element for %d damage. Damage increases with the magic stat.", "Tire un rayon lent d'un élément aléatoire, infligeant %d dégâts. Les dégâts augmentent avec l'attribut Magie.", "tformat")
...
t("Dredge Frenzy", "Frénésie des Dragas", "talent name")
...
t("Sever Lifeline", "Couper la Ligne de Vie", "talent name")
...
t([[Engulf yourself in a surge of mana, quickly restoring %d mana every turn for 10 turns.
		...
		Le mana restauré augmente avec votre Puissance des sorts.]], "tformat")
...
t([[Imbues your body with natural energies, healing for %d life.
		...
		Le soin augmente avec votre Puissance mentale.]], "tformat")
...
t("You fade from sight, making you invulnerable until the beginning of your next turn.", "Vous disparaissez de la vue, vous rendant invulnérable jusqu'au début de votre prochain tour.", "tformat")
...
t("With blinding speed you suddenly appear next to a target up to %d spaces away and attack for %d%% damage.", "Avec une vitesse aveuglante, vous apparaissez soudainement à côté d'une cible jusqu'à %d cases de distance et attaquez pour %d%% de dégâts.", "tformat")
...
t([[Grab a target and pull it next to you, covering it with frost while reducing its movement speed by 50%% for %d turns.
		...
		Les dégâts et la chance de ralentir augmentent avec votre Puissance des sorts.]], "tformat")
...
t([[A punch to the body that deals %d%% damage, drains %d of the target's stamina per combo point, and dazes the target for %d to %d turns, depending on the amount of combo points you've accumulated.
		...
		Using this talent removes your combo points.]], [[Un coup au corps qui inflige %d%% de dégâts, draine %d d'endurance par point de combo et étourdit la cible pendant %d à %d tours, selon la quantité de points de combo accumulés.
		La chance d'étourdir augmente avec votre Puissance physique.
...
t([[Superior cunning and training allows you to outthink and outwit your opponents' physical and mental assaults.  Increases Defense by %d and Mental Save by %d.
		...
		Le bonus de Défense augmente avec votre Dextérité, et le bonus de sauvegarde avec votre Ruse.]], "tformat")
...
t([[Grapples the target and inflicts %0.2f physical damage. If the target is already grappled, the target will be maimed as well, reducing damage by %d and global speed by 30%% for %d turns.
		...
		Les effets de saisie sont basés sur votre talent Saisie et les dégâts augmentent avec votre Puissance physique.]], "tformat")
t("Bloodrage", "Rage Sanguinaire", "talent name")
...
t("Designate a target as a martyr for 10 turns. When the martyr deals damage, it also damages itself for %d%% of the damage dealt.", "Désigne une cible comme martyr pendant 10 tours. Lorsque le martyr inflige des dégâts, il s'inflige également %d%% des dégâts infligés.", "tformat")
...
t([[Hits the target with your weapon doing %d%% damage and two shield strikes doing %d%% damage each, trying to overpower your target.
		If the last attack hits, the target is knocked back 4 grids. The chance for knockback increases with your Accuracy.]], [[Frappe la cible avec votre arme, infligeant %d%% de dégâts, suivi de deux coups de bouclier infligeant chacun %d%% de dégâts.
		Si la dernière attaque touche, la cible est repoussée de 4 cases.
		La chance de repoussage augmente avec votre Précision.]], "tformat")
...
t([[Use your telekinetic power to enhance your strength, allowing you to pick up an adjacent enemy and hurl it anywhere within radius %d.
		...
		À l'atterrissage, votre cible subit %0.1f dégâts physiques et est étourdissante pendant 4 tours. Toutes les autres créatures dans un rayon de 2 du point d'atterrissage subissent %0.1f dégâts physiques et sont repoussées de vous.
		...
		Les dégâts augmentent avec votre Puissance mentale et la portée augmente avec la Puissance mentale et la Force.]], "tformat")
...
t([[Attack your foes in a frontal arc, doing %d%% weapon damage and making your targets bleed for %d each turn for %d turns.
		The bleed damage increases with your main hand weapon damage and Dexterity.]], [[Attaque vos ennemis dans un arc frontal, infligeant %d%% de dégâts et faisant saigner vos cibles pour %d à chaque tour pendant %d tours.
		Les dégâts de saignement augmentent avec les dégâts de votre arme principale et votre Dextérité.]], "tformat")
t("Empower Poisons", "Renforcer les Poisons", "talent name")
t([[Reduces the duration of all poisons on the target by 50%%, but increases their damage by %d%%.
		...
		L'effet augmente avec votre Ruse.]], "tformat")
t("Willful Combat", "Combat Résolu", "talent name")
t([[For %d turns, you put all your will into your blows, adding %d physical power to each strike.
		...
		L'effet augmente avec vos attributs de Ruse et Volonté.]], "tformat")
t("Deadly Strikes", "Coups Mortels", "talent name")
t([[You hit your target, doing %d%% damage. If your attack hits, you gain %d armor penetration (APR) for %d turns.
		The APR will increase with your Cunning.]], [[Vous frappez votre cible, infligeant %d%% de dégâts. Si votre attaque touche, vous gagnez %d de pénétration d'armure pendant %d tours.
		La pénétration d'armure augmente avec votre Ruse.]], "tformat")
...
t([[Using a series of tricks and maneuvers, you switch places with your target.
		...
		While switching places, your weapon(s) will connect with the target; this will not do weapon damage, but on hit effects of the weapons can trigger.]], [[En utilisant une série de tours et de manœuvres, vous échangez de place avec votre cible.
...
t([[You hit your target, doing %d%% damage. If your attack connects, the target is crippled for %d turns, losing %d%% melee, spellcasting and mind speed.
		The chance to land the status improves with Accuracy, and the status power improves with Cunning.]], [[Frappe votre cible, infligeant %d%% de dégâts. Si votre attaque touche, la cible est handicapée pendant %d tours, perdant %d%% de vitesse de mêlée, de lancement de sorts et mentale.
		La chance d'appliquer l'état augmente avec votre Précision et la puissance de l'état augmente avec votre Ruse.]], "tformat")
...
t("You hit your target, doing %d%% damage, distracting it while you jump back %d squares away.", "Vous frappez votre cible, infligeant %d%% de dégâts et la distrayant pendant que vous sautez en arrière de %d cases.", "tformat")
t("Mobile Defence", "Défense Mobile", "talent name")
t("Whilst wearing leather or lighter armour, you gain %d%% Defense and %d%% Armour hardiness.", "En portant une armure de cuir ou plus légère, vous gagnez %d%% de Défense et %d%% de solidité d'armure.", "tformat")
...
t("You literally dance around your foes, increasing your movement speed by %d%% and reducing the cooldown of Hack'n'Back, Rush, Disengage and Evasion by %d turns.", "Vous dansez littéralement autour de vos ennemis, augmentant votre vitesse de déplacement de %d%% et réduisant le rechargement de Tailler et Reculer, Charge, Se Dégager et Évasion de %d tour(s).", "tformat")
t("Charm Mastery", "Maîtrise des Talismans", "talent name")
t("Your cunning manipulations allow you to use charms (wands, totems and torques) more efficiently, reducing their cooldowns by %d%%.", "Vos manipulations rusées vous permettent d'utiliser les talismans (baguettes, totems et torques) plus efficacement, réduisant leurs rechargements de %d%%.", "tformat")
...
t([[You look at your surroundings with more intensity than most people, allowing you to see stealthed or invisible creatures.
		...
		La puissance de détection augmente avec votre Ruse.]], "tformat")
...
t([[You have learned to hit the right spot, increasing your armor penetration by %d when dual wielding.
		...
		Le bonus de pénétration d'armure augmente avec votre Dextérité.]], "tformat")
...
t("#Source# slams #Target# into the ground!", "#Source# projette #Target# au sol !", "logCombat")
...
t([[Attack your foes in a frontal arc with a roundhouse kick, which deals %0.2f physical damage and knocks your foes back 4 grids. This will break any grapples you're maintaining
		...
		Les dégâts augmentent avec votre Puissance physique.]], "tformat")
...
t([[You reach out with shadowy vines toward your target, pulling it to you and silencing it for %d turns and dazing it for 2 turns.
		...
		La chance de toucher augmente avec votre Précision.]], "tformat")
...
t([[You take full control of your own shadow for %d turns.
		...
		Votre ombre possède vos talents et attributs, a %d%% de vie et inflige %d%% de dégâts, a -30%% de résistance générale, -100%% de résistance à la lumière et +100%% de résistance à l'obscurité.
...
t("Shadow Empathy", "Empathie des Ombres", "talent name")
t([[You are linked to your shadows for %d turns, diverting %d%% of all damage you take to a random shadow.
		...
		L'effet augmente avec la Puissance mentale.]], "tformat")
...
t([[The caster's image blurs, granting a %d bonus to Defense.
		...
		Le bonus augmente avec votre Puissance des sorts.]], "tformat")
