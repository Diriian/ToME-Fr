...
t("#LIGHT_BLUE# * +6 Magic, +0 Willpower, +0 Cunning", "#LIGHT_BLUE# * +6 Magic, +0 Willpower, +0 Cunning", "_t")
--]==]
...
t("Sawbutcher", "Sawbutcher", "birth descriptor name")
...
t("Gunslinger", "Gunslinger", "birth descriptor name")
t("A tinker who dual-wields steamguns to great effect.", "A tinker who dual-wields steamguns to great effect.", "_t")
t("Their most important stats are: Cunning and Dexterity", "Their most important stats are: Cunning and Dexterity", "_t")
...
t("Psyshot", "Psyshot", "birth descriptor name")
...
t("#LIGHT_BLUE# * +0 Magic, +3 Willpower, +3 Cunning", "#LIGHT_BLUE# * +0 Magic, +3 Willpower, +3 Cunning", "_t")
t("Annihilator", "Annihilator", "birth descriptor name")
t("The Annihilator is a master of destruction, wielding the most devastating steamtech inventions to lay waste to their foes.", "The Annihilator is a master of destruction, wielding the most devastating steamtech inventions to lay waste to their foes.", "_t")
t("While normally wielding a steamgun loaded with experimental ammunition and an electrically charged shield, they can equip heavy weapons such as flamethrowers.", "While normally wielding a steamgun loaded with experimental ammunition and an electrically charged shield, they can equip heavy weapons such as flamethrowers.", "_t")
t("More adept at technology than most other tinkers, they supplement their weapons with automated turrets, mechanical minions and other such devices.", "More adept at technology than most other tinkers, they supplement their weapons with automated turrets, mechanical minions and other such devices.", "_t")
t("Research. Tinker. Annihilate.", "Research. Tinker. Annihilate.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("Orc", "Orc", "birth descriptor name")
...
t("Goggles 1", "Goggles 1", "_t")
t("Goggles 2", "Goggles 2", "_t")
t("Goggles 3", "Goggles 3", "_t")
t("Goggles 4", "Goggles 4", "_t")
t("Jaws 1", "Jaws 1", "_t")
t("Jaws 2", "Jaws 2", "_t")
t("Mechbiter 1", "Mechbiter 1", "_t")
t("Mechbiter 2", "Mechbiter 2", "_t")
t("Monocle Left 1", "Monocle Left 1", "_t")
t("Monocle Left 2", "Monocle Left 2", "_t")
t("Monocle Right 1", "Monocle Right 1", "_t")
t("Monocle Right 2", "Monocle Right 2", "_t")
...
t("[shoot down the airship]", "[shoot down the airship]", "_t")
t("[shoot down the imp]", "[shoot down the imp]", "_t")
t("#LIGHT_GREEN#*Are you SURE you want to ERADICATE THE STEAM GIANTS?*#WHITE#", "#LIGHT_GREEN#*Are you SURE you want to ERADICATE THE STEAM GIANTS?*#WHITE#", "_t")
t("[back]", "[back]", "_t")
t("#LIGHT_GREEN#*Are you SURE you want to WASTE YOUR SHOT?*#WHITE#", "#LIGHT_GREEN#*Are you SURE you want to WASTE YOUR SHOT?*#WHITE#", "_t")
...
Go on kill me @playername@! My life is destroyed, my friends are dead, my dear Aeryn is dead. All dead by your murderous hands! Finish me, let me have some #{italic}#rest#{normal}#.]], [[#LIGHT_GREEN#*The Crimson Templar looks exhausted, nearly dead. You feel the ring attuning to him and suddenly you understand you could absorb his essence to power the ring.*#WHITE#
...
t("#LIGHT_GREEN#[destroy him to power the ring]#WHITE# So be it!", "#LIGHT_GREEN#[destroy him to power the ring]#WHITE# So be it!", "_t")
t("#LIGHT_GREEN#[bind him to the ring]#WHITE# No, you are more useful alive and broken to me!", "#LIGHT_GREEN#[bind him to the ring]#WHITE# No, you are more useful alive and broken to me!", "_t")
...
Aeryn... my love...]], [[#LIGHT_GREEN#*The malevolent energies around you condensate into the ring, absorbing the last remains of John.
The ring is now much more powerful.*#WHITE#
Aeryn... my love...]], "_t")
t("#LIGHT_GREEN#[done]#WHITE#", "#LIGHT_GREEN#[done]#WHITE#", "_t")
...
#{bold}#I HATE YOU!#{normal}#]], [[#LIGHT_GREEN#*The malevolent energies around you condense into the ring, binding John to it forever.
The ring is now able to summon him for a few turns at will.*#WHITE#
...
No sudden moves, @playername@. Kaltor's orders are to consider you a customer for now. Try anything foolish, and you'll be a live demonstration for his newest guns instead.  Understand?]], [[#LIGHT_GREEN#*As you open the door to the shop, you are greeted by a pair of Steam Giant guards, staring at you and holding their steamguns tightly, at the ready but not aimed at you.*#WHITE#
...
t("I have gold, you have equipment. This doesn't need to be any more complicated than that.", "I have gold, you have equipment. This doesn't need to be any more complicated than that.", "_t")
t("Those are some pretty fancy guns. Think it'll be hard to get your blood out of the gears?", "Those are some pretty fancy guns. Think it'll be hard to get your blood out of the gears?", "_t")
t([[#LIGHT_GREEN#*She smiles, relieved but also slightly disappointed.*#WHITE#
Couldn't have said it better myself. Come on in - and try not to scare the other patrons.]], [[#LIGHT_GREEN#*She smiles, relieved but also slightly disappointed.*#WHITE#
Couldn't have said it better myself. Come on in - and try not to scare the other patrons.]], "_t")
t("[enter]", "[enter]", "_t")
t([[Good luck with that, savage.
#LIGHT_GREEN#*She smirks, and pulls a cord on the wall beside her as her and her partner duck behind cover; a loud bell rings, and you hear a commotion from further inside the shop.*#WHITE#]], [[Good luck with that, savage.
...
-- texte non traduit
--[==[
t("Finally a practical giant! Show me your wares.", "Finally a practical giant! Show me your wares.", "_t")
t("Die giant scum! For Kruk! For Garkul! For the Pride!", "Die giant scum! For Kruk! For Garkul! For the Pride!", "_t")
t("No need for shopping now.", "No need for shopping now.", "_t")
...
Well, I'm not one to turn down anyone with gold, and seeing as you've already made me rich, I'll even give you a discount, down to my pre-attack prices. #LIGHT_GREEN#*He leans in uncomfortably close, staring you in the eyes.* #WHITE#Or, if you came to do here what you did in the Emporium... #LIGHT_GREEN#*He directs his glare toward the multiple well-armed guards staring at you and standing still on the sides of the room.*#WHITE# I'm sure my #{italic}#emergency safety measures#{normal}# would just #{italic}#love#{normal}# an opportunity to try out their shiny new toys.]], [[#LIGHT_GREEN#*A well-dressed giant stands in front of you, covered in expensive jewelry; judging from the poorly-fastened clasp on his necklace, you can assume he acquired it all fairly recently.  He grins as he leans down over the counter to get a good view of you.*#WHITE#
Ah, welcome, @playername@! #LIGHT_GREEN#*he yells in a voice loud enough to catch the attention of all in the shop, as he lifts his head to look around.*#WHITE# Yes, you heard me right, @playername@! The very same one who's been running rampant through the Vaporous Emporium is coming to ME for armaments! I don't think I could've asked for a stronger endorsement! #LIGHT_GREEN#*He looks back down to you, leaning over the counter to point out a glass display case loaded with exotic weaponry and armor.*#WHITE#
...
So, what'll it be?]], [[Welcome back, @playername@!  You see this, customers?  This fearsome, savage master of battle was so impressed by my products that he came back for more!
#LIGHT_GREEN#*He points to a new poster on the wall next to him, showing your face and the caption #{bold}#"KALTOR: THE CHOICE OF DESTROYERS!"#{normal}#*#WHITE#
...
t([[#LIGHT_GREEN#*Kaltor is busy packing some of his goods away in crates; he hands one to a worker, carrying it out the back door, before turning to you.*#WHITE#
	Make it quick, @playername@. Not to be rude, but there's a private airship out there with my name on it, and I'd rather have a bird's-eye view of what you're about to do than a front-row seat.]], [[#LIGHT_GREEN#*Kaltor is busy packing some of his goods away in crates; he hands one to a worker, carrying it out the back door, before turning to you.*#WHITE#
...
Oh, what a pity.  Guards?  Ten thousand gold to whoever gets the killing blow.  Store credit, of course.]], [[#LIGHT_GREEN#*He frowns in mock disappointment, as he presses a button on his stylish coat; it hisses, and you hear motors whirring*#WHITE#
...
-- texte non traduit
--[==[
t("I am looking for special training.", "I am looking for special training.", "_t")
t("I can indeed offer some training (talent category Steamtech/Physics and Steamtech/Chemistry) for a fee of 100 gold pieces each.", "I can indeed offer some training (talent category Steamtech/Physics and Steamtech/Chemistry) for a fee of 100 gold pieces each.", "_t")
t("Please train me in physics.", "Please train me in physics.", "_t")
t("The tinker spends some time with you, teaching you the basics of smithing.", "The tinker spends some time with you, teaching you the basics of smithing.", "logPlayer")
t("Please train me in chemistry.", "Please train me in chemistry.", "_t")
...
-- texte non traduit
--[==[
t("[insert %s]", "[insert %s]", "tformat")
t("#LIGHT_GREEN#*This machine seems to have a slot for some kind of disks.*#WHITE#", "#LIGHT_GREEN#*This machine seems to have a slot for some kind of disks.*#WHITE#", "_t")
--]==]
...
t("What are you?", "What are you?", "_t")
...
If you do so we shall reward you with petty knowledge so that you may postpone your death.]], [[We require recent yeti muscle tissue from powerful specimens. You will help us, or you will not. Either way they will come to us.
If you do so we shall reward you with petty knowledge so that you may postpone your death.]], "_t")
t("That is... generous of you.", "That is... generous of you.", "_t")
t("Talent categories", "Talent categories", "_t")
t("Talents", "Talents", "_t")
t("Improved core stats", "Improved core stats", "_t")
...
t("No.", "No.", "_t")
t("Yes!", "Yes!", "_t")
t("Very well. We can teach you a talent category; which do you want?", "Very well. We can teach you a talent category; which do you want?", "_t")
t("Physical techniques", "Physical techniques", "_t")
t("Arcane spells", "Arcane spells", "_t")
t("Nature/Psionic talents", "Nature/Psionic talents", "_t")
t("Hum no let me change my mind.", "Hum no let me change my mind.", "_t")
t("Very well. We can teach you a talent.  Which do you want?", "Very well. We can teach you a talent.  Which do you want?", "_t")
t("Very well. We can teach you a talent; which type do you want?", "Very well. We can teach you a talent; which type do you want?", "_t")
...
Do you still wish to take this path?]], [[Antimagic talents are very special. To learn one means you will never be able to use arcane powered items or talents again.
Do you still wish to take this path?]], "_t")
t("Very well. We can teach you a talent (unlocking the talent category is separate). Which do you want?", "Very well. We can teach you a talent (unlocking the talent category is separate). Which do you want?", "_t")
t("Very well. We can increase one of your core stats by 4, which one?", "Very well. We can increase one of your core stats by 4, which one?", "_t")
--]==]
...
t("light + dark", "light + dark", "damage type")
t("blighted needles", "blighted needles", "damage type")
t("infective darkness", "infective darkness", "damage type")
t("fiery vapour", "fiery vapour", "damage type")
t("repairing", "repairing", "damage type")
t("mind drone", "mind drone", "damage type")
t("20% chance of physical repulsion", "20% chance of physical repulsion", "damage type")
t("temporal ripples", "temporal ripples", "damage type")
t("curse of amakthel", "curse of amakthel", "damage type")
t("psionic searing", "psionic searing", "damage type")
t("resource shock", "resource shock", "damage type")
t("smoke cloud", "smoke cloud", "damage type")
t("lightning web", "lightning web", "damage type")
t("incendiary grenade", "incendiary grenade", "damage type")
t("chemical grenade", "chemical grenade", "damage type")
t("shock grenade", "shock grenade", "damage type")
t("phosphorous", "phosphorous", "damage type")
t("fire wall", "fire wall", "damage type")
t("volatile fuel", "volatile fuel", "damage type")
t("chemical", "chemical", "damage type")
t("debilitating acid", "debilitating acid", "damage type")
t("caustic steam", "caustic steam", "damage type")
t("galvanic", "galvanic", "damage type")
t("occult", "occult", "damage type")
...
-- texte non traduit
--[==[
t("corrupted geothermal drill", "corrupted geothermal drill", "_t")
t("geothermal drill", "geothermal drill", "_t")
t("A huge geothermal drill, pumping heat and steam from Eyal's crust.", "A huge geothermal drill, pumping heat and steam from Eyal's crust.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("pile of herbs", "pile of herbs", "_t")
t("A little stockpile of herbs, whomever left them there should be thanked.", "A little stockpile of herbs, whomever left them there should be thanked.", "_t")
t("#OLIVE_DRAB#You carefully pickup the stack of herbs.", "#OLIVE_DRAB#You carefully pickup the stack of herbs.", "log")
--]==]
...
-- texte non traduit
--[==[
t("manacave ground", "manacave ground", "entity name")
--]==]
...
t("This yeti is large and angry, with claws far more sharply honed than those found in nature.", "This yeti is large and angry, with claws far more sharply honed than those found in nature.", "_t")
t("attack yeti", "attack yeti", "entity name")
t("This yeti's claws are coated in sharply carved iron. It glares at you with a long trained anger.", "This yeti's claws are coated in sharply carved iron. It glares at you with a long trained anger.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("saw horror", "saw horror", "entity name")
t("Oh. Oh no. Where did it get those?", "Oh. Oh no. Where did it get those?", "_t")
--]==]
...
t("The skin of this creature is literally crawling with larvae, yet she seems to be moving toward you very fast.", "The skin of this creature is literally crawling with larvae, yet she seems to be moving toward you very fast.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("mechanical", "mechanical", "entity type")
t("drone", "drone", "entity subtype")
t("steam drone", "steam drone", "entity name")
t("This eight legged mechanical construct looks suspiciously like a spider. A huge clonking spider that runs to you at great speed ready to cut you to pieces with its two rotating saws in place of mandibles.", "This eight legged mechanical construct looks suspiciously like a spider. A huge clonking spider that runs to you at great speed ready to cut you to pieces with its two rotating saws in place of mandibles.", "_t")
--]==]
...
t("#LIGHT_DARK#As %s falls you see its spirit rising for revenge.", "#LIGHT_DARK#As %s falls you see its spirit rising for revenge.", "logSeen")
t("steam giant blood carver", "steam giant blood carver", "entity name")
t("Blood seems to ooze from the towering giant, yet seemingly to no ill effect.", "Blood seems to ooze from the towering giant, yet seemingly to no ill effect.", "_t")
--]==]
...
--[==[
t("steam", "steam", "entity subtype")
t("steam giant gunner", "steam giant gunner", "entity name")
t("This steam giant is carrying a powerful looking gun.", "This steam giant is carrying a powerful looking gun.", "_t")
t("steam giant gunslinger", "steam giant gunslinger", "entity name")
t("This steam giant carries a steamgun in each hand.", "This steam giant carries a steamgun in each hand.", "_t")
t("steam giant flameshot", "steam giant flameshot", "entity name")
t("This steam giant carries a steamgun in each hand. The barrels appear to be flaming.", "This steam giant carries a steamgun in each hand. The barrels appear to be flaming.", "_t")
t("retaliator of Atmos", "retaliator of Atmos", "entity name")
t("This steam giant carries a steamgun in each hand. She is here to eliminate any and all aggression towards the Atmos tribe.", "This steam giant carries a steamgun in each hand. She is here to eliminate any and all aggression towards the Atmos tribe.", "_t")
--]==]
...
--[==[
t("steam", "steam", "entity subtype")
t("steam giant guard", "steam giant guard", "entity name")
t("This titanic figure walks towards you, a massive sword and shield in each hand.", "This titanic figure walks towards you, a massive sword and shield in each hand.", "_t")
t("steam giant berserker", "steam giant berserker", "entity name")
t("This steam giant carries a massive greatsword with both hands, and you see a cloud of thick steam enveloping the blade.", "This steam giant carries a massive greatsword with both hands, and you see a cloud of thick steam enveloping the blade.", "_t")
t("steam giant yeti rider", "steam giant yeti rider", "entity name")
t("Riding atop a massive armored yeti, this steam giant wields a huge greatsword.", "Riding atop a massive armored yeti, this steam giant wields a huge greatsword.", "_t")
--]==]
...
--[==[
t("mechanical", "mechanical", "entity type")
t("arachnid", "arachnid", "entity subtype")
t("mecharachnid warrior", "mecharachnid warrior", "entity name")
t("This eight legged mechanical construct looks suspiciously like a spider. A huge clonking spider that runs to you at great speed ready to cut you to pieces with its two rotating saws in place of mandibles.", "This eight legged mechanical construct looks suspiciously like a spider. A huge clonking spider that runs to you at great speed ready to cut you to pieces with its two rotating saws in place of mandibles.", "_t")
t("mecharachnid flame thrower", "mecharachnid flame thrower", "entity name")
t("This eight legged mechanical construct looks suspiciously like a spider. The huge flame thrower mounted on its back however is definitively un-spider-like.", "This eight legged mechanical construct looks suspiciously like a spider. The huge flame thrower mounted on its back however is definitively un-spider-like.", "_t")
t("mecharachnid destroyer", "mecharachnid destroyer", "entity name")
t("This eight legged mechanical construct looks suspiciously like a spider. An armed to the teeth, well, mandibles, spider.", "This eight legged mechanical construct looks suspiciously like a spider. An armed to the teeth, well, mandibles, spider.", "_t")
t("mecharachnid repairbot", "mecharachnid repairbot", "entity name")
t("This eight legged mechanical construct looks suspiciously like a spider. It seems to be more concerned by its fellow arachnids than by you.", "This eight legged mechanical construct looks suspiciously like a spider. It seems to be more concerned by its fellow arachnids than by you.", "_t")
--]==]
...
t("A mage dressed in shining robes.", "A mage dressed in shining robes.", "_t")
...
-- texte non traduit
--[==[
t("titan", "titan", "entity subtype")
t("titan battlesmasher", "titan battlesmasher", "entity name")
t("This creature looks like one of the steam giants, but nastier, bigger and somehow corrupted by unknown forces. Oh and it is wielding a huge maul too!", "This creature looks like one of the steam giants, but nastier, bigger and somehow corrupted by unknown forces. Oh and it is wielding a huge maul too!", "_t")
t("titanic horror", "titanic horror", "entity name")
t("While a titan usually look like a corrupted steam giant, this one looks more like a giant-sized horrific mass of living flesh.", "While a titan usually look like a corrupted steam giant, this one looks more like a giant-sized horrific mass of living flesh.", "_t")
t("titan searing seer", "titan searing seer", "entity name")
t("Wreathed in arcane flames you can feel the intense psionic forces ripping at your mind emanating from this titan.", "Wreathed in arcane flames you can feel the intense psionic forces ripping at your mind emanating from this titan.", "_t")
t("titan vile spewer", "titan vile spewer", "entity name")
t("The wretched titan's skin is of a sickly green, full of ever-oozing wounds, cracks and pustules. Worms and all kind of vile things crawl over it.", "The wretched titan's skin is of a sickly green, full of ever-oozing wounds, cracks and pustules. Worms and all kind of vile things crawl over it.", "_t")
t("titan dreadnought", "titan dreadnought", "entity name")
t("One of the biggest titans you have seen yet, it is fully clad in deep black stralite full plate, charging menacingly towards you at a terrible pace.", "One of the biggest titans you have seen yet, it is fully clad in deep black stralite full plate, charging menacingly towards you at a terrible pace.", "_t")
t("sher'tan", "sher'tan", "entity name")
t("This abomination has the height of any other titan but its features definitively remind you of the few Sher'Tul images you have seen. Your very being rebels to the thought and sheer terror takes hold of your mind.", "This abomination has the height of any other titan but its features definitively remind you of the few Sher'Tul images you have seen. Your very being rebels to the thought and sheer terror takes hold of your mind.", "_t")
t("gargantuan sher'tan", "gargantuan sher'tan", "entity name")
t("This abomination has the height of any other titan but its feature definitively remind you of the few Sher'Tul images you have seen. Your very being rebels to the thought and sheer terror takes hold of your mind.", "This abomination has the height of any other titan but its feature definitively remind you of the few Sher'Tul images you have seen. Your very being rebels to the thought and sheer terror takes hold of your mind.", "_t")
--]==]
...
t("troll pirate", "troll pirate", "entity name")
t("This is a Troll pirate.", "This is a Troll pirate.", "_t")
t("troll marauder", "troll marauder", "entity name")
t("This lean but muscular troll deftly wields two daggers. He glares at you with eyes filled with cunning.", "This lean but muscular troll deftly wields two daggers. He glares at you with eyes filled with cunning.", "_t")
t("troll captain", "troll captain", "entity name")
t("This troll is barking orders to the other trolls around him. He effortlessly holds a longsword in each hand.", "This troll is barking orders to the other trolls around him. He effortlessly holds a longsword in each hand.", "_t")
t("troll guard", "troll guard", "entity name")
t("This troll carries a large sword and shield, and appears to be wearing segments of armor.", "This troll carries a large sword and shield, and appears to be wearing segments of armor.", "_t")
t("troll aquamancer", "troll aquamancer", "entity name")
t("This troll is holding a tall staff in one hand. Tendrils of water circle around it.", "This troll is holding a tall staff in one hand. Tendrils of water circle around it.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("dragon", "dragon", "entity subtype")
t("undead drake hatchling", "undead drake hatchling", "entity name")
t("A skeletal drake hatchling; not too powerful by itself, but if it's anything like living ones, it's probably not alone.", "A skeletal drake hatchling; not too powerful by itself, but if it's anything like living ones, it's probably not alone.", "_t")
t("undead drake", "undead drake", "entity name")
t("A skeletal drake, armed with a deadly breath weapon and nasty claws.", "A skeletal drake, armed with a deadly breath weapon and nasty claws.", "_t")
t("undead wyrm", "undead wyrm", "entity name")
t("The skeleton of a long-lived wyrm, armed with a deadly breath weapon and nasty claws.", "The skeleton of a long-lived wyrm, armed with a deadly breath weapon and nasty claws.", "_t")
--]==]
...
t("The air seems to freeze and wither around this terrible undead.", "The air seems to freeze and wither around this terrible undead.", "_t")
--]==]
...
t("yeti demolisher", "yeti demolisher", "entity name")
t("This huge humanoid form is coated with a thick white fur, with large, vicious claws. Will you welcome the embrace of its large muscular arms?", "This huge humanoid form is coated with a thick white fur, with large, vicious claws. Will you welcome the embrace of its large muscular arms?", "_t")
--]==]
...
t("implant on your skin.", "implant on your skin.", "_t")
t("steam generator implant", "steam generator implant", "entity name")
t("medical injector implant", "medical injector implant", "entity name")
--]==]
...
t("%s viral injector", "%s viral injector", "tformat")
...
t("%s rocket boots", "%s rocket boots", "tformat")
t("HANDS", "HANDS", "entity on slot")
t("%s hand cannon", "%s hand cannon", "tformat")
...
t("Annihilator", "Annihilator", "entity name")
...
t("Stimulus", "Stimulus", "entity name")
...
t("A hypospray full of ...something. There is no telling what you're injecting yourself with.", "A hypospray full of ...something. There is no telling what you're injecting yourself with.", "_t")
t("Gain a random beneficial effect", "Gain a random beneficial effect", "_t")
t("Deflector", "Deflector", "entity name")
t("vibrating shield", "vibrating shield", "_t")
t("The front plate of this shield vibrates at all times, covering some strange assembly you can't quite make sense of.", "The front plate of this shield vibrates at all times, covering some strange assembly you can't quite make sense of.", "_t")
t("Knocks melee attackers away. Distance scales with damage incoming.", "Knocks melee attackers away. Distance scales with damage incoming.", "_t")
t("Skysmasher", "Skysmasher", "entity name")
t("rocket powered maul", "rocket powered maul", "_t")
t("The discovery of rockets has proved incredibly dangerous. It is not always clear for whom.", "The discovery of rockets has proved incredibly dangerous. It is not always clear for whom.", "_t")
t("Nimbus of Enlightenment", "Nimbus of Enlightenment", "entity name")
t("elaborate cap", "elaborate cap", "_t")
t([[They are out to get you.
This is not real this is not real this is not real.]], [[They are out to get you.
...
Putting this on your head may not be the best idea.]], [[By all accounts, just an ordinary cooking pot with an array of antennae haphazardly soldered onto it. An attached manual contains nothing but fifty pages of deranged gibberish, nonsensical diagrams and lines upon lines of numbers with no apparent pattern or reason to them. 

Putting this on your head may not be the best idea.]], "_t")
t("%s's Shadow", "%s's Shadow", "tformat")
t([[itshereitshereitshereitshere
itshereitshereitshereitshere
itshereitshereitshereitshere
itshereitshereitshereitshere]], [[itshereitshereitshereitshere
itshereitshereitshereitshere
itshereitshereitshereitshere
itshereitshereitshereitshere]], "_t")
t("#F53CBE#%s's shadow awakens!", "#F53CBE#%s's shadow awakens!", "logSeen")
t("Pressurizer", "Pressurizer", "entity name")
t("heavy lined cloak", "heavy lined cloak", "_t")
t("This cloak hides and protects a series of powerful steam compressors.", "This cloak hides and protects a series of powerful steam compressors.", "_t")
t("Eastern Wood Hat", "Eastern Wood Hat", "entity name")
t("worn leather hat", "worn leather hat", "_t")
t("This hat was made from materials from a forest whose name is long since lost, far in the east. It is said to have belonged to one of the first gunslingers.", "This hat was made from materials from a forest whose name is long since lost, far in the east. It is said to have belonged to one of the first gunslingers.", "_t")
t("Steamcatcher", "Steamcatcher", "entity name")
t("pipe coated leather hat", "pipe coated leather hat", "_t")
t("There's an old saying that most of your body heat escapes through your head. It's not true of body heat, but strangely, is actually true of steam.", "There's an old saying that most of your body heat escapes through your head. It's not true of body heat, but strangely, is actually true of steam.", "_t")
t("On taking fire damage: Gain 5% of the damage as steam.", "On taking fire damage: Gain 5% of the damage as steam.", "_t")
t("Shoes of Moving Quickly", "Shoes of Moving Quickly", "entity name")
t("rocket powered boots", "rocket powered boots", "_t")
t("Accurately? Less so.", "Accurately? Less so.", "_t")
t("You move 3 spaces at once.", "You move 3 spaces at once.", "_t")
t("Band of Protection", "Band of Protection", "entity name")
t("reinforced belt", "reinforced belt", "_t")
t("This belt utilizes an enchanted gem to focus a burst of steam into a powerful barrier.", "This belt utilizes an enchanted gem to focus a burst of steam into a powerful barrier.", "_t")
t("generate a personal shield that absorbs up to %d damage and damages attackers striking the wearer for %d fire damage while it lasts (based on Cunning)", "generate a personal shield that absorbs up to %d damage and damages attackers striking the wearer for %d fire damage while it lasts (based on Cunning)", "tformat")
t("%s summons a barrier of steam from %s %s!", "%s summons a barrier of steam from %s %s!", "logSeen")
t("Viletooth", "Viletooth", "entity name")
t("rusted steamsaw", "rusted steamsaw", "_t")
t("This aged looking saw is very rusty, and you think you see a thin layer of... something... on its blades.", "This aged looking saw is very rusty, and you think you see a thin layer of... something... on its blades.", "_t")
t("may infect the target with a random disease", "may infect the target with a random disease", "_t")
t("Mirrorazor", "Mirrorazor", "entity name")
t("rippling portal", "rippling portal", "_t")
...
t("Oh, for the love of...  You're way too busy to deal with this nonsense.  You rev up Mirrorazor again, re-syncing it with the Mirror Universe, and toss the note back in.  A different note flies out the other side, miraculously not torn to shreds by the massive difference in planetary rotations.", "Oh, for the love of...  You're way too busy to deal with this nonsense.  You rev up Mirrorazor again, re-syncing it with the Mirror Universe, and toss the note back in.  A different note flies out the other side, miraculously not torn to shreds by the massive difference in planetary rotations.", "_t")
t("#LIGHT_BLUE#Mirrorazor shudders as a note falls out from a different timeline!", "#LIGHT_BLUE#Mirrorazor shudders as a note falls out from a different timeline!", "saySimple")
t("5 turns after use, mirror yourself across the map (centered around the location you were standing when activated).", "5 turns after use, mirror yourself across the map (centered around the location you were standing when activated).", "_t")
t("Razorlock", "Razorlock", "entity name")
t("interlocked steamsaws", "interlocked steamsaws", "_t")
t([[This intricate set of steamsaws lock together in a nearly indecipherable system.
They sure seem sharp though.]], [[This intricate set of steamsaws lock together in a nearly indecipherable system.
They sure seem sharp though.]], "_t")
t("Ramroller", "Ramroller", "entity name")
t("a... chariot?", "a... chariot?", "_t")
t("\"So we were thinking. You know what's better than saws? Really BIG saws. Unfortunately, no one could lift them. So we came up with an innovative new solution: Mount them on a motorized platform, allowing easy transportation and unparalleled cutting power!\"", "\"So we were thinking. You know what's better than saws? Really BIG saws. Unfortunately, no one could lift them. So we came up with an innovative new solution: Mount them on a motorized platform, allowing easy transportation and unparalleled cutting power!\"", "_t")
t("Moving builds up a stacking movement speed (caps at 25%) and damage bonus (caps at double). Hitting removes the bonus.", "Moving builds up a stacking movement speed (caps at 25%) and damage bonus (caps at double). Hitting removes the bonus.", "_t")
t("Overcutter", "Overcutter", "entity name")
t("enormous steamsaw", "enormous steamsaw", "_t")
t("Earlier steamsaws were notably not meant to be used with one hand.", "Earlier steamsaws were notably not meant to be used with one hand.", "_t")
t("Turbocutter", "Turbocutter", "entity name")
t("red striped steamsaw", "red striped steamsaw", "_t")
t("\"Have you ever thought your steamsaws were just too slow? Well, have I got the thing for you...\"", "\"Have you ever thought your steamsaws were just too slow? Well, have I got the thing for you...\"", "_t")
t("Increases the speed bonus from Saw Wheels by 25%.", "Increases the speed bonus from Saw Wheels by 25%.", "_t")
t("Whipsnap", "Whipsnap", "entity name")
t("spring loaded steamsaw", "spring loaded steamsaw", "_t")
t("\"Sick of your pesky enemies hitting you with weapons? Well, with the new spring loaded Whipsnap, you can quickly put a stop to that!\"", "\"Sick of your pesky enemies hitting you with weapons? Well, with the new spring loaded Whipsnap, you can quickly put a stop to that!\"", "_t")
t("Pinwheel", "Pinwheel", "entity name")
t("spike tipped steamsaw", "spike tipped steamsaw", "_t")
t("\"Create new, exciting connections in other people's lives, such as between their feet and the floor!\"", "\"Create new, exciting connections in other people's lives, such as between their feet and the floor!\"", "_t")
t("15% chance to pin the target", "15% chance to pin the target", "_t")
t("Frostbite", "Frostbite", "entity name")
t("icy steamsaw", "icy steamsaw", "_t")
t("Fashioned from magical ice, and perfect for carving ice - especially ice with someone else inside it.", "Fashioned from magical ice, and perfect for carving ice - especially ice with someone else inside it.", "_t")
t("The Lumberator", "The Lumberator", "entity name")
...
t("On Taking Damage: Blindside the attacker (range 6).", "On Taking Damage: Blindside the attacker (range 6).", "_t")
t("Overclocked Radius", "Overclocked Radius", "entity name")
t("distorted steamsaw", "distorted steamsaw", "_t")
...
There were ...side effects.]], [[Faced with the petty quandaries of 'conventional physics', some mad tinker must have coated this sawblade with a fine sheathe of dilated time to maximize its speed.
 
There were ...side effects.]], "_t")
t("Attack speed increases with paradox, up to 250% at 1000 paradox.", "Attack speed increases with paradox, up to 250% at 1000 paradox.", "_t")
t("increase paradox by a random amount", "increase paradox by a random amount", "_t")
t("increase paradox by a drastic amount with a chance to do an anomaly (%d%% chance). If anomaly triggers, halve paradox.", "increase paradox by a drastic amount with a chance to do an anomaly (%d%% chance). If anomaly triggers, halve paradox.", "tformat")
t("Heartrend", "Heartrend", "entity name")
t([[There is an attached note.
 
'I've spilt the heartsblood of my work, feeling it pound, like a heart, in my palms.
Some people just can't let go until they've bled dry.']], [[There is an attached note.
...
While you are bleeding, Heartrend's damage increases and it gains lifesteal.]], [[All damage dealt by or to you (that is over 1% of max life) bleeds for an additional 20% of the damage as physical damage (ignores most status resistances).
While you are bleeding, Heartrend's damage increases and it gains lifesteal.]], "_t")
t("If bleed damage per turn is greater than 5% of max life, attacks cleave.", "If bleed damage per turn is greater than 5% of max life, attacks cleave.", "_t")
t("Dethzaw", "Dethzaw", "entity name")
t("fiery steamsaw", "fiery steamsaw", "_t")
...
His naming skills have not improved.]], [[Grushgore the Destroyer was absolutely enthralled when he discovered steamsaws. He immediately kidnapped several tinkerers and forced them to create this for him.
His naming skills have not improved.]], "_t")
t("deal a melee attack against all other enemies in a circle around you", "deal a melee attack against all other enemies in a circle around you", "_t")
t("Galen's Flowing Robe", "Galen's Flowing Robe", "entity name")
t("ample robe", "ample robe", "_t")
t("This robe was worn by the Technomancer Galen, infused with technomancy enchantments it is said to react to techno-spells!", "This robe was worn by the Technomancer Galen, infused with technomancy enchantments it is said to react to techno-spells!", "_t")
...
t("#PURPLE#%s activates and teleports away all nearby creatures!", "#PURPLE#%s activates and teleports away all nearby creatures!", "logSeen")
t("#PURPLE#%s activates and increases %s's resistances!", "#PURPLE#%s activates and increases %s's resistances!", "logSeen")
t("#PURPLE#%s activates and increases %s's arcane dynamo power!", "#PURPLE#%s activates and increases %s's arcane dynamo power!", "logSeen")
t("#PURPLE#%s activates and resets %s's %s cooldown!", "#PURPLE#%s activates and resets %s's %s cooldown!", "logSeen")
t("Galen's Will", "Galen's Will", "entity name")
t("aether-infused steamsaw", "aether-infused steamsaw", "_t")
t("Saws made of metal? That is no good for a discerning Technomancer so Galen made a saw out of pure arcane forces!", "Saws made of metal? That is no good for a discerning Technomancer so Galen made a saw out of pure arcane forces!", "_t")
t("Increases the steam your arcane dynamo generate per 10 points of mana by 2.", "Increases the steam your arcane dynamo generate per 10 points of mana by 2.", "_t")
...
t("No self respecting craftsman would be caught without them!", "No self respecting craftsman would be caught without them!", "_t")
t("X-Ray Goggles", "X-Ray Goggles", "entity name")
t("pitch black goggles", "pitch black goggles", "_t")
t("How do these even work?", "How do these even work?", "_t")
t("see everything. EVERYTHING. For 5 turns, anyway", "see everything. EVERYTHING. For 5 turns, anyway", "_t")
t("Laser Powered Giant Smasher", "Laser Powered Giant Smasher", "entity name")
t("radiant hammer", "radiant hammer", "_t")
t("The Laser Powered Giant Smasher, nicknamed the Gloryhammer. You can feel it vibrating with untold power in your hands.", "The Laser Powered Giant Smasher, nicknamed the Gloryhammer. You can feel it vibrating with untold power in your hands.", "_t")
t("#PURPLE#You feel the power of the Gloryhammer course through you! It has become fully empowered!", "#PURPLE#You feel the power of the Gloryhammer course through you! It has become fully empowered!", "logPlayer")
--]==]
...
-- texte non traduit
--[==[
t("vaporous emporium", "vaporous emporium", "newLore category")
...
Even if you have no fear of the orcish tribes, ritch swarms, and other assorted threats that lurk just outside our city walls, please consider purchasing some of my wares.  They are truly beautiful displays of craftsmanship, and would do well as a desk sculpture or (if properly disarmed) a child's toy.  If nothing else, you will be ensuring that a once-proud artisan with great love and respect for his craft need not resort to begging on the streets.]], "_t")
t("ornately-painted poster", "ornately-painted poster", "_t")
...
t("official-looking poster", "official-looking poster", "_t")
...
Thank you for helping ensure we ALL have power, while we work on curing this shortage!]], [[#{bold}#KEEP THE PRESSURE UP!#{normal}#
#{italic}#An announcement on power consumption, paid for by the Council of Geothermal Authority#{normal}#
...
t("hastily-written poster", "hastily-written poster", "_t")
...
t("strange black disk (2)", "strange black disk (2)", "_t")
...
t("strange black disk (3)", "strange black disk (3)", "_t")
...
"Mayday, mayday, we are bailing out!  Tantalos is gone, and we are NOT going back for him!  Scrap the tunnel to the Palace of Fumes, scrap the entire damn council, we're getting as far away from here as we can--"  Loud hissing.  "MOTHER OF--!"  Grunts, squishing, slashing.  "Flooring it all the way to the damn Sunwall, we're taking the first farportal off this continent whether those tinies like it or not!  Guess this technically counts as treason, mutiny, whatever, but if the Council's hearing this, BLOW IT OUT YOUR STEAM-HOLES, WE'D RATHER LIVE!  Altitude rising, surface approaching, this is H.C. Parmor signing off--"]], [[#{italic}#(You hear loud, mechanical rumbling; in the distance, you hear sounds of struggling and bludgeoning, swords slicing through flesh, steamguns being fired, and shouts of pain from giant and horror alike.  Parmor sounds panicked.)#{normal}#

"Mayday, mayday, we are bailing out!  Tantalos is gone, and we are NOT going back for him!  Scrap the tunnel to the Palace of Fumes, scrap the entire damn council, we're getting as far away from here as we can--"  Loud hissing.  "MOTHER OF--!"  Grunts, squishing, slashing.  "Flooring it all the way to the damn Sunwall, we're taking the first farportal off this continent whether those tinies like it or not!  Guess this technically counts as treason, mutiny, whatever, but if the Council's hearing this, BLOW IT OUT YOUR STEAM-HOLES, WE'D RATHER LIVE!  Altitude rising, surface approaching, this is H.C. Parmor signing off--"]], "_t")
t("erratic scribblings", "erratic scribblings", "_t")
t("why is it down there why is it ANYWHERE", "why is it down there why is it ANYWHERE", "_t")
t("If anyone finds this, tell the Jarsovi brothers their father lov", "If anyone finds this, tell the Jarsovi brothers their father lov", "_t")
t("Too many of them.  Couldn't pull more Atmos back in, wasn't safe, couldn't tell them from the others.  Hope we've got enough fuel to get us to the surface.", "Too many of them.  Couldn't pull more Atmos back in, wasn't safe, couldn't tell them from the others.  Hope we've got enough fuel to get us to the surface.", "_t")
...
-- texte non traduit
--[==[
t("internment camp", "internment camp", "newLore category")
t("internment camp correspondence (1)", "internment camp correspondence (1)", "_t")
...
Regretfully,
Administrator Quellop]], [[#{italic}#To: Guard Captain Galsamae
From: Administrator Quellop#{normal}#
...
t("internment camp correspondence (2)", "internment camp correspondence (2)", "_t")
t([[#{italic}#To: Guard Captain Galsamae
From: Administrator Quellop#{normal}#
...
With growing impatience,
Administrator Quellop]], "_t")
t("internment camp correspondence (3)", "internment camp correspondence (3)", "_t")
...
PS: If any mention of this is made to your superiors, I'll make sure they also know about the Atmos absinthe you had smuggled in here last week.]], [[#{italic}#To: Condescending Little Cretin
From: Guard Captain Galsamae#{normal}#
...
t("internment camp correspondence (4)", "internment camp correspondence (4)", "_t")
t([[#{italic}#To: Guard Captain Galsamae
From: Administrator Quellop#{normal}#
...
-Quellop]], [[#{italic}#To: Guard Captain Galsamae
From: Administrator Quellop#{normal}#
...
-- texte non traduit
--[==[
t("krimbul clan", "krimbul clan", "newLore category")
t("the journey of the Krimbul Clan", "the journey of the Krimbul Clan", "_t")
...
In a cruel twist of fate, we found what would have been paradise not long after our escape - the Mana Caves, laden with magic, but we only needed a tenth of it now as we did alive.  Nonetheless, it has been our home ever since...  most soft-feet would have raided the caverns and wiped us out like common vermin, but the Kruk Pride treated us with respect and dignity that perhaps no minotaur OR undead creature has received before (let alone the combination).  We are still a reclusive people, and our current state gives us even fewer reasons to need trade with them...  but they are the closest thing we have ever had to friends, and I suspect that right now, we are that to them as well.]], "_t")
t("a transcribed speech", "a transcribed speech", "_t")
...
]], [[Men and women of the Krimbul Clan!  I come before you today because with my awakening shall come a greater destiny, one we shall all share.  The dawn of a new age is at hand, and it would do you no good to sleep through it.  Allow me to open your eyes, before I lead you to our ultimate destiny!
...
t("personal journal of Nektosh the One-Horned", "personal journal of Nektosh the One-Horned", "_t")
...
i'm sorry karbatha]], [[no no no no no no no no no no no no no
...
-- texte non traduit
--[==[
t("Lunar Orb", "Lunar Orb", "talent name")
t("Fires out a bolt of cosmic energy in the target direction. The projectile continues until it hits a wall or the edge of the map, dealing %0.2f dark damage to enemies hit and restoring %d negative energy. The negative energy gained is reduced by 25%% per enemy hit, restoring a maximum of %d. Enemies hit will become aware of you.", "Fires out a bolt of cosmic energy in the target direction. The projectile continues until it hits a wall or the edge of the map, dealing %0.2f dark damage to enemies hit and restoring %d negative energy. The negative energy gained is reduced by 25%% per enemy hit, restoring a maximum of %d. Enemies hit will become aware of you.", "tformat")
t("Astral Path", "Astral Path", "talent name")
t("The spell fizzles: there are no available spots to teleport to.", "The spell fizzles: there are no available spots to teleport to.", "logSeen")
t([[Fire an orb of negative energy towards a spot within range %d.
		...
		The speed of the projectile (%d%%) increases with your movement speed]], [[Fire an orb of negative energy towards a spot within range %d.
		When the orb reaches its destination, it will teleport you to its location.
		The speed of the projectile (%d%%) increases with your movement speed]], "tformat")
t("Galactic Pulse", "Galactic Pulse", "talent name")
t([[Sends out a slow-moving spiral of cosmic energy towards a target location within range 8.
		As the cosmic energy moves, it pulls in targets adjacent to it, dealing %0.2f darkness damage and granting you 1 negative energy per hit.]], [[Sends out a slow-moving spiral of cosmic energy towards a target location within range 8.
...
t("Supernova", "Supernova", "talent name")
t([[Expend all of your negative energy to create a massive burst of dark energy (radius %d) at a target location within range %d.
		...
		The damage and pin chance increase with your spellpower, and the damage, radius and pin duration all increase with negative energy and talent level]], [[Expend all of your negative energy to create a massive burst of dark energy (radius %d) at a target location within range %d.
		This deals %0.2f darkness damage and pins targets hit for %d turns.
...
-- texte non traduit
--[==[
t("Twilit Echoes", "Twilit Echoes", "talent name")
...
-- texte non traduit
--[==[
t("Celestial Acceleration", "Celestial Acceleration", "talent name")
t("Increases your movement speed by %0.2f%% per percent of positive energy and your casting speed by %0.2f%% per percent of negative energy, up to a maximum of %0.2f%% at 80%%. Sustained energy still counts toward the maximum.", "Increases your movement speed by %0.2f%% per percent of positive energy and your casting speed by %0.2f%% per percent of negative energy, up to a maximum of %0.2f%% at 80%%. Sustained energy still counts toward the maximum.", "tformat")
t("Polarization", "Polarization", "talent name")
t("Whichever of your positive and negative energies is a higher percentage regenerates towards its max instead of its normal resting value (%d positive, %d negative). Your negative and positive regeneration/degeneration rates are increased to %0.2f.", "Whichever of your positive and negative energies is a higher percentage regenerates towards its max instead of its normal resting value (%d positive, %d negative). Your negative and positive regeneration/degeneration rates are increased to %0.2f.", "tformat")
t("Magnetic Inversion", "Magnetic Inversion", "talent name")
t("Swap your current positive and negative energy levels. This spell takes no time to cast.", "Swap your current positive and negative energy levels. This spell takes no time to cast.", "_t")
t("Plasma Bolt", "Plasma Bolt", "talent name")
t("Fires out a bolt of pure energy, dealing %0.2f light and %0.2f darkness damage in a radius of %d, and slowing targets hit. Their movement is reduced by %d%% and attacking, casting and mind attacks by %d%%. The bolt will attune to your current positive and negative energy amounts.", "Fires out a bolt of pure energy, dealing %0.2f light and %0.2f darkness damage in a radius of %d, and slowing targets hit. Their movement is reduced by %d%% and attacking, casting and mind attacks by %d%%. The bolt will attune to your current positive and negative energy amounts.", "tformat")
--]==]
...
t("Create a distortion at the target tile, knocking back all projectiles and changing their direction to face away if possible.", "Create a distortion at the target tile, knocking back all projectiles and changing their direction to face away if possible.", "_t")
t("Mirror Wall", "Mirror Wall", "talent name")
t("mirror wall", "mirror wall", "_t")
t("Creates a wall %d units long for %d turns, reflecting all projectiles that hit it and blocking sight.", "Creates a wall %d units long for %d turns, reflecting all projectiles that hit it and blocking sight.", "tformat")
...
-- texte non traduit
--[==[
t("Solar Orb", "Solar Orb", "talent name")
t("Solar Orb", "Solar Orb", "_t")
t("Fire out an orb of light that deals %0.2f light damage and then returns, dealing the same amount of damage again and reducing the cooldown by half (%d) when it reaches you. The damage will increase with your spellpower. The ball will travel at most %d distance to return to you.", "Fire out an orb of light that deals %0.2f light damage and then returns, dealing the same amount of damage again and reducing the cooldown by half (%d) when it reaches you. The damage will increase with your spellpower. The ball will travel at most %d distance to return to you.", "tformat")
t("Solar Wind", "Solar Wind", "talent name")
t("While sustained, this ability speeds up outgoing projectiles by %d%% while slowing incoming projectiles by %d%%. The increase and decrease improve with your spellpower", "While sustained, this ability speeds up outgoing projectiles by %d%% while slowing incoming projectiles by %d%%. The increase and decrease improve with your spellpower", "tformat")
t("Lucent Wrath", "Lucent Wrath", "talent name")
t("After %d turns, the target area in (radius %d) is blasted with a beam of light, dealing %0.2f damage and lighting the area", "After %d turns, the target area in (radius %d) is blasted with a beam of light, dealing %0.2f damage and lighting the area", "tformat")
t("Lightspeed", "Lightspeed", "talent name")
t("%s moves at light speed!", "%s moves at light speed!", "logSeen")
t("Instantly gain %d%% percent of a turn.", "Instantly gain %d%% percent of a turn.", "tformat")
--]==]
...
t("Fire out a spear of cosmic energies. If it hits an enemy it deals %0.2f damage, otherwise it explodes in a thin cone of radius %d at the end of its range, blocked by enemies, which deals %0.2f to %0.2f damage depending on how much the enemies block.", "Fire out a spear of cosmic energies. If it hits an enemy it deals %0.2f damage, otherwise it explodes in a thin cone of radius %d at the end of its range, blocked by enemies, which deals %0.2f to %0.2f damage depending on how much the enemies block.", "tformat")
t("Crescent Wave", "Crescent Wave", "talent name")
t("Fires out a projectile in a clockwise arc. If it hits an enemy it deals %0.2f damage and roots them for one turn. If another projectile damages them within %d turns, they take half that damage and are rooted again.", "Fires out a projectile in a clockwise arc. If it hits an enemy it deals %0.2f damage and roots them for one turn. If another projectile damages them within %d turns, they take half that damage and are rooted again.", "_t")
t("Twilit Echoes", "Twilit Echoes", "talent name")
t([[The target feels the echoes of all your light and dark damage for %d turns. 
...
t([[Gaze at your foes and turn them to stone for %d turns.
		...
		This spell may fail against creatures resistant to being stunned, that are specifically immune to stoning, or certain bosses.]], [[Gaze at your foes and turn them to stone for %d turns.
		Stoned creatures are unable to act or regen life, and are very brittle.
		If a stoned creature is hit by an attack that deals more than 30%% of its life, it will shatter and be destroyed.
		Stoned creatures are highly resistant to fire and lightning, and somewhat resistant to physical attacks.
...
t("Ritch Larva Infect", "Ritch Larva Infect", "talent name")
t("@Source@ stings with her ovipositor!", "@Source@ stings with her ovipositor!", "_t")
t([[Sting the target with your ovipositor, injecting %d larvae into it to finish their hatching process.
		...
		]], [[Sting the target with your ovipositor, injecting %d larvae into it to finish their hatching process.
		Over a 5 turn gestation period, the larvae will feed on the victim internally, dealing %0.2f to %0.2f physical damage each turn (increasing as they grow).
		After the gestation period is complete, each larva will rip itself free of its host, dealing %0.2f physical and %0.2f fire damage.
		]], "tformat")
t("Slumbering...", "Slumbering...", "talent name")
t("@Source@ enters a deep slumber.", "@Source@ enters a deep slumber.", "_t")
t("#STEEL_BLUE#%s slumbers...", "#STEEL_BLUE#%s slumbers...", "saySimple")
t("#CRIMSON#%s awakens!", "#CRIMSON#%s awakens!", "saySimple")
...
t("Curse of Amakthel", "Curse of Amakthel", "talent name")
...
t("Temporal Ripples", "Temporal Ripples", "talent name")
t([[Creates a circle of radius %d of altered time for %d turns. Any damage your foes take while standing in it will heal the attacker for 200%% of the damage dealt.
		]], [[Creates a circle of radius %d of altered time for %d turns. Any damage your foes take while standing in it will heal the attacker for 200%% of the damage dealt.
		]], "tformat")
t("Saw Storm", "Saw Storm", "talent name")
t([[Summon a storm of swirling sawblades to slice your foes, inflicting %d physical damage and bleeding to anyone who approaches for %d turns.
		The damage and duration will increase with your Mindpower.]], [[Summon a storm of swirling sawblades to slice your foes, inflicting %d physical damage and bleeding to anyone who approaches for %d turns.
		The damage and duration will increase with your Mindpower.]], "tformat")
t("Razor Saw", "Razor Saw", "talent name")
t([[Launches a sawblade with intense power doing %0.2f physical damage to all targets in line.
		The damage will increase with Mindpower]], [[Launches a sawblade with intense power doing %0.2f physical damage to all targets in line.
		The damage will increase with Mindpower]], "tformat")
t("Rocket Dash", "Rocket Dash", "talent name")
...
t("Mind Controlled Yeti", "Mind Controlled Yeti", "talent name")
--]==]
...
t("Surekill", "Surekill", "talent name")
t([[You fire an exceptionally lethal shot at an enemy, doing %d%% damage.
Damage dealt by this talent is increased by half your critical multiplier, if doing so would kill the target.]], [[You fire an exceptionally lethal shot at an enemy, doing %d%% damage.
...
t([[Dash forward using rockets.
		...
		This attack does 180% weapon damage.
		You must dash from at least 2 tiles away.]], "_t")
t("Laser Powered Smash", "Laser Powered Smash", "talent name")
t("@Source@ unleashes the power of the Gloryhammer!", "@Source@ unleashes the power of the Gloryhammer!", "_t")
t([[Unleash the ultimate power of the Gloryhammer to all foes around in radius 1.
		This attack creates an explosion of radius 1 around every affected target, dealing 50% weapon damage and blinding them for 4 turns.]], [[Unleash the ultimate power of the Gloryhammer to all foes around in radius 1.
...
-- texte non traduit
--[==[
t("Condensate", "Condensate", "talent name")
t([[Condensate hot steam around your foes in radius %d, burning them for %0.2f fire damage and applying the wet effect for 4 turns, halving their stun resistances.
		The damage will increase with your Mindpower.]], [[Condensate hot steam around your foes in radius %d, burning them for %0.2f fire damage and applying the wet effect for 4 turns, halving their stun resistances.
		The damage will increase with your Mindpower.]], "tformat")
t("Solidify Air", "Solidify Air", "talent name")
t("solid air", "solid air", "_t")
t("a piece of solidified air", "a piece of solidified air", "_t")
t([[You concentrate your will in a cone in front of you, condensing the air into a tangible, solid form.
		...
		The damage will increase with your Mindpower.]], [[You concentrate your will in a cone in front of you, condensing the air into a tangible, solid form.
		Any creatures caught inside take %0.2f physical damage.
		Any places with no creatures will be filled with solid air, blocking the way for %d turns.
		The damage will increase with your Mindpower.]], "tformat")
t("Superconduction", "Superconduction", "talent name")
t([[Call a streak of lightning on your target, dealing %0.2f to %0.2f lightning damage.
		...
		All affected foes are seared for 4 turns, reducing their fire resistance by %d%% and and mind save by %d.
		The damage will increase with your Mindpower.]], "tformat")
t("Negative Biofeedback", "Negative Biofeedback", "talent name")
...
t([[You let your mind tap into your steam generators for energy, increasing your Mindpower in proportion to your steam level: %d when at full steam and 0 when at 0 steam.
		...
		The effects increase with your Willpower.]], [[You let your mind tap into your steam generators for energy, increasing your Mindpower in proportion to your steam level: %d when at full steam and 0 when at 0 steam.
		Using a psionic talent will feedback into your generators, increasing your Steam power by %d for your next steamtech talent.
		Using a steamtech talent will feedback into psionic focus, increasing your psi level by %d.
		The effects increase with your Willpower.]], "tformat")
t("Improved Gestalt", "Improved Gestalt", "talent name")
t([[When you use a steamtech talent while Gestalt is active you drain some residual power to form a psionic shield.
		...
		The effects increase with your Mindpower.]], [[When you use a steamtech talent while Gestalt is active you drain some residual power to form a psionic shield.
		The shield forms for 3 turns and absorbs %d damage.
		The effects increase with your Mindpower.]], "tformat")
t("Instant Channeling", "Instant Channeling", "talent name")
t("You must have either a psionic damage shield active or Improved Gestalt available to use this talent.", "You must have either a psionic damage shield active or Improved Gestalt available to use this talent.", "logPlayer")
t([[Instantly channel all of your remaining steam to replenish your psi energies and either enhance your active psionic damage shield or trigger a new one.
		...
		This talent requires Gestalt to be active and either an active psionic damage shield or Improved Gestalt off cooldown.]], [[Instantly channel all of your remaining steam to replenish your psi energies and either enhance your active psionic damage shield or trigger a new one.
		The (new or existing) shield duration is increased by 3 turns and its power is boosted by %d%% of the steam used.
		You restore psi equal to %d%% of the steam used.
...
t("Forced Gestalt", "Forced Gestalt", "talent name")
...
-- texte non traduit
--[==[
t("Vaporous Step", "Vaporous Step", "talent name")
...
t("Inhale Vapours", "Inhale Vapours", "talent name")
t([[When you deactivate Vaporous Step, if the psychoport succeeds you inhale some of the vapours, regenerating %d steam and %d life.
		...
		The healing done will increase with your Mindpower.]], [[When you deactivate Vaporous Step, if the psychoport succeeds you inhale some of the vapours, regenerating %d steam and %d life.
		The effects will be multiplied by 33%% (diminutive) for each charge of Vaporous Step.
		The healing done will increase with your Mindpower.]], "tformat")
t("Psionic Fog", "Psionic Fog", "talent name")
t([[Using the steam of your generators you shape it into a psionic fog that lasts %d turns. Any foes caught inside will take %0.2f damage per turn and be seared, reducing their fire resistance by %d%% and and mind save by %d.
		The damage will increase with your Mindpower.]], [[Using the steam of your generators you shape it into a psionic fog that lasts %d turns. Any foes caught inside will take %0.2f damage per turn and be seared, reducing their fire resistance by %d%% and and mind save by %d.
		The damage will increase with your Mindpower.]], "tformat")
t("Uncertainty Principle", "Uncertainty Principle", "talent name")
...
t([[While inside a psionic fog the quantum state of space is warped by your powerful tech-augmented psionic powers.
		...
		This effect has a cooldown.]], [[While inside a psionic fog the quantum state of space is warped by your powerful tech-augmented psionic powers.
		When you would get hit you instead find yourself in an adjacent location.
...
-- texte non traduit
--[==[
t("Galvanic Rod", "Galvanic Rod", "talent name")
t("You need an arcane dynamo to cast this spell.", "You need an arcane dynamo to cast this spell.", "logPlayer")
t([[You summon a galvanic rod at a location. Upon arrival the rod releases a shock in radius %d dealing %0.2f galvanic damage (fire and lightning) to all creatures.
		...
		The damage will increase with your Spellpower.]], [[You summon a galvanic rod at a location. Upon arrival the rod releases a shock in radius %d dealing %0.2f galvanic damage (fire and lightning) to all creatures.
		You have 3 rods each with their own %d turns cooldown.
		This spell works with Burning Wake.
		This spell has 25%% chance to try to activate Hurricane, if used.
		The damage will increase with your Spellpower.]], "tformat")
t("Galvanic Arcing", "Galvanic Arcing", "talent name")
t([[Using your arcane power you force galvanic rods to linger for %d turns. While lingering they are inert, but can link up to other rods.
		...
		This spell has 15%% chance to try to activate Hurricane, if used.
		The damage will increase with your Spellpower.]], "tformat")
t("Unstable Blast", "Unstable Blast", "talent name")
t("You need Galvanic Arcing active and at least one rod to cast this spell.", "You need Galvanic Arcing active and at least one rod to cast this spell.", "logPlayer")
t([[Reaching through the aether you temporarily destabilize a galvanic rod's control systems. (Using your weapon as a rod does not count as a valid target)
		...
		This spell works with Burning Wake.
		The damage will increase with your Spellpower.]], "tformat")
t("Energy Mass Conversion", "Energy Mass Conversion", "talent name")
t("You need Galvanic Arcing active and three rods to cast this spell.", "You need Galvanic Arcing active and three rods to cast this spell.", "logPlayer")
...
-- texte non traduit
--[==[
t("Metaphasic Spin", "Metaphasic Spin", "talent name")
t("You need an arcane dynamo to cast this spell.", "You need an arcane dynamo to cast this spell.", "logPlayer")
t("Select the steamsaw to use?", "Select the steamsaw to use?", "_t")
...
t("Reality Breach", "Reality Breach", "talent name")
t("You need to activate Metatemporal Spinner to cast this spell.", "You need to activate Metatemporal Spinner to cast this spell.", "logPlayer")
t("#Source# annihilates '#Target#'!", "#Source# annihilates '#Target#'!", "logCombat")
t([[Spin your saw at incredible speeds for an instant, fully breaking reality in a 3-wide beam in front of you.
		...
		The breach is so deep that the beam will always have the maximum possible length it can.
		The damage will increase with your Spellpower.]], "tformat")
t("Ethereal Steam", "Ethereal Steam", "talent name")
t([[You reach out through the aether to all creatures in sight that were slowed by Reality Breach or Congeal Time.
		...
		As long as at least one link is up, the cooldown of your Metaphasic Spin spell is set to 6 turns instead of 30.
		The damage will increase with your Spellpower.]], "tformat")
t("Metaphasic Echoes", "Metaphasic Echoes", "talent name")
t("You can only cast this spell on the turn after Reality Breach.", "You can only cast this spell on the turn after Reality Breach.", "logPlayer")
...
-- texte non traduit
--[==[
t("Electron Incantation", "Electron Incantation", "talent name")
t("You need an arcane dynamo to cast this spell.", "You need an arcane dynamo to cast this spell.", "logPlayer")
t("You can only cast this spell after casting an other technomancy spell.", "You can only cast this spell after casting an other technomancy spell.", "logPlayer")
t([[After casting a technomancy spell you store some of its energies that you can then use to overload your arcane dynamo, increasing the steam it generates per 10 mana spent by 4 for 4 turns.
		...
		The damage will increase with your Spellpower.]], [[After casting a technomancy spell you store some of its energies that you can then use to overload your arcane dynamo, increasing the steam it generates per 10 mana spent by 4 for 4 turns.
		In addition the energies spills outward in radius 3, dealing %0.2f damage (damage type based on the type of technomancy spell used).
		This spell is only usable after casting a technomancy spell and until you use any other spell or talent.
		The damage will increase with your Spellpower.]], "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Micro Spiderbot", "Micro Spiderbot", "talent name")
t("You need an arcane dynamo to cast this spell.", "You need an arcane dynamo to cast this spell.", "logPlayer")
...
t("Cryogenic Digs", "Cryogenic Digs", "talent name")
t([[Each time a spiderbot expires it digs around, producing either a Glacial Vapour (%0.2f cold damage and doing 30%% more damage to wet targets) or Earthquake (%0.2f physical damage and 25%% chances to stun for 2 turns) of radius 1 that last for %d turns.
		...
		The damage will increase with your Spellpower.]], [[Each time a spiderbot expires it digs around, producing either a Glacial Vapour (%0.2f cold damage and doing 30%% more damage to wet targets) or Earthquake (%0.2f physical damage and 25%% chances to stun for 2 turns) of radius 1 that last for %d turns.
		Those special kinds of Glacial Vapour and Earthquake do not affect the caster.
		The damage will increase with your Spellpower.]], "tformat")
t("Ramming Bot", "Ramming Bot", "talent name")
t("You need an arcane dynamo and an active spiderbot to cast this spell.", "You need an arcane dynamo and an active spiderbot to cast this spell.", "logPlayer")
t([[Command a random spiderbot to jump onto your target at ramming speed. The impact destroys the bot (possibly triggering Cryogenic Digs).
		...
		The cooldown of this spell is affected by Body of Stone.
		The damage will increase with your Spellpower.]], "tformat")
t("Spiderbot Shield", "Spiderbot Shield", "talent name")
t([[You call back up to %d spiderbots to you to create protective barrier for %d turns.
		...
		The cooldown of this spell is affected by Body of Stone.
		]], [[You call back up to %d spiderbots to you to create protective barrier for %d turns.
		Spiderbots have %d life and they take damage in order, always fully absorbing the blow that destroyed them.
		If Cryogenic Digs is active when a spiderbot is destroyed it jumps to the attacker and triggers the dig there.
		The cooldown of this spell is affected by Body of Stone.
		]], "tformat")
...
-- texte non traduit
--[==[
t("Rocket Pod", "Rocket Pod", "talent name")
t([[You equip an automated, shoulder mounted rocket launcher. Each turn it will launch rockets at up to %d enemies in weapon range, dealing %d%% steamgun damage as fire.
		The rockets will pass harmlessly through allies, but on-hit effects triggered by them only deal 50%% of their usual damage.]], [[You equip an automated, shoulder mounted rocket launcher. Each turn it will launch rockets at up to %d enemies in weapon range, dealing %d%% steamgun damage as fire.
...
t("Incendiary Powder", "Incendiary Powder", "talent name")
...
t("Death From Above", "Death From Above", "talent name")
t([[You use your rocket pods to launch yourself into the air for 3 turns, firing a radius 2 barrage of rockets that deal %d%% steamgun damage as fire in radius 2. 
		...
		Using any talent other than Rocket Barrage will end this effect immediately.]], [[You use your rocket pods to launch yourself into the air for 3 turns, firing a radius 2 barrage of rockets that deal %d%% steamgun damage as fire in radius 2. 
		While flying you gain %d%% movement speed, %d%% chance to evade melee and ranged attacks, and can reactivate this talent at will to repeat the rocket barrage.
		Using any talent other than Rocket Barrage will end this effect immediately.]], "tformat")
t("Rocket Barrage", "Rocket Barrage", "talent name")
t("Fires a barrage of rockets in radius 2, dealing %d%% steamgun damage as fire.", "Fires a barrage of rockets in radius 2, dealing %d%% steamgun damage as fire.", "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Continuous Butchery", "Continuous Butchery", "talent name")
t("You require a steamsaw for this talent.", "You require a steamsaw for this talent.", "logPlayer")
t([[You attune your saws to a specific target for 5 turns.
		...
		#{italic}#Metal your foes to death!#{normal}#]], [[You attune your saws to a specific target for 5 turns.
		Each time you strike this target all damage done with steamsaws (including by other talents) is increased by +%d%%.
		If you strike any other foe the bonus ends.
		#{italic}#Metal your foes to death!#{normal}#]], "tformat")
t("Explosive Saw", "Explosive Saw", "talent name")
t([[You send a saw mounted on an automated steam propulsor to assault a foe, dealing %0.2f physical damage each turn for 4 turns and silencing it.
		...
		The damage will increase with your Steampower.]], [[You send a saw mounted on an automated steam propulsor to assault a foe, dealing %0.2f physical damage each turn for 4 turns and silencing it.
		At the end of the duration, the saw explodes for %0.2f fire damage and flies back, pulling the target up to %d tiles towards you.
		The damage will increase with your Steampower.]], "tformat")
t("Mow Down", "Mow Down", "talent name")
...
t("Tech Overload", "Tech Overload", "talent name")
t([[You override all security measures of your tinkers, allowing you to reset the cooldown of %d of most of your steamtech talents of tier %d or less and instantly increases your steam level by %d%% of the maximum.
		...
		#{italic}#Master of Tech, Master of Death!#{normal}#]], [[You override all security measures of your tinkers, allowing you to reset the cooldown of %d of most of your steamtech talents of tier %d or less and instantly increases your steam level by %d%% of the maximum.
		In addition for 6 turns your maximum steam capacity is doubled, but steam regeneration is halved.
...
-- texte non traduit
--[==[
t("Pulse Detonator", "Pulse Detonator", "talent name")
t([[Sends a pulse detonator to the target. Upon arrival it explodes in radius 4 cone, dealing %0.2f physical damage, knocking back foes by 3 and dazing them for %d turns.
		Damage increases with your steampower.]], [[Sends a pulse detonator to the target. Upon arrival it explodes in radius 4 cone, dealing %0.2f physical damage, knocking back foes by 3 and dazing them for %d turns.
		Damage increases with your steampower.]], "tformat")
t("Flying Grapple", "Flying Grapple", "talent name")
t("Flying Grapple", "Flying Grapple", "_t")
t("A flying grapple pull %s into %s!", "A flying grapple pull %s into %s!", "logSeen")
t([[You send a small steam-powered flying grapple to a target. The drone is homing so if the target moves it will follow.
		...
		]], [[You send a small steam-powered flying grapple to a target. The drone is homing so if the target moves it will follow.
		When it reaches its target it deploys grapples in all directions around it in radius 4.
		The grapples latch onto any foes and pull them toward the target. If they are stopped by a creature (or the target) both them and the creature take %0.2f physical damage.
		]], "tformat")
t("Net Projector", "Net Projector", "talent name")
t("%s resists the net.", "%s resists the net.", "logSeen")
t([[Sends a lightly electrified net of radius 2 toward a target, all creatures caught inside will be pinned in place for 5 turns.
		While the electricity is not enough to do damage it does shock their body, reducing all resistances by %d%%.]], [[Sends a lightly electrified net of radius 2 toward a target, all creatures caught inside will be pinned in place for 5 turns.
		While the electricity is not enough to do damage it does shock their body, reducing all resistances by %d%%.]], "tformat")
t("Sawfield", "Sawfield", "talent name")
t([[For 4 turns many small saws circle around the target in radius %d, making any creature caught inside bleed for %0.2f physical damage.
		Damage increases with your steampower.]], [[For 4 turns many small saws circle around the target in radius %d, making any creature caught inside bleed for %0.2f physical damage.
		Damage increases with your steampower.]], "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Automated Cloak Tessellation", "Automated Cloak Tessellation", "talent name")
t("@Source@ tessellates @hisher@ cloak!", "@Source@ tessellates @hisher@ cloak!", "_t")
...
t([[You tessellate your cloak with small pieces of metal, providing %d damage reduction against all attacks.
		The myriad metal scraps also help against incoming projectiles, providing a %d%% chance of deflecting them to a nearby spot.]], [[You tessellate your cloak with small pieces of metal, providing %d damage reduction against all attacks.
...
t("Cloak Gesture", "Cloak Gesture", "talent name")
t("@Source@ weaves @hisher@ cloak!", "@Source@ weaves @hisher@ cloak!", "_t")
t([[With a gesture of your cloak, you drop a small incendiary device in front of you, creating a wall of thick steam of %d length that burns creatures passing it for %0.2f fire damage and blocks sight for 5 turns.
		...
		Damage increases with your steampower.]], [[With a gesture of your cloak, you drop a small incendiary device in front of you, creating a wall of thick steam of %d length that burns creatures passing it for %0.2f fire damage and blocks sight for 5 turns.
		At level 5 the action is so perfect that your foes even lose track of you entirely.
		Damage increases with your steampower.]], "tformat")
t("Embedded Restoration Systems", "Embedded Restoration Systems", "talent name")
t("#LIGHT_BLUE#%s's embedded restoration system activate.", "#LIGHT_BLUE#%s's embedded restoration system activate.", "logSeen")
t("%s activates %s cloak's restoration systems!", "%s activates %s cloak's restoration systems!", "logSeen")
t("%s deactivates %s cloak's restoration systems.", "%s deactivates %s cloak's restoration systems.", "logSeen")
t([[Your cloak is lined with an automated health system that activate when no enemies are visible.
		...
		The system can only trigger once every %d turns.]], [[Your cloak is lined with an automated health system that activate when no enemies are visible.
		When it triggers, you will be healed for %d life.
		At talent level 3, it will also remove one detrimental physical effect.
		The system can only trigger once every %d turns.]], "tformat")
t("Cloaking Device", "Cloaking Device", "talent name")
t([[Trigger an array of small mirrors to appear all over your cloak.
		...
		Stealth power increases with your steampower.]], [[Trigger an array of small mirrors to appear all over your cloak.
		The mirrors are positioned to reflect all light shining on you, granting %d stealth power for 10 turns.
...
t("critical steam engine", "critical steam engine", "_t")
t([[Throw a small, unstable steam engine on the battlefield that will go critical after 2 turns.
		...
		#{italic}#Tick Tock Tick BOOM!#{normal}#]], [[Throw a small, unstable steam engine on the battlefield that will go critical after 2 turns.
		It will then create an explosion of hot vapour in radius %d, burning all foes for %0.2f fire damage.
		Any bleeding foe caught in the flames will take 40%% more damage.
		Damage scales with your Steampower.
		#{italic}#Tick Tock Tick BOOM!#{normal}#]], "tformat")
t("Lingering Cloud", "Lingering Cloud", "talent name")
t([[Explosive Steam Engine vapour now lingers for 5 turns.
		...
		Damage scales with your Steampower.
		#{italic}#Modern technology at the service of burnination!#{normal}#]], [[Explosive Steam Engine vapour now lingers for 5 turns.
		Each turn, bleeding foes inside the cloud will take %0.2f fire damage.
		Any steamtech-using creature will also regenerate %d additional steam per turn while inside the cloud.
		Damage scales with your Steampower.
		#{italic}#Modern technology at the service of burnination!#{normal}#]], "tformat")
t("Tremor Engine", "Tremor Engine", "talent name")
t("tremor engine", "tremor engine", "_t")
...
t([[On its last pulse, your Tremor Engine shakes violently, raising a volcano for %d turns.
		...
		Damage scales with your Steampower.
		#{italic}#All the fury of fire at your disposal!#{normal}#]], [[On its last pulse, your Tremor Engine shakes violently, raising a volcano for %d turns.
		Each turn, the volcano will send out fiery boulders that deal %0.2f fire and %0.2f physical damage.
		Damage scales with your Steampower.
...
-- texte non traduit
--[==[
t("Saw Wheels", "Saw Wheels", "talent name")
t("You require a steamsaw for this talent.", "You require a steamsaw for this talent.", "logPlayer")
t([[Firmly plant your steamsaws in the ground, using them to propel yourself very quickly (+%d%% movement speed).
		...
		#{italic}#The wheels of death! Amazing!#{normal}#]], [[Firmly plant your steamsaws in the ground, using them to propel yourself very quickly (+%d%% movement speed).
		Any foes on either side of your movement get wrecked by the saws, knocking them 3 tiles away from you.
		Attacking or using any talent will break this effect.
		When this effect is broken or cancelled the sudden change in motion deals %d%% weapon damage to all foes around you. To do full damage you need to have moved at least 5 times, otherwise damage is lower (or null for no movement).
		#{italic}#The wheels of death! Amazing!#{normal}#]], "tformat")
t("Grinding Shield", "Grinding Shield", "talent name")
t([[Spin your saws wildly around you to create a wall of steamy sawteeth.
		...
		#{italic}#Split their bones on the saws of death!#{normal}#]], [[Spin your saws wildly around you to create a wall of steamy sawteeth.
		All melee damage against you is reduced by %d%%, you have %d%% chance to evade projectiles and you can never take a blow that deals more than %d%% of your max life.
		#{italic}#Split their bones on the saws of death!#{normal}#]], "tformat")
t("Punishment", "Punishment", "talent name")
t("#CRIMSON#%s unleashes a punishing strike for %d%% bonus damage!", "#CRIMSON#%s unleashes a punishing strike for %d%% bonus damage!", "logSeen")
t([[Slam your saws into your target, dealing 100%% weapon damage + %d%% per physical, magical, or mental effect on them (up to 7 effects).
		...
		#{italic}#The Metal Punisher!#{normal}#]], [[Slam your saws into your target, dealing 100%% weapon damage + %d%% per physical, magical, or mental effect on them (up to 7 effects).
			Sustains are not effects.
		#{italic}#The Metal Punisher!#{normal}#]], "tformat")
t("Battlefield Veteran", "Battlefield Veteran", "talent name")
t([[You have lived through many battles, and your experience makes you a gritty veteran.
		...
		#{italic}#Domination for all!#{normal}#]], [[You have lived through many battles, and your experience makes you a gritty veteran.
		Saw Wheels end of effect attack increased by %d%%.
		Grinding Shield lets you live below your normal limits, up to -%d life.
		Punishment has a %d%% chance to have its cooldown reduced by 1 for each effect.
...
-- texte non traduit
--[==[
t("Massive Physique", "Massive Physique", "talent name")
t([[Working iron has honed your body into an amazing shape, granting %d strength and constitution.
		At talent level 5, you are so incredibly built that you gain one size category.]], [[Working iron has honed your body into an amazing shape, granting %d strength and constitution.
		At talent level 5, you are so incredibly built that you gain one size category.]], "tformat")
t("Endless Endurance", "Endless Endurance", "talent name")
t([[Working long hours at a forge has made you incredibly slow to tire and given you endless vitality.
		...
		Stopping you is nearly impossible; your pinning resistance is increased by %d%%.]], [[Working long hours at a forge has made you incredibly slow to tire and given you endless vitality.
		Your healing factor is increased by %d%% and your life regeneration by %0.2f.
		Stopping you is nearly impossible; your pinning resistance is increased by %d%%.]], "tformat")
t("Life in the Flames", "Life in the Flames", "talent name")
t([[Slaving for many years at the forge has made you more resilient to physical pain and fire burns.
		...
		At talent level 5, you are so accustomed to the flames that you become immune to the fireburn effect.]], [[Slaving for many years at the forge has made you more resilient to physical pain and fire burns.
		Your fire resistance is increased by %d%% and your physical resistance by %d%%.
		At talent level 5, you are so accustomed to the flames that you become immune to the fireburn effect.]], "tformat")
t("Craftsman's Eye", "Craftsman's Eye", "talent name")
t([[You can easily see the weak points in your enemy's defenses. After all, you know to look for the same flaws in your own work.
		...
		At talent level 5, you can also fight stealthed and invisible creatures without penalty.]], [[You can easily see the weak points in your enemy's defenses. After all, you know to look for the same flaws in your own work.
		This grants %d armour penetration and %d%% critical strike multiplier.
...
-- texte non traduit
--[==[
t("Overheat Bullets", "Overheat Bullets", "talent name")
t("You must dual wield steamguns for this talent.", "You must dual wield steamguns for this talent.", "logPlayer")
t([[By sending a stream of hot steam over your bullets you overheat them. For the next %d turns, each bullet will set the target ablaze, making it burn for %0.2f fire damage over 5 turns (most of your shooting talents fire two bullets at once).
		...
		Only one bullet enhancement can be used at once.]], [[By sending a stream of hot steam over your bullets you overheat them. For the next %d turns, each bullet will set the target ablaze, making it burn for %0.2f fire damage over 5 turns (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], "tformat")
t("Supercharge Bullets", "Supercharge Bullets", "talent name")
t([[You are able to polish your bullets so well they can go through multiple targets for %d turns.
		...
		Only one bullet enhancement can be used at once.]], [[You are able to polish your bullets so well they can go through multiple targets for %d turns.
		This also improves their armour penetration by %d.
		Only one bullet enhancement can be used at once.]], "tformat")
t("Percussive Bullets", "Percussive Bullets", "talent name")
t([[You swap your bullets for more massive ones for %d turns.
		...
		The chances to knockback and stun increase with your Steampower.
		Only one bullet enhancement can be used at once.]], "tformat")
t("Combustive Bullets", "Combustive Bullets", "talent name")
t([[You coat your bullets with flammable materials, for the next %d turns each bullet will explode when it hits its target, dealing %0.2f fire damage to all foes within radius 2 (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], [[You coat your bullets with flammable materials, for the next %d turns each bullet will explode when it hits its target, dealing %0.2f fire damage to all foes within radius 2 (most of your shooting talents fire two bullets at once).
		Damage will increase with Steampower.
		Only one bullet enhancement can be used at once.]], "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Steamsaw Mastery", "Steamsaw Mastery", "talent name")
t("Increases weapon damage by %d%% and Physical Power by 30 when using steamsaws.", "Increases weapon damage by %d%% and Physical Power by 30 when using steamsaws.", "tformat")
t("Overheat Saws", "Overheat Saws", "talent name")
t("You require two steamsaws for this talent.", "You require two steamsaws for this talent.", "logPlayer")
t([[Channel hot steam around your saws, burning foes you strike in melee for %0.2f fire damage over 3 turns (which can stack)!
		#{italic}#Hot, steamy maiming!#{normal}#]], [[Channel hot steam around your saws, burning foes you strike in melee for %0.2f fire damage over 3 turns (which can stack)!
		#{italic}#Hot, steamy maiming!#{normal}#]], "tformat")
t("Tempest of Metal", "Tempest of Metal", "talent name")
t([[Continuously swing your steamsaws around you, dealing %d%% weapon damage to adjacent foes each time you attack.
		...
		#{italic}#Make the metal talk!#{normal}#]], [[Continuously swing your steamsaws around you, dealing %d%% weapon damage to adjacent foes each time you attack.
		Your chaotic motions make it difficult for anything to hit you, granting %d%% chance to completely negate all damage.
		Damage avoidance chance increases with Steampower.
		#{italic}#Make the metal talk!#{normal}#]], "tformat")
t("Overcharge Saws", "Overcharge Saws", "talent name")
t([[You temporarily overcharge the saw motors, increasing the effective talent level of all saw talents by %d%% for %d turns.
		#{italic}#The pain shall never stop!#{normal}#]], [[You temporarily overcharge the saw motors, increasing the effective talent level of all saw talents by %d%% for %d turns.
...
t("Caustic Dispersal", "Caustic Dispersal", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
t("You fire a toxic shell that explodes in radius %d, dealing %d%% weapon damage as acid and leaving behind a cloud of miasma for %d turns that inherits all effects from your Miasma Engine.", "You fire a toxic shell that explodes in radius %d, dealing %d%% weapon damage as acid and leaving behind a cloud of miasma for %d turns that inherits all effects from your Miasma Engine.", "tformat")
t("Smogscreen", "Smogscreen", "talent name")
...
-- texte non traduit
--[==[
t("Therapeutics", "Therapeutics", "talent name")
t([[Allows you to create therapeutic tinkers of level %d.
		...
		%s]], [[Allows you to create therapeutic tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Chemistry", "Chemistry", "talent name")
t([[Allows you to create chemical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[Allows you to create chemical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Explosives", "Explosives", "talent name")
t([[Allows you to create explosive tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[Allows you to create explosive tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Steam Power", "Steam Power", "talent name")
t("Increases the efficiency of all steamtech you operate, granting %d steampower.", "Increases the efficiency of all steamtech you operate, granting %d steampower.", "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Grenade Launcher", "Grenade Launcher", "talent name")
t([[You mount a grenade launcher on your steamgun that launches high explosive rounds. Each time you make a basic attack with your steamgun or a heavy weapon, you fire a grenade at the target that explodes for %d%% steamgun damage in radius %d.
		...
		You can only fire a single grenade once every 9 turns.]], [[You mount a grenade launcher on your steamgun that launches high explosive rounds. Each time you make a basic attack with your steamgun or a heavy weapon, you fire a grenade at the target that explodes for %d%% steamgun damage in radius %d.
		This talent also reinforces the armor of you and your minions to give you immunity to your own grenades.
		You can only fire a single grenade once every 9 turns.]], "tformat")
t("Reactive Armor", "Reactive Armor", "talent name")
t([[You line your armor with explosive plating that detonates when struck. On taking a melee or ranged hit that deals more than 8%% of your maximum life a plate detonates, reducing the damage taken by %d%% and triggering a basic grenade attack in a radius %d cone projected at the target dealing %d%% of its usual damage.
		...
		You have up to 3 plates at a time, and regain one every %d turns.]], [[You line your armor with explosive plating that detonates when struck. On taking a melee or ranged hit that deals more than 8%% of your maximum life a plate detonates, reducing the damage taken by %d%% and triggering a basic grenade attack in a radius %d cone projected at the target dealing %d%% of its usual damage.
		This cannot trigger more than once per turn.
		Blocking an attack with your shield will also trigger the retaliation damage, if it has not already triggered this turn.
		You have up to 3 plates at a time, and regain one every %d turns.]], "tformat")
t("Sapper", "Sapper", "talent name")
...
t([[You load a magazine of %d grenades into your launcher, causing your next %d shots to fire a random grenade type in place of your usual Grenade Launcher, dealing 50%% of the usual grenade damage.
		...
		Your Grenade Launcher talent must be on cooldown to use this talent, and the magazine will only last for 6 turns.]], [[You load a magazine of %d grenades into your launcher, causing your next %d shots to fire a random grenade type in place of your usual Grenade Launcher, dealing 50%% of the usual grenade damage.
		While the magazine is loaded your attack speed is increased by %d%%.
		Your Grenade Launcher talent must be on cooldown to use this talent, and the magazine will only last for 6 turns.]], "tformat")
t("Incendiary Grenade", "Incendiary Grenade", "talent name")
t("Enhance your grenade with an incendiary agent that burns through armor, dealing fire damage over 3 turns and increasing damage taken while burning by %d%%.", "Enhance your grenade with an incendiary agent that burns through armor, dealing fire damage over 3 turns and increasing damage taken while burning by %d%%.", "tformat")
t("Chemical Grenade", "Chemical Grenade", "talent name")
t("Enhance your grenade with incapacitating chemicals that deal acid damage and reduce global speed by %d%% for 3 turns.", "Enhance your grenade with incapacitating chemicals that deal acid damage and reduce global speed by %d%% for 3 turns.", "tformat")
t("Shock Grenade", "Shock Grenade", "talent name")
t("Enhance your grenade with an electrical charge, causing it to deal lightning damage and shock targets for %d turns, reducing stun and pin resistance by 50%%.", "Enhance your grenade with an electrical charge, causing it to deal lightning damage and shock targets for %d turns, reducing stun and pin resistance by 50%%.", "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Mechanical Arms", "Mechanical Arms", "talent name")
t([[Using psionic forces you maintain in place on your back two giant horrific mechanical arms.
		...
		Creatures harassed by the mechanical arms have their damage reduced by %d%% for 5 turns.]], [[Using psionic forces you maintain in place on your back two giant horrific mechanical arms.
		Each basic turn (as if you had 100%% speed) they can automatically attack up to 2 foes within range 3 with a mindstar attack doing %d%% weapon damage.
		Creatures harassed by the mechanical arms have their damage reduced by %d%% for 5 turns.]], "tformat")
t("Lucid Shot", "Lucid Shot", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
t([[Fire a powerful shot at a foe doing %d%% weapon damage.
		If the creature, or any creatures in radius 3, was affected by a fear or nightmare effect it violently wakes up, shaking it off only to find itself disoriented, unable to discern friends from foes for %d turns.]], [[Fire a powerful shot at a foe doing %d%% weapon damage.
...
t("Psy Worm", "Psy Worm", "talent name")
t([[Fire a psionic-enhanced shot at a foe doing %d%% mind weapon damage and infecting it with a psy worm for 8 turns.
		...
		When a creature infected by Psy Worm dies it spreads to all enemies in a radius of 3.]], [[Fire a psionic-enhanced shot at a foe doing %d%% mind weapon damage and infecting it with a psy worm for 8 turns.
		Each turn the worm will do %0.2f mind damage and restore %d psi to you, double if stunned or feared.
		Also each turn the worm has 25%% chances to spread to a nearby foe in radius 3.
		When a creature infected by Psy Worm dies it spreads to all enemies in a radius of 3.]], "tformat")
t("No Hope", "No Hope", "talent name")
t("Entering the mind of your foe you manipulate it to make it lose hope of defeating you, reducing all its damage by 40%% for %d turns.", "Entering the mind of your foe you manipulate it to make it lose hope of defeating you, reducing all its damage by 40%% for %d turns.", "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Slip Away", "Slip Away", "talent name")
t([[Using small steam motors to enhance your movements, you are able to slip past up to %d foes in a line.
		After passing the targets, you will quickly run %d tiles away.]], [[Using small steam motors to enhance your movements, you are able to slip past up to %d foes in a line.
		After passing the targets, you will quickly run %d tiles away.]], "tformat")
t("Agile Gunner", "Agile Gunner", "talent name")
t([[The thrill of the hunt invigorates you. For each foe in radius %d around you, you gain 20%% movement speed (up to %d%%).
		Current bonus: %d%%.]], [[The thrill of the hunt invigorates you. For each foe in radius %d around you, you gain 20%% movement speed (up to %d%%).
		Current bonus: %d%%.]], "tformat")
t("Awesome Toss", "Awesome Toss", "talent name")
t("You require two steamguns for this talent.", "You require two steamguns for this talent.", "logPlayer")
t([[In an awesome feat of agility and technological prowess, you toss both of your steamguns in the air, causing them to spin madly for 3 turns.
		...
		The spectacle is so distracting that your foes have a hard time concentrating on you, increasing all of your resistances by %d%%.]], [[In an awesome feat of agility and technological prowess, you toss both of your steamguns in the air, causing them to spin madly for 3 turns.
		Each turn, they will fire twice at random targets in range, dealing %d%% weapon damage.
		While the guns are airborne, you are disarmed and cannot attack.
...
t("Dazzling Jump", "Dazzling Jump", "talent name")
t("%s seems immune to the powerful kick.", "%s seems immune to the powerful kick.", "logSeen")
t([[While your foes are distracted by your Awesome Toss, you use powerful steam motors to jump into the air and kick a target %d tiles away.
		The impact is so great that it ripples outwards, slowing all creatures in radius 3 by %d%% for 4 turns while the reaction force propels you %d tiles backwards.]], [[While your foes are distracted by your Awesome Toss, you use powerful steam motors to jump into the air and kick a target %d tiles away.
...
-- texte non traduit
--[==[
t("Emergency Steam Purge", "Emergency Steam Purge", "talent name")
...
t("Innovation", "Innovation", "talent name")
t([[Your knowledge of physical laws allows you to use and improve equipment in ways their creators never dreamed.
		Increases all stats, saves, armour, and defense bonuses by %d%% on equipment that is crafted by a master or powered by steamtech.]], [[Your knowledge of physical laws allows you to use and improve equipment in ways their creators never dreamed.
...
t("Supercharge Tinkers", "Supercharge Tinkers", "talent name")
t([[Using a huge amount of steam, you temporarily supercharge your tinkers and other steam-powered talents.
		For %d turns, you gain %d steampower and %d%% steamtech critical chance.]], [[Using a huge amount of steam, you temporarily supercharge your tinkers and other steam-powered talents.
		For %d turns, you gain %d steampower and %d%% steamtech critical chance.]], "tformat")
t("Last Engineer Standing", "Last Engineer Standing", "talent name")
t([[Sometimes, being a master tinker requires taking risks; yours are more calculated than others.
		Gain %d cunning, %d physical save, %d%% resistance to self-inflicted damage, and %d%% chance to avoid being critically hit.]], [[Sometimes, being a master tinker requires taking risks; yours are more calculated than others.
...
t([[You add a portable furnace to your steam generators.
		...
		]], [[You add a portable furnace to your steam generators.
		While it is active your fire and physical damage increases by %d%% and your fire and physical resistance penetration by %d%%.
		#{italic}#Burninate all with awesome Steam power!#{normal}#
		]], "tformat")
t("Molten Metal", "Molten Metal", "talent name")
...
t("Furnace Vent", "Furnace Vent", "talent name")
t([[Open the vents on your furnace, creating a conic blast dealing up to %0.2f fire damage at 10 molten points (currently %0.2f).
		...
		]], [[Open the vents on your furnace, creating a conic blast dealing up to %0.2f fire damage at 10 molten points (currently %0.2f).
		All molten points are consumed.
		The damage will increase with your Steampower.
		#{italic}#By fire be purged!#{normal}#
		]], "tformat")
t("Melting Point", "Melting Point", "talent name")
...
-- texte non traduit
--[==[
t("Autoloader", "Autoloader", "talent name")
t([[You link your weapons and shield to your steam generators, using them to load ammunition and improve the power of your weapons. 
		...
		In addition, your steamgun and heavy weapon shots now bypass friendly targets harmlessly.]], [[You link your weapons and shield to your steam generators, using them to load ammunition and improve the power of your weapons. 
		Each time you fire your Steamgun, you have a %d%% chance to reload 1 Heavy Weapon ammo.
		Each time you fire a Heavy Weapon you reload %d ammo.
		Each time you raise your shield to block, you reload 1 Heavy Weapon ammo.
		This also increases weapon damage by %d%% and Physical Power by 30 when using steamguns or heavy weapons.
		In addition, your steamgun and heavy weapon shots now bypass friendly targets harmlessly.]], "tformat")
t("Exoskeleton", "Exoskeleton", "talent name")
t("#STEEL_BLUE#(%d exoskeleton)#LAST#", "#STEEL_BLUE#(%d exoskeleton)#LAST#", "tformat")
t([[Current exoskeleton life: %d/%d
		...
		The armor's maximum life will increase with your Steampower.]], [[Current exoskeleton life: %d/%d
		You craft a set of steam powered armor that fits over your regular armor, enhancing your defense. The armor has %d life, and 50%% of all damage taken is redirected to it.
		Your powered armour repairs 5%% of it’s maximum life each turn, and each time you spend steam it will be repaired for %d%% of the steam cost.
		The armor's maximum life will increase with your Steampower.]], "tformat")
t("Hypervision Goggles", "Hypervision Goggles", "talent name")
...
In addition, the goggles passively increase your stealth, invisibility and trap detection by %d.]], [[Enhance your vision for %d turns, giving you vision of all targets in range %d, even through walls. While the goggles are active you also spot flaws in your opponent's defenses, increasing your resistance penetration by %d%%.
In addition, the goggles passively increase your stealth, invisibility and trap detection by %d.]], "tformat")
t("AED", "AED", "talent name")
...
The healing and damage will increase with your Steampower.]], [[Prepare a defensive device that stores an electrical charge for 8 turns.
If your life falls below 0 while the AED is active it will activate to shock you back into life, negating the triggering attack, restoring %d life and dealing %0.2f lightning damage in radius %d that dazes affected enemies for 3 turns.
If the AED does not activate, the cooldown is reduced by 15 turns.
...
t([[Increases weapon damage by %d%% and Physical Power by 30 when using steamguns.
		Also, increases your reload rate by %d.]], [[Increases weapon damage by %d%% and Physical Power by 30 when using steamguns.
...
t("Uncanny Reload", "Uncanny Reload", "talent name")
t([[You focus on managing your steamgun ammo for %d turns.
		While the effect lasts your attacks do not consume shots.]], [[You focus on managing your steamgun ammo for %d turns.
		While the effect lasts your attacks do not consume shots.]], "tformat")
t("Static Shot", "Static Shot", "talent name")
...
-- texte non traduit
--[==[
t("Strafe", "Strafe", "talent name")
t("@Source@ strafes with @hisher@ steamguns!", "@Source@ strafes with @hisher@ steamguns!", "_t")
t("You must dual wield steamguns for this talent.", "You must dual wield steamguns for this talent.", "logPlayer")
t([[You have learned to fire while moving.
		...
		When Strafe ends you may instantly reload between %d and %d ammo (based on the number of strafes you performed and your ammo capacity).]], [[You have learned to fire while moving.
		In one motion, you fire your double steamguns (100%% weapon damage, 1 tile range penalty) and may then move to an adjacent tile (unless pinned to the ground or immobilized).
		This talent can be activated for up to %d consecutive turns before it goes on cooldown, and takes time according to your steamtech speed or movement speed (if you move), whichever is slower.
...
t("Startling Shot", "Startling Shot", "talent name")
...
t([[You deliberately fire a missing shot at a target, startling it for 3 turns.
		...
		The next shot that hits the startled creature will deal %d%% more damage.]], [[You deliberately fire a missing shot at a target, startling it for 3 turns.
		If the target fails a mental save it instinctively recoils two steps back.
		The next shot that hits the startled creature will deal %d%% more damage.]], "tformat")
t("#Source# fires a retaliatory shot at #Target#!", "#Source# fires a retaliatory shot at #Target#!", "logCombat")
t("Evasive Shots", "Evasive Shots", "talent name")
t([[Using small engines to augment your reflexes you are able to automatically fire retaliatory shots at your foes doing %d%% weapon damage.
		...
		This can only happen once per turn and uses shots as normal.]], [[Using small engines to augment your reflexes you are able to automatically fire retaliatory shots at your foes doing %d%% weapon damage.
		Retaliation shots are fired when you evade/are missed by a melee or ranged attack.
		This can only happen once per turn and uses shots as normal.]], "tformat")
t("Trick Shot", "Trick Shot", "talent name")
t([[Your cunning and dexterity allow you to fire incredible trick shots that can hit multiple targets.
		...
		Your shot deals %d%% weapon damage on its first strike, but loses %d%% damage and %d(%d%%) accuracy with each bounce.]], [[Your cunning and dexterity allow you to fire incredible trick shots that can hit multiple targets.
		You precisely aim your trick shot to ricochet amongst foes you can see so that whenever it hits something solid (creature or solid wall), it will bounce towards the next closest foe.
		It may ricochet up to %d times (or until it misses) within range 5 of your first target and will not target the same foe twice.
...
t([[You gain the ability to equip one of 3 heavy weapons listed below, temporarily granting you a special attack. Heavy weapons are significantly more powerful than a steamgun, but require heavy ammunition to fire. You can store up to %d ammunition at a time, and regenerate 1 every 3 turns while a heavy weapon is not equipped.
		...
		]], [[You gain the ability to equip one of 3 heavy weapons listed below, temporarily granting you a special attack. Heavy weapons are significantly more powerful than a steamgun, but require heavy ammunition to fire. You can store up to %d ammunition at a time, and regenerate 1 every 3 turns while a heavy weapon is not equipped.
...
t("Flamethrower", "Flamethrower", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
...
t([[You replace your steamgun and attack with an incendiary device that projects streams of liquid flame at your foes.
		...
		These attacks cannot miss and ignore armor.]], [[You replace your steamgun and attack with an incendiary device that projects streams of liquid flame at your foes.
...
t("You require heavy ammunition to power your shockstaff.", "You require heavy ammunition to power your shockstaff.", "logPlayer")
t([[You replace your steamgun and attack with a lightning-charged staff to engage in close combat.
		...
		You can charge up to your steamgun's range to make shockstaff attacks.]], [[You replace your steamgun and attack with a lightning-charged staff to engage in close combat.
		
		Deals %d%% steamgun damage as lightning to enemies in a frontal arc, as well as reducing the damage they deal by %d%% for 3 turns. This counts as a melee attack but triggers ammunition on-hit effects. All shockstaff attacks will also make a shield slam for the same damage as lightning. 

		You can charge up to your steamgun's range to make shockstaff attacks.]], "tformat")
t("Stormstrike", "Stormstrike", "talent name")
t([[Sweep your shockstaff, striking all enemies in a frontal arc for %d%% weapon damage as lightning and reducing their damage dealt by %d%% for 3 turns.
		...
		While active this replaces your normal melee attack.]], [[Sweep your shockstaff, striking all enemies in a frontal arc for %d%% weapon damage as lightning and reducing their damage dealt by %d%% for 3 turns.
		If you have a shield, you will also strike them.
		While active this replaces your normal melee attack.]], "tformat")
t("Boltgun", "Boltgun", "talent name")
t("You require heavy ammunition to fire your boltgun.", "You require heavy ammunition to fire your boltgun.", "logPlayer")
t([[You replace your steamgun and attack with a multi-barreled bolt launcher, firing deadly chemical-infused flechettes.
		
		Each attack fires twice for %d%% weapon damage as acid and generates %d steam per hit.]], [[You replace your steamgun and attack with a multi-barreled bolt launcher, firing deadly chemical-infused flechettes.
...
t("Automated Defenses", "Automated Defenses", "talent name")
...
#AQUAMARINE#Boltgun#LAST#: Overcharge your boltgun, firing a single deadly bolt dealing %d%% steamgun damage as acid in a piercing line. For each negative physical, magical, or mental effect on the target, they take an additional %d%% damage (to a maximum of %d%%) and the duration of each negative effect is increased by %d turns.]], [[Push your heavy weapon beyond its normal limits to trigger a powerful effect. This will immediately disable your heavy weapon and expends all remaining ammunition.
#AQUAMARINE#Flamethrower#LAST#: Detonate your fuel tanks, creating a radius 4 explosion that launches you to a chosen tile in range %d. Enemies caught within the explosion take %0.2f fire damage, and further fire damage equal to %d%% of their current burning damage from the volatile fuel.
#AQUAMARINE#Shockstaff#LAST#: Drive your staff into the ground, discharging all remaining power to deal %d%% shockstaff damage as lightning in radius %d. Those struck will be knocked back %d tiles, and if they strike a wall they will emit a static pulse dealing %0.2f lightning damage in radius 1 and stunning them for 5 turns.
...
t("steam %d", "steam %d", "tformat")
t("Implant: Medical Injector", "Implant: Medical Injector", "talent name")
t("#LIGHT_BLUE#Medical injector selected to be used first by salves.", "#LIGHT_BLUE#Medical injector selected to be used first by salves.", "saySimple")
...
t("Medical injector allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "Medical injector allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "tformat")
t("efficiency %d%% / cooldown %d%%", "efficiency %d%% / cooldown %d%%", "tformat")
--]==]
...
You now also use your Cunning in place of Strength when equipping shields as well as when calculating shield damage.]], [[Using your Block talent surrounds you and your minions in a static barrier for 4 turns, increasing all resistances by %d%%. If an enemy deals damage to you or your minions, the barrier will shock them for %d%% of your shield damage.
		This effect cannot damage the same target more than once per turn, and will not interact with Counterstrike.
...
t("Capacitor Discharge", "Capacitor Discharge", "talent name")
...
t("Lightning Web", "Lightning Web", "talent name")
t("lightning web", "lightning web", "_t")
t([[Project a radius 3 electric field from your shield lasting %d turns. Enemies within this field will take an automatic shield strike for %d%% lightning damage each turn, while allies will gain flat damage reduction equal to %d%% (%d) of block value.
		All damage reduced by this effect will be stored for Capacitor Discharge.]], [[Project a radius 3 electric field from your shield lasting %d turns. Enemies within this field will take an automatic shield strike for %d%% lightning damage each turn, while allies will gain flat damage reduction equal to %d%% (%d) of block value.
...
t("no ammo", "no ammo", "_t")
t("bad ammo", "bad ammo", "_t")
t("incompatible missile launcher", "incompatible missile launcher", "_t")
...
t("A heavily armored mechachnical spider, armed to the teeth with advanced weaponry.", "A heavily armored mechachnical spider, armed to the teeth with advanced weaponry.", "_t")
...
The mecharachnid has an inbuilt teleportation device that will recall it to you when combat ends if it is not nearby.]], [[You build a mighty mechanical arachnid to assist you in combat. You can equip the mecharachnid with 2 steamguns, ammunition, and armor of your choice.
If your mecharachnid is dead, this will resurrect it with %d%% of its maximum life. Your mecharachnid is automatically rebuilt at full life when combat ends.
Your mecharachnid has level %d Steamgun Mastery, Combat Accuracy and Armor Training. The mecharachnid uses Dexterity instead of Strength to equip armor.
...
t("#LIGHT_RED#Your mecharachnid is already in chassis %s.", "#LIGHT_RED#Your mecharachnid is already in chassis %s.", "logPlayer")
t("Mecharachnid chassis changed to: #GOLD#%s", "Mecharachnid chassis changed to: #GOLD#%s", "logPlayer")
t("You require your mecharachnid to be adjacent, and must be out of combat.", "You require your mecharachnid to be adjacent, and must be out of combat.", "logPlayer")
t([[You craft a new chassis for your mecharachnid, allowing you to tailor it to different situations. Each chassis grants the mecharachnid a new talent category, the ability to attach a weapon to their tail, as well as granting them %d class talent points to spend in a new category based off their chassis.
		...
		Tail weapons do not attack by default, and are instead used for special talents.]], [[You craft a new chassis for your mecharachnid, allowing you to tailor it to different situations. Each chassis grants the mecharachnid a new talent category, the ability to attach a weapon to their tail, as well as granting them %d class talent points to spend in a new category based off their chassis.
...
t("Mecharachnid Piloting", "Mecharachnid Piloting", "talent name")
...
t("Defensive Protocol", "Defensive Protocol", "talent name")
t("Enhancements to your mecharachnid combat skill increases your melee and ranged evasion by %d%%, and causes you to automatically strike adjacent enemies with your tailsaw for %d%% damage each turn.", "Enhancements to your mecharachnid combat skill increases your melee and ranged evasion by %d%%, and causes you to automatically strike adjacent enemies with your tailsaw for %d%% damage each turn.", "tformat")
t("Pincer Strike", "Pincer Strike", "talent name")
t("#Target# resists the pincer strike from #Source#!", "#Target# resists the pincer strike from #Source#!", "logCombat")
...
t("Automated Repair System", "Automated Repair System", "talent name")
t([[On falling below 0 life, you engage an automated repair mode. While in this mode you cannot act, but can survive below -%d life, heal for %0.1f life each turn and have all resistances increased by %d%%. This will last until you are destroyed or until you are fully healed.
		This effect has a cooldown.]], [[On falling below 0 life, you engage an automated repair mode. While in this mode you cannot act, but can survive below -%d life, heal for %0.1f life each turn and have all resistances increased by %d%%. This will last until you are destroyed or until you are fully healed.
		This effect has a cooldown.]], "tformat")
t("Gauss Cannon", "Gauss Cannon", "talent name")
t("You require a tail-mounted steamgun for this talent.", "You require a tail-mounted steamgun for this talent.", "logPlayer")
t([[Fire a charged shot at the farthest target with your tail-mounted steamgun that pierces through your enemies, ignoring armor and dealing %d%% weapon damage as lightning.
		This takes no time to use.]], [[Fire a charged shot at the farthest target with your tail-mounted steamgun that pierces through your enemies, ignoring armor and dealing %d%% weapon damage as lightning.
		This takes no time to use.]], "tformat")
t("Magnetic Accelerator", "Magnetic Accelerator", "talent name")
t("You must have an empty space to leap to.", "You must have an empty space to leap to.", "logPlayer")
t([[Improved power output increases the speed of your projectiles by %d%%, critical damage by %d%%, and allows you to automatically reload each turn.
		In addition, you can instantly activate this talent to gain a sudden burst of speed, moving to a tile in range %d.]], [[Improved power output increases the speed of your projectiles by %d%%, critical damage by %d%%, and allows you to automatically reload each turn.
		In addition, you can instantly activate this talent to gain a sudden burst of speed, moving to a tile in range %d.]], "tformat")
t("Haywire Missiles", "Haywire Missiles", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
t([[Fires a barrage of charged missiles from your tail-mounted steamgun at a radius %d area, dealing %d%% steamgun damage as lightning as well as dazing those within for 2 turns.
		The daze chance increases with your Accuracy.]], [[Fires a barrage of charged missiles from your tail-mounted steamgun at a radius %d area, dealing %d%% steamgun damage as lightning as well as dazing those within for 2 turns.
		The daze chance increases with your Accuracy.]], "tformat")
t("Advanced Targeting System", "Advanced Targeting System", "talent name")
t([[Enhancements to your targeting systems give all ranged attacks a %d%% chance to trigger an immediate shot from your tail-mounted steamgun for 100%% damage as lightning.
		In addition, your physical and lightning resistance penetration is increased by %d%%.]], [[Enhancements to your targeting systems give all ranged attacks a %d%% chance to trigger an immediate shot from your tail-mounted steamgun for 100%% damage as lightning.
		In addition, your physical and lightning resistance penetration is increased by %d%%.]], "tformat")
t("Tail Attachment", "Tail Attachment", "talent name")
t("%s mounts %s to its tail.", "%s mounts %s to its tail.", "logSeen")
t("Attach which item?", "Attach which item?", "_t")
t("Attach the chosen weapon to your tail.", "Attach the chosen weapon to your tail.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("Metalstar", "Metalstar", "talent name")
t([[Quickly aggregate particles of metal around your mindstar and focus psionic energies into it.
		The metal explodes like shrapnel, knocking back (%d away) and dazing (%d duration) all foes in radius %d.]], [[Quickly aggregate particles of metal around your mindstar and focus psionic energies into it.
		The metal explodes like shrapnel, knocking back (%d away) and dazing (%d duration) all foes in radius %d.]], "tformat")
t("Bloodstar", "Bloodstar", "talent name")
t([[When you fire your metalstar, your also establish a psionic bloodlink with the shrapnel still inside for %d turns.
		...
		This damage does not break daze and increases with your Steampower.]], [[When you fire your metalstar, your also establish a psionic bloodlink with the shrapnel still inside for %d turns.
		Each turn the victims are drained for %0.2f physical damage, half of which heals you (each additional victim healing is reduced by half).
		If the victim move more than twice away from the radius of Metalstar (currently %d) the effect stops.
		This damage does not break daze and increases with your Steampower.]], "tformat")
t("Steamstar", "Steamstar", "talent name")
t([[Your bloodstar effect also burns part of your victim's flesh, dealing %0.2f fire damage.
		...
		This damage does not break daze and increases with your Steampower.]], [[Your bloodstar effect also burns part of your victim's flesh, dealing %0.2f fire damage.
		The intensity of the fire generates steam which you psionically absorb through gestalt, providing %d steam each turn (each additional victim steam generation is reduced by 66%%).
		This damage does not break daze and increases with your Steampower.]], "tformat")
t("Deathstar", "Deathstar", "talent name")
t("When you use a shoot class talent to hit a creature affected by bloodstar an other shoot talent will have its current cooldown reduced by %d turns.", "When you use a shoot class talent to hit a creature affected by bloodstar an other shoot talent will have its current cooldown reduced by %d turns.", "tformat")
--]==]
...
t("Medical Urgency Vest", "Medical Urgency Vest", "talent name")
t("#LIGHT_BLUE#Medical Urgency Vest selected to be used first by salves.", "#LIGHT_BLUE#Medical Urgency Vest selected to be used first by salves.", "saySimple")
t("This medical injector will now be used first if available when using medical salves.", "This medical injector will now be used first if available when using medical salves.", "logPlayer")
t("The medical urgency vest allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "The medical urgency vest allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "tformat")
t("Life Support", "Life Support", "talent name")
t("#LIGHT_BLUE#Life Support Suit selected to be used first by salves.", "#LIGHT_BLUE#Life Support Suit selected to be used first by salves.", "saySimple")
t("The life support suit allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "The life support suit allows using therapeutics with %d%% efficiency and cooldown mod of %d%%.", "tformat")
t("Create Tinker", "Create Tinker", "talent name")
t("Allows you to create tinkers.", "Allows you to create tinkers.", "_t")
t("Weapon Automaton: One Handed", "Weapon Automaton: One Handed", "talent name")
t("You cannot use %s without a one handed melee weapon in your inventory!", "You cannot use %s without a one handed melee weapon in your inventory!", "logPlayer")
t("Select a weapon for your Automaton", "Select a weapon for your Automaton", "_t")
...
t("Hand Cannon", "Hand Cannon", "talent name")
t("You have no ammo!", "You have no ammo!", "logPlayer")
...
t([[Quickly create a psionic-enhanced metal contraption that lures all your foes to it and reflects %d%% of the damage it takes to its attackers.
		...
		Damage, life, resists, and armor scale with your Steampower.]], [[Quickly create a psionic-enhanced metal contraption that lures all your foes to it and reflects %d%% of the damage it takes to its attackers.
		The contraption will have %d life and last 5 turns.
		Damage, life, resists, and armor scale with your Steampower.]], "tformat")
t("Rocket Boots", "Rocket Boots", "talent name")
t([[Activate the rocket boots, firing huge flames from your boots increasing your movement speed by %d%%.
		...
		#{italic}#Burninate them all!#{normal}#]], [[Activate the rocket boots, firing huge flames from your boots increasing your movement speed by %d%%.
		Each movement will leave a trail of flames doing %0.2f fire damage for 4 turns.
		Doing any other actions will break the effect.
		#{italic}#Burninate them all!#{normal}#]], "tformat")
t("Iron Grip", "Iron Grip", "talent name")
t("%s resists the iron grip!", "%s resists the iron grip!", "logSeen")
t([[Activate the pistons to crush your target for %d turns and dealing %d%% unarmed melee damage.
		...
		#{italic}#Crush their bones!#{normal}#]], [[Activate the pistons to crush your target for %d turns and dealing %d%% unarmed melee damage.
		While the target is held it can not move and its armour and defense are reduced by %d.
...
t("A smelly cannister.", "A smelly cannister.", "_t")
t([[Launch a cannister filled with toxic gas at a location.
		...
		Damage and penetration are inherited from the creator.]], [[Launch a cannister filled with toxic gas at a location.
		Every 2 turns the cannister emits a poison cloud of radius 3 around it each turn.
		The poison does %0.2f nature damage over 5 turns.
		The cannister has %d life and lasts 8 turns. When it ends or is destroyed a last cloud is created.
		Damage, life, resists, and armor scale with your Steampower.
		Damage and penetration are inherited from the creator.]], "tformat")
t("Steam Powered Armour", "Steam Powered Armour", "talent name")
t([[Activate the armour's active defense system.
		...
		The effects increase with your Steampower.]], [[Activate the armour's active defense system.
		A flow of electricity covers your armour to attenuate the force of energy attacks while small steam engines move key pieces of the armour to attenuate physical attacks.
		All damage except mind damage is reduced by a flat %d.
		In addition the electric power of the armour sometimes leaks, each turn there is a 50%% chance to produce a electrical arc toward a foe, dealing %0.2f to %0.2f lightning damage to all foes in radius 1.
		The effects increase with your Steampower.]], "tformat")
t("Viral Needlegun", "Viral Needlegun", "talent name")
t([[You fire a cone of blighted needles, hitting everything in a frontal cone of radius %d for %0.2f physical damage.
		...
		The damage and disease effects increase with your Steampower.]], [[You fire a cone of blighted needles, hitting everything in a frontal cone of radius %d for %0.2f physical damage.
		Each creature hit has a %d%% chance of being infected by a random disease, doing %0.2f blight damage and reducing either Constitution, Strength or Dexterity by %d for 20 turns.
		The damage and disease effects increase with your Steampower.]], "tformat")
t("Sand Shredder", "Sand Shredder", "talent name")
t("%s shreds through sandwalls!", "%s shreds through sandwalls!", "logSeen")
t("You shred pieces of sandwalls. Brrrmmm!.", "You shred pieces of sandwalls. Brrrmmm!.", "_t")
t("Flamethrower", "Flamethrower", "talent name")
t([[Throw a cone of flame with radius %d
		The damage will increase with your Steampower.]], [[Throw a cone of flame with radius %d
		The damage will increase with your Steampower.]], "tformat")
t("Mass Repair", "Mass Repair", "talent name")
t([[Throw a cone of healing with radius %d, healing other mechanical creatures (steam spiders) for %d.
		The healing will increase with your Steampower.]], [[Throw a cone of healing with radius %d, healing other mechanical creatures (steam spiders) for %d.
		The healing will increase with your Steampower.]], "tformat")
t("Arcane Disruption Wave", "Arcane Disruption Wave", "talent name")
...
t([[Shatters the mind of your victim, giving you full control over its actions for 6 turns.
		...
		This effect does not work on rares, bosses, or undead.
		.]], "tformat")
t("Shocking Touch", "Shocking Touch", "talent name")
t([[Touch a creature to release a nasty electrical charge into them, doing %0.2f lightning damage.
		...
		The damage increases with your Steampower.]], [[Touch a creature to release a nasty electrical charge into them, doing %0.2f lightning damage.
		If this tinker is above tier 1, the electricity can arc to another target up to 2 tiles away.
		The number of enemies hit is at most the tinker tier.
...
t("Itching Powder", "Itching Powder", "talent name")
t("%s resists the itching powder!", "%s resists the itching powder!", "logSeen")
t([[Throw a handful of dust that is very itchy to touch.
		...
		The itchiness effect is applied with your Steampower.]], [[Throw a handful of dust that is very itchy to touch.
		Creatures in a cone of radius %d are itchy for %d turns, causing them to fail talents %d%% of the time.
		The itchiness effect is applied with your Steampower.]], "tformat")
t("Thunder Grenade", "Thunder Grenade", "talent name")
t("%s resists the explosion!", "%s resists the explosion!", "logSeen")
t([[Throw a grenade at your foes, dealing %0.2f physical damage in radius %d.
		Creatures hit will also be stunned for %d turns.
		The stun effect is applied with your Steampower.]], [[Throw a grenade at your foes, dealing %0.2f physical damage in radius %d.
		Creatures hit will also be stunned for %d turns.
		The stun effect is applied with your Steampower.]], "tformat")
t("Project Saw", "Project Saw", "talent name")
t([[You activate hidden springs to project a saw towards your foes.
		...
		The damage increases with your Steampower.]], [[You activate hidden springs to project a saw towards your foes.
		Any creature caught in the beam takes %0.2f physical damage and bleeds for half more in 5 turns.
		The damage increases with your Steampower.]], "tformat")
t("Voltaic Bolt", "Voltaic Bolt", "talent name")
t([[Fires a bolt of lightning, doing %0.2f lightning damage.
		The damage will increase with your Steampower.]], [[Fires a bolt of lightning, doing %0.2f lightning damage.
		The damage will increase with your Steampower.]], "tformat")
t("Voltaic Sentry", "Voltaic Sentry", "talent name")
t("volatic sentry", "volatic sentry", "_t")
t("A strange device. Your hair stands on end when you approach.", "A strange device. Your hair stands on end when you approach.", "_t")
t([[Place an electrically charged sentry device at a location.
		...
		Damage, life, resists, and armor scale with your Steampower.
		Damage and penetration are inherited from the creator.]], [[Place an electrically charged sentry device at a location.
		Every turn it will fire a bolt of electricity at a nearby enemy.
		The bolts do %0.2f lightning damage.
		The sentry has %d life and lasts 10 turns.
		Damage, life, resists, and armor scale with your Steampower.
		Damage and penetration are inherited from the creator.]], "tformat")
t("Explosive Shell", "Explosive Shell", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
...
t("Flare Shell", "Flare Shell", "talent name")
t([[You fire a special explosive shot with your steamgun(s) at a spot within range.
		...
		When each shot reaches its target, it does normal steamgun damage and explodes within radius %d, which lights up the area and blinds for %d turns.
		This talent does not use ammo as it is the ammo.]], "tformat")
t("Incendiary Shell", "Incendiary Shell", "talent name")
t("clusterbomb", "clusterbomb", "_t")
t([[You fire a special explosive shot with your steamgun(s) at a spot within range.
...
t([[You fire a special solid shot with your steamgun(s) at a target for %d%% physical weapon damage.
		...
		The weight of the shot will knock the target back %d tiles.
		This talent does not use ammo as it is the ammo.]], "tformat")
t("Impaler Shell", "Impaler Shell", "talent name")
t([[You fire a special stake shot with your steamgun(s) at a target for %d%% physical weapon damage.
		...
		The weight of the shot will knock the target back 2 tiles and they will be pinned for %d turns.
		This talent does not use ammo as it is the ammo.]], "tformat")
t("Saw Shell", "Saw Shell", "talent name")
t([[You fire a special steamsaw shot with your steamgun(s) at a target for %d%% physical weapon damage.
		...
		This talent does not use ammo as it is the ammo.]], [[You fire a special steamsaw shot with your steamgun(s) at a target for %d%% physical weapon damage.
		The steamsaw will cut into the target, doing %d%% physical weapon damage over 5 turns.
		This talent does not use ammo as it is the ammo.]], "tformat")
t("Hook Shell", "Hook Shell", "talent name")
t("%s resists the pull!", "%s resists the pull!", "logSeen")
t([[You fire a special hook shot with your steamgun(s) at a target creature or location.
		...
		This talent does not use ammo as it is the ammo.]], [[You fire a special hook shot with your steamgun(s) at a target creature or location.
		If you target a creature, they are pulled up to %d tiles towards you.
		If you target an empty tile, you are pulled up to %d tiles towards it.
		This talent does not use ammo as it is the ammo.]], "tformat")
t("Magnetic Shell", "Magnetic Shell", "talent name")
...
t("Voltaic Shell", "Voltaic Shell", "talent name")
t([[You fire a special voltaic shot with your steamgun(s) at a target for 100%% weapon damage as lightning.
		...
		This talent does not use ammo as it is the ammo.
		Bolt damage scales with Steampower.]], [[You fire a special voltaic shot with your steamgun(s) at a target for 100%% weapon damage as lightning.
		The shot will release powerful electrical currents at up to %d nearby enemies. 
		Each bolt does %0.2f lightning damage.
		This talent does not use ammo as it is the ammo.
		Bolt damage scales with Steampower.]], "tformat")
t("Antimagic Shell", "Antimagic Shell", "talent name")
t([[You fire a special antimagic shot with your steamgun(s) at a target for 100%% normal weapon damage.
		...
		This talent does not use ammo as it is the ammo.
		Sap damage scales with Steampower.]], [[You fire a special antimagic shot with your steamgun(s) at a target for 100%% normal weapon damage.
		The shot will release antimagic sap on the target, doing %0.2f arcane resource burn damage.
		This talent does not use ammo as it is the ammo.
		Sap damage scales with Steampower.]], "tformat")
t("Botanical Shell", "Botanical Shell", "talent name")
t([[You fire a special botanical shot with your steamgun(s) at a target for 100%% weapon damage as nature.
		...
		This talent does not use ammo as it is the ammo.
		Moss damage scales with Steampower.]], [[You fire a special botanical shot with your steamgun(s) at a target for 100%% weapon damage as nature.
		The shot will release spores which grow into Nourishing Moss in a radius of %d for %d turns.
		Each turn the moss deals %0.2f nature damage to each foe within its radius.
		This moss has vampiric properties and heals the user for %d%% of the damage done.
		This talent does not use ammo as it is the ammo.
		Moss damage scales with Steampower.]], "tformat")
t("Corrosive Shell", "Corrosive Shell", "talent name")
t([[You fire a special corrosive shot with your steamgun(s) at a target for %d%% weapon damage as acid.
		...
		This talent does not use ammo as it is the ammo.
		Corrosion strength scales with Steampower.]], [[You fire a special corrosive shot with your steamgun(s) at a target for %d%% weapon damage as acid.
		The acid released by the shot will also corrode the target, reducing its accuracy, defense and armour by %d.
		This talent does not use ammo as it is the ammo.
		Corrosion strength scales with Steampower.]], "tformat")
t("Toxic Shell", "Toxic Shell", "talent name")
...
t("Moss Tread", "Moss Tread", "talent name")
...
t("Arcane Dynamo", "Arcane Dynamo", "talent name")
t([[Allows the use of Technomancy spells.
		...
		#{italic}#Metal Arcane Power!#{normal}#]], [[Allows the use of Technomancy spells.
		Grants a magical steam reserve that regenerates %d steam per 10 mana spent.
		Grants Spellpower based on current steam level (currently %d; %d%% steam filled).
		Outside of combat, you relax and let your steam reserve slowly wither away.
...
-- texte non traduit
--[==[
t("Smith", "Smith", "talent name")
t([[Allows you to create smithed tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[Allows you to create smithed tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Mechanical", "Mechanical", "talent name")
t([[Allows you to create mechanical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[Allows you to create mechanical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Electricity", "Electricity", "talent name")
t([[Allows you to create electrical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], [[Allows you to create electrical tinkers of level %d.
		You will learn a new schematic at level 1.
		Each other talent level, you have a 20%% chance to learn one more random schematic, if you have not gained it by level 5 you are guaranteed it (unless all are known).
		%s]], "tformat")
t("Compact Steam Tank", "Compact Steam Tank", "talent name")
t("Increases the capacity of your steam tank by %d.", "Increases the capacity of your steam tank by %d.", "tformat")
--]==]
...
t([[Increases weapon damage by %d%% and Physical Power by 30 when using steamguns.
		...
		Also activable for a shot that deals %d%% weapon damage as mind damage.]], [[Increases weapon damage by %d%% and Physical Power by 30 when using steamguns.
		When your bullets hit a target you instinctively reach out to the impact and use the kinetic force to project a mindstar attack doing %d%% damage (guaranteed hit), if you wield one in the offhand.
		This projection requires a pure mindstar; it will not work if extended into a psiblade.

		Also activable for a shot that deals %d%% weapon damage as mind damage.]], "tformat")
t("Boiling Shot", "Boiling Shot", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
t([[Using psionic energies you overheat your shot, making it deal %d%% damage.
		If the shot hits a wet foe it will vaporize, removing the wet effect and dealing %0.2f fire damage in a radius 4.]], [[Using psionic energies you overheat your shot, making it deal %d%% damage.
		If the shot hits a wet foe it will vaporize, removing the wet effect and dealing %0.2f fire damage in a radius 4.]], "tformat")
t("Blunt Shot", "Blunt Shot", "talent name")
t("Fire a relatively low-powered shot at a foe doing %d%% weapon damage, if it hits a cone-shaped shockwave of radius 4 emanates from the impact, stunning it and all creatures caught inside for %d turns.", "Fire a relatively low-powered shot at a foe doing %d%% weapon damage, if it hits a cone-shaped shockwave of radius 4 emanates from the impact, stunning it and all creatures caught inside for %d turns.", "tformat")
t("Vacuum Shot", "Vacuum Shot", "talent name")
t([[Attach a psionic steam device to a shot doing %d%% weapon damage.
		When it hits a foe the device activates, violently sucking all the air nearby, pulling in all creatures in radius %d.]], [[Attach a psionic steam device to a shot doing %d%% weapon damage.
...
t([[Hits the target on the arms with one rotating saw doing %d%% damage and trying to maim it for %d turns.
		...
		#{italic}#Cutting your foes has never been so simple!#{normal}#]], [[Hits the target on the arms with one rotating saw doing %d%% damage and trying to maim it for %d turns.
		Maimed foes deal %d%% less damage.
		The chance improves with your Physical power.
		#{italic}#Cutting your foes has never been so simple!#{normal}#]], "tformat")
t("Bloodstream", "Bloodstream", "talent name")
t([[You "gently" slam your saws into the wounds of a creature, dealing %d%% weapon damage and deepening the wounds.
		...
		#{italic}#The marvels of technology, now at the service of true butchery!#{normal}#]], [[You "gently" slam your saws into the wounds of a creature, dealing %d%% weapon damage and deepening the wounds.
		All bleeding wounds durations are increased by %d turns and the damage by %d%% (this may be done only once per bleeding effect).
		When this happens a gush of blood is projected in a narrow cone of radius 4, dealing %0.2f physical damage to all creatures.
		The power and damage improves with your Steampower.
		#{italic}#The marvels of technology, now at the service of true butchery!#{normal}#]], "tformat")
t("Spinal Break", "Spinal Break", "talent name")
...
t("Goresplosion", "Goresplosion", "talent name")
...
t("This talent is required for the following tinkers (you still need to learn/find the schematics):", "This talent is required for the following tinkers (you still need to learn/find the schematics):", "_t")
t(" #LIGHT_BLUE#(known)#LAST#", " #LIGHT_BLUE#(known)#LAST#", "_t")
...
-- texte non traduit
--[==[
t("Molten Iron Blood", "Molten Iron Blood", "talent name")
t([[Using psionic energies you temporarily alter your blood, turning it into molten iron.
		...
		]], [[Using psionic energies you temporarily alter your blood, turning it into molten iron.
		When affected by molten blood all creatures that hit you in melee take %0.2f fire damage, all your resistances are increased by %d%% and all new detrimental effects on you have their duration reduced by %d%%.
		Damage increases with your Steampower.
		]], "tformat")
t("Mind Drones", "Mind Drones", "talent name")
...
t("Psionic Mirror", "Psionic Mirror", "talent name")
t([[You cleanse your mind of %d mental debuffs.
		Cleansed effects will be randomly sent to closeby foes (range 5, subject to a mental save).]], [[You cleanse your mind of %d mental debuffs.
...
The stat bonus as well as the damage and healing dealt by Flame and Medic Turrets will increase with your Steampower.]], [[You are able to deploy turrets, stationary constructs that defend you in combat. Turrets last 10 turns, have a 20 turn cooldown, and deploying a turret places the others on a 5 turn cooldown.
You learn new turrets as you invest in this talent.
...
t("Turret", "Turret", "_t")
t("Deploy a turret mounted with a steamgun that fires at foes within range for %d%% steamgun damage. The turret gains +%d Dexterity, Constitution and Cunning and %0.2f Steamgun Mastery.", "Deploy a turret mounted with a steamgun that fires at foes within range for %d%% steamgun damage. The turret gains +%d Dexterity, Constitution and Cunning and %0.2f Steamgun Mastery.", "tformat")
t("Rocket Launcher", "Rocket Launcher", "talent name")
t("You require a steamgun for this talent.", "You require a steamgun for this talent.", "logPlayer")
t("Fire a missile dealing steamgun damage as fire in radius 2.", "Fire a missile dealing steamgun damage as fire in radius 2.", "tformat")
t("Dual Steamgun", "Dual Steamgun", "talent name")
t("Gain a second steamgun that deals %d%% damage.", "Gain a second steamgun that deals %d%% damage.", "tformat")
t("Flame Turret", "Flame Turret", "talent name")
t("flame turret", "flame turret", "_t")
t("An automated turret equiped with a flamethrower.", "An automated turret equiped with a flamethrower.", "_t")
t("Deploy a turret mounted with a flamethrower, scorching nearby targets. The turret gains +%d Dexterity, Constitution and Cunning.", "Deploy a turret mounted with a flamethrower, scorching nearby targets. The turret gains +%d Dexterity, Constitution and Cunning.", "tformat")
t("Flamethrower", "Flamethrower", "talent name")
t([[Throw a cone of flame with radius %d, dealing %0.2f fire damage.
		The damage will increase with your Steampower.]], [[Throw a cone of flame with radius %d, dealing %0.2f fire damage.
		The damage will increase with your Steampower.]], "tformat")
t("Flame Vortex", "Flame Vortex", "talent name")
t([[Project a radius %d vortex of superheated air, dealing %0.2f fire damage and pulling targets towards you.
		The damage will increase with your Steampower.]], [[Project a radius %d vortex of superheated air, dealing %0.2f fire damage and pulling targets towards you.
		The damage will increase with your Steampower.]], "tformat")
t("Medic Turret", "Medic Turret", "talent name")
t("medic turret", "medic turret", "_t")
t("An automated turret emitting a healing mist.", "An automated turret emitting a healing mist.", "_t")
t("Deploy a turret that emits a healing mist in radius 3. The turret gains +%d Dexterity, Constitution and Cunning.", "Deploy a turret that emits a healing mist in radius 3. The turret gains +%d Dexterity, Constitution and Cunning.", "tformat")
t("Overclock", "Overclock", "talent name")
t([[Send a surge of power into all turrets in sight, extending their duration by %d turns and granting them a charged shield absorbing %d damage for 10 turns. While the shield holds, each turn the turret will project a bolt of lightning dealing %0.2f lightning damage to a random enemy in radius 6, with a 25%% chance to daze.
		The effects will increase with your Steampower.]], [[Send a surge of power into all turrets in sight, extending their duration by %d turns and granting them a charged shield absorbing %d damage for 10 turns. While the shield holds, each turn the turret will project a bolt of lightning dealing %0.2f lightning damage to a random enemy in radius 6, with a 25%% chance to daze.
		The effects will increase with your Steampower.]], "tformat")
t("Upgrade", "Upgrade", "talent name")
t([[Upgrade the target turret, granting it %d%% increased maximum life and enhanced abilities based on type:
		...
		Medic: Increases healing on affected targets by %d%%, and has a %d%% chance to cleanse a negative effect each turn.]], [[Upgrade the target turret, granting it %d%% increased maximum life and enhanced abilities based on type:
		Steamgun: Gains a second steamgun dealing %d%% damage, and every 3 turns will fire a rocket dealing %d%% steamgun damage as fire in radius 2.
		Flame: Increases damage by %d%%, range by %d, and every 3 turns will project a vortex of superheated air that drags targets within range %d towards the turret as well as dealing normal flamethrower damage.
		Medic: Increases healing on affected targets by %d%%, and has a %d%% chance to cleanse a negative effect each turn.]], "tformat")
t("Hunker Down", "Hunker Down", "talent name")
t("guardian turret", "guardian turret", "_t")
t("An advanced turret equipped with dual steamguns.", "An advanced turret equipped with dual steamguns.", "_t")
...
-- texte non traduit
--[==[
t("Subcutaneous Metallisation", "Subcutaneous Metallisation", "talent name")
t([[When your life dips below 50%% of your total life an automated process turns some of your lower skin layers (or other internal organs) into a thick metallic layer for 6 turns.
		...
		This effect can only trigger once every %d turns.]], [[When your life dips below 50%% of your total life an automated process turns some of your lower skin layers (or other internal organs) into a thick metallic layer for 6 turns.
		While the effect lasts all damage done to you is reduced by a flat amount equal to 100%% of your Constitution.
...
t("Rak'Shor's Cunning", "Rak'Shor's Cunning", "talent name")
...
t("Rak'Shor's Cunning", "Rak'Shor's Cunning", "_t")
...
t("All steamtech criticals reduce the remaining cooldown of a random steamtech talent by 1.", "All steamtech criticals reduce the remaining cooldown of a random steamtech talent by 1.", "_t")
--]==]
...
-- texte non traduit
--[==[
t("Automated Reflex System", "Automated Reflex System", "talent name")
t("Have gained the #{italic}#Matrix Style#{normal}# achievement with this or any previous character for the current difficulty & permadeath settings.", "Have gained the #{italic}#Matrix Style#{normal}# achievement with this or any previous character for the current difficulty & permadeath settings.", "_t")
t([[A small automatic detection system is always looking for incoming projectiles, when one is about to hit you it injects drugs into your system to boost your reactivity, granting you a free turn.
		This effect can not happen more than once every 5 turns.]], [[A small automatic detection system is always looking for incoming projectiles, when one is about to hit you it injects drugs into your system to boost your reactivity, granting you a free turn.
...
t("Technomancer", "Technomancer", "talent name")
t("Unlocked the Technomancer evolution", "Unlocked the Technomancer evolution", "_t")
t("Technomancer", "Technomancer", "_t")
t("Occult Technomancy", "Occult Technomancy", "_t")
t("These talents focus on arcane and temporal damage, using a super-spinned steamsaw to rip holes in reality.", "These talents focus on arcane and temporal damage, using a super-spinned steamsaw to rip holes in reality.", "_t")
t("Galvanic Technomancy", "Galvanic Technomancy", "_t")
t("These talents focus on fire and lightning damage, strategically placing galvanic rods to create fields of death and stuns.", "These talents focus on fire and lightning damage, strategically placing galvanic rods to create fields of death and stuns.", "_t")
t("Terrene Technomancy", "Terrene Technomancy", "_t")
t("These talents focus on cold and physical damage, summoning micro spiderbots to harass and pin their foes or protect themselves.", "These talents focus on cold and physical damage, summoning micro spiderbots to harass and pin their foes or protect themselves.", "_t")
t("Choose your free Technomancy unlock?", "Choose your free Technomancy unlock?", "_t")
t([[Available talents:
]], [[Available talents:
]], "_t")
t([[Technomancers are Archmages that dabble in steam technology to enhance their already formidable arsenal of spells.
		...
		#{bold}#As soon as this evolution is used you will need to craft the Arcane Dynamo to place in a robe to benefit from all the powers of the Technomancer.#{normal}#]], [[Technomancers are Archmages that dabble in steam technology to enhance their already formidable arsenal of spells.
		Once this class evolution is taken, you gain the following:
		- Arcane Dynamo tinker schematic
		- Steamtech/Physics category (unlocked)
		- Steamtech/Chemistry category (locked)
...
-- texte non traduit
--[==[
t("Pain Enhancement System", "Pain Enhancement System", "talent name")
t("Earned the achievement 'Size Matters' on this character.", "Earned the achievement 'Size Matters' on this character.", "_t")
t("When you deal a critical hit your embedded system activates, increasing all your primary stats except Strength by 50%% of your Strength for 6 turns.", "When you deal a critical hit your embedded system activates, increasing all your primary stats except Strength by 50%% of your Strength for 6 turns.", "tformat")
--]==]
...
-- texte non traduit
--[==[
t("Range Amplification Device", "Range Amplification Device", "talent name")
t("Have a light radius of 10 or more", "Have a light radius of 10 or more", "_t")
t([[Activate a special focusing device that extends all your ranged spells and psionic powers range by 3 (only works on those with range 2 or more and up to 10 max).
		The use of this device is very strenuous, increasing fatigue by 20%% while active.]], [[Activate a special focusing device that extends all your ranged spells and psionic powers range by 3 (only works on those with range 2 or more and up to 10 max).
...
-- texte non traduit
--[==[
t("a steamtech power", "a steamtech power", "_t")
t("a technomancy spell", "a technomancy spell", "_t")
--]==]
...
--[==[
t("Warm", "Warm", "_t")
t("The target is warm from the campfire. Increasing steam regeneration by 6/turn, stun immunity by 30% and stamina regeneration by 4/turn.", "The target is warm from the campfire. Increasing steam regeneration by 6/turn, stun immunity by 30% and stamina regeneration by 4/turn.", "_t")
t("Sun Radiance", "Sun Radiance", "_t")
t("The target is under the effect of the sun. Increasing lite and sight radius by 2, blindness immunity by 30%, stealth seeing by 20 and light resistance by 30%.", "The target is under the effect of the sun. Increasing lite and sight radius by 2, blindness immunity by 30%, stealth seeing by 20 and light resistance by 30%.", "_t")
t("Moon Radiance", "Moon Radiance", "_t")
t("The target is under the effect of the moons. Decreasing lite and sight radius by 1, increasing stun immunity by 30%, granting 10 stealth and darkness resistance by 30%.", "The target is under the effect of the moons. Decreasing lite and sight radius by 1, increasing stun immunity by 30%, granting 10 stealth and darkness resistance by 30%.", "_t")
--]==]
...
t("#Target# is no longer fluctuating.", "#Target# is no longer fluctuating.", "_t")
t("Death Momentum", "Death Momentum", "_t")
t("steam", "steam", "effect subtype")
t("technomancy", "technomancy", "effect subtype")
t("Ethereal Steam", "Ethereal Steam", "_t")
t("Deals %0.2f occult damage per turn and each time a talent is used, the caster regens one turn of a random cooldown.", "Deals %0.2f occult damage per turn and each time a talent is used, the caster regens one turn of a random cooldown.", "tformat")
t("#Target# covered in arcane-infused steam!", "#Target# covered in arcane-infused steam!", "_t")
t("#Target# is free from the steam.", "#Target# is free from the steam.", "_t")
t("Ethereal Link", "Ethereal Link", "_t")
t("While Ethereal Steam exists the cooldown of Metaphasic Spin is reduced to 6.", "While Ethereal Steam exists the cooldown of Metaphasic Spin is reduced to 6.", "tformat")
t("Metaphasic Echoes", "Metaphasic Echoes", "_t")
t("Project your saw along the leftover breaches.", "Project your saw along the leftover breaches.", "tformat")
t("Spiderbots Shield", "Spiderbots Shield", "_t")
t("%d spiderbots are protecting you, each with %d life. Current top spiderbot has %d life remaining.", "%d spiderbots are protecting you, each with %d life. Current top spiderbot has %d life remaining.", "tformat")
t("#Target# covered with micro spiderbots!", "#Target# covered with micro spiderbots!", "_t")
t("#Target# is no longer protected by spiderbots.", "#Target# is no longer protected by spiderbots.", "_t")
t("#SLATE#(%d to spiderbot - destructed)#LAST#", "#SLATE#(%d to spiderbot - destructed)#LAST#", "tformat")
t("#SLATE#(%d to spiderbot)#LAST#", "#SLATE#(%d to spiderbot)#LAST#", "tformat")
t("Electron Incantation", "Electron Incantation", "_t")
t("Arcane Dynamo returns %d more steam per 10 mana spent.", "Arcane Dynamo returns %d more steam per 10 mana spent.", "tformat")
t("Defensive Circuit: Dynamo Boost", "Defensive Circuit: Dynamo Boost", "_t")
t("Defensive Circuit: Resistances Boost", "Defensive Circuit: Resistances Boost", "_t")
...
t("Forced Gestalt", "Forced Gestalt", "_t")
t("All powers increased by %d.", "All powers increased by %d.", "tformat")
t("#Target# is drains all powers around #himher#.", "#Target# is drains all powers around #himher#.", "_t")
t("#Target# is less powerful.", "#Target# is less powerful.", "_t")
t("All powers reduced by %d.", "All powers reduced by %d.", "tformat")
t("#Target# is drained of all powers.", "#Target# is drained of all powers.", "_t")
t("#Target# is more powerful.", "#Target# is more powerful.", "_t")
t("steam", "steam", "effect subtype")
t("disrupt", "disrupt", "effect subtype")
t("Mind Drone", "Mind Drone", "_t")
t("Talents fail chance %d%%, fear and sleep immunity reduced by %d%%.", "Talents fail chance %d%%, fear and sleep immunity reduced by %d%%.", "tformat")
t("A mind drone bores into #Target#!", "A mind drone bores into #Target#!", "_t")
t("#Target# is free from the mind drone.", "#Target# is free from the mind drone.", "_t")
t("biologic", "biologic", "effect subtype")
...
t("#Target# is once more confident.", "#Target# is once more confident.", "_t")
t("All Seeing", "All Seeing", "_t")
...
t("A Light in the Darkness", "A Light in the Darkness", "_t")
t("The power of the Sun imbues the target.", "The power of the Sun imbues the target.", "_t")
t("X-Ray Vision", "X-Ray Vision", "_t")
t("Can see EVERYTHING.", "Can see EVERYTHING.", "_t")
t("Aiming!", "Aiming!", "_t")
...
t("Automatically firing a missile barrage against a target for %d%% increased damage.", "Automatically firing a missile barrage against a target for %d%% increased damage.", "tformat")
t("The target has been marked by a rocket pod, reducing defence by %d and negating all evasion effects.", "The target has been marked by a rocket pod, reducing defence by %d and negating all evasion effects.", "tformat")
t("#Target# has been marked by a rocket pod!", "#Target# has been marked by a rocket pod!", "_t")
t("+Locked On", "+Locked On", "_t")
...
t("Currently piloted.", "Currently piloted.", "tformat")
t("#GREEN#%s takes direct control of their mecharachnid!", "#GREEN#%s takes direct control of their mecharachnid!", "logSeen")
t("Direct Control", "Direct Control", "_t")
t("Direct control by the pilot increases damage by %d%% and resistances by %d%%.", "Direct control by the pilot increases damage by %d%% and resistances by %d%%.", "tformat")
t("Heavy Ammunition", "Heavy Ammunition", "_t")
t("%d Ammo", "%d Ammo", "tformat")
...
t("+Automated Repair System", "+Automated Repair System", "_t")
t("#Target#'s repairs are complete.", "#Target#'s repairs are complete.", "_t")
t("-Automated Repair System", "-Automated Repair System", "_t")
t("Demagnetized", "Demagnetized", "_t")
t("Beneficial effects of Magnetic Field lost.", "Beneficial effects of Magnetic Field lost.", "tformat")
t("technomancy", "technomancy", "effect subtype")
t("Galvanic Rods", "Galvanic Rods", "_t")
t([[Rods available:
]], [[Rods available:
]], "_t")
t([[#LIGHT_GREEN#- Rod (%d): available
]], [[#LIGHT_GREEN#- Rod (%d): available
]], "tformat")
...
t("Startled", "Startled", "_t")
t("The target is startled after being strangely missed by a shot. The next shot it takes will deal %d%% more damage.", "The target is startled after being strangely missed by a shot. The next shot it takes will deal %d%% more damage.", "tformat")
t("steamtech", "steamtech", "effect subtype")
t("Iron Grip", "Iron Grip", "_t")
t("The target has been crushed, pinning it and reducing defense and armour by %d.", "The target has been crushed, pinning it and reducing defense and armour by %d.", "tformat")
t("#Target# is crushed by the iron grip.", "#Target# is crushed by the iron grip.", "_t")
t("+Iron Grip", "+Iron Grip", "_t")
t("#Target# is free from the iron grip.", "#Target# is free from the iron grip.", "_t")
t("-Iron Grip", "-Iron Grip", "_t")
t("Bullet Mastery: Overheated", "Bullet Mastery: Overheated", "_t")
t("Bullets shot are overheated:  When striking their target, they set it on fire for %d fire damage over 5 turns", "Bullets shot are overheated:  When striking their target, they set it on fire for %d fire damage over 5 turns", "tformat")
t("#Target# tweaks some of %s bullets.", "#Target# tweaks some of %s bullets.", "tformat")
t("+Bullet Mastery", "+Bullet Mastery", "_t")
t("Bullet Mastery: Supercharged", "Bullet Mastery: Supercharged", "_t")
t("Bullets shot are supercharged:  They can pass through multiple targets and have %d additional armour penetration.", "Bullets shot are supercharged:  They can pass through multiple targets and have %d additional armour penetration.", "tformat")
t("Bullet Mastery: Percussive", "Bullet Mastery: Percussive", "_t")
t("Bullets shot are percussive:  When striking, they have a %d%% chance to knock back and a %d%% chance to stun.", "Bullets shot are percussive:  When striking, they have a %d%% chance to knock back and a %d%% chance to stun.", "tformat")
t("Bullet Mastery: Combustive", "Bullet Mastery: Combustive", "_t")
t("Bullets shot are combustive:  When striking their target, they explode (radius 2) for %d fire damage.", "Bullets shot are combustive:  When striking their target, they explode (radius 2) for %d fire damage.", "tformat")
...
t("Provides a frost aura, giving you +%d%% blight, mind and acid affinity.", "Provides a frost aura, giving you +%d%% blight, mind and acid affinity.", "tformat")
t("#Target# uses a water salve.", "#Target# uses a water salve.", "_t")
t("+Water Salve", "+Water Salve", "_t")
t("-Water Salve", "-Water Salve", "_t")
t("tech", "tech", "effect subtype")
t("Unstoppable Force Salve", "Unstoppable Force Salve", "_t")
t("Increases all saves by %d and healing factor by %d%%.", "Increases all saves by %d and healing factor by %d%%.", "tformat")
...
t("Increases steampower by %d and steam crit by %d%%.", "Increases steampower by %d and steam crit by %d%%.", "tformat")
t("#Target# supercharges all tinkers.", "#Target# supercharges all tinkers.", "_t")
t("+Supercharge Tinkers", "+Supercharge Tinkers", "_t")
t("#Target#'s supercharge is fading.", "#Target#'s supercharge is fading.", "_t")
t("-Supercharge Tinkers", "-Supercharge Tinkers", "_t")
t("Overcharge Saws", "Overcharge Saws", "_t")
t("Increases all saws talent levels by %d%%.", "Increases all saws talent levels by %d%%.", "tformat")
t("#Target# overcharges saw motors.", "#Target# overcharges saw motors.", "_t")
t("+Overcharge Saws", "+Overcharge Saws", "_t")
...
t("#Target# is #ORANGE#INFESTED#LAST# with ritch larvae!", "#Target# is #ORANGE#INFESTED#LAST# with ritch larvae!", "_t")
t("+Larvae Infestation", "+Larvae Infestation", "_t")
t("developing ", "developing ", "_t")
t("A %s #ORANGE#BURSTS OUT#LAST# of %s%s!", "A %s #ORANGE#BURSTS OUT#LAST# of %s%s!", "logSeen")
t(" but is crushed", " but is crushed", "_t")
t("Tech Overload", "Tech Overload", "_t")
...
t("sil", "sil", "_t")
t("#Target# is assailed by an automated saw blade.", "#Target# is assailed by an automated saw blade.", "_t")
...
t("+Net Projector", "+Net Projector", "_t")
t("#Target# is free from the net.", "#Target# is free from the net.", "_t")
t("-Net Projector", "-Net Projector", "_t")
t("Molten Point", "Molten Point", "_t")
t("steam", "steam", "effect subtype")
...
t("#Target# no longer has molten iron blood.", "#Target# no longer has molten iron blood.", "_t")
t("Seared", "Seared", "_t")
t("Fire resistance decreased by %d%% and mind save by %d.", "Fire resistance decreased by %d%% and mind save by %d.", "tformat")
t("#Target# is seared.", "#Target# is seared.", "_t")
t("#Target# is no longer seared.", "#Target# is no longer seared.", "_t")
t("awesome", "awesome", "effect subtype")
t("Awesome Toss", "Awesome Toss", "_t")
...
t("powder", "powder", "effect subtype")
...
t("#Target# is hiding in smoke.", "#Target# is hiding in smoke.", "_t")
t("+Smoke Cover", "+Smoke Cover", "_t")
t("#Target# is no longer hiding in smoke.", "#Target# is no longer hiding in smoke.", "_t")
t("-Smoke Cover", "-Smoke Cover", "_t")
t("Magnetised", "Magnetised", "_t")
t("The target has been magnetised, reducing defense by %d and increasing fatigue by %d.", "The target has been magnetised, reducing defense by %d and increasing fatigue by %d.", "tformat")
t("#Target# is magnetised.", "#Target# is magnetised.", "_t")
t("+Magnetised", "+Magnetised", "_t")
...
t("+Static Shield", "+Static Shield", "_t")
t("The static shield around #target# crumbles.", "The static shield around #target# crumbles.", "_t")
t("-Static Shield", "-Static Shield", "_t")
t("Lightning Web", "Lightning Web", "_t")
t("The target is surrounded by a crackling web of lightning, reducing all damage taken by %d.", "The target is surrounded by a crackling web of lightning, reducing all damage taken by %d.", "tformat")
t("#LIGHT_BLUE#(%d lightning web)#LAST#", "#LIGHT_BLUE#(%d lightning web)#LAST#", "tformat")
t("Incendiary Grenade", "Incendiary Grenade", "_t")
...
t("AED", "AED", "_t")
t("If life is brought below 0, cancels the attack, heals for %d and deals %0.2f lightning damage in radius %d as well as dazing for 2 turns.", "If life is brought below 0, cancels the attack, heals for %d and deals %0.2f lightning damage in radius %d as well as dazing for 2 turns.", "tformat")
t("#Target# prepares their AED!", "#Target# prepares their AED!", "_t")
t("+AED", "+AED", "_t")
t("#Target#'s AED deactivates.", "#Target#'s AED deactivates.", "_t")
t("-AED", "-AED", "_t")
t("%s's AED triggers!", "%s's AED triggers!", "logSeen")
t("Burning Phosphorous", "Burning Phosphorous", "_t")
t("The target is covered in burning chemicals, taking %0.2f fire damage each turn. Subsequent shots deal %0.2f fire damage, and if they fall below 25%% life they have a %d%% chance to panic.", "The target is covered in burning chemicals, taking %0.2f fire damage each turn. Subsequent shots deal %0.2f fire damage, and if they fall below 25%% life they have a %d%% chance to panic.", "tformat")
t("#F53CBE#%s resists the fear.", "#F53CBE#%s resists the fear.", "logSeen")
t("#F53CBE#%s panics and flees from %s!", "#F53CBE#%s panics and flees from %s!", "logSeen")
t("#F53CBE#%s panics but fails to flee from %s!", "#F53CBE#%s panics but fails to flee from %s!", "logSeen")
...
t("+Pincer Strike", "+Pincer Strike", "_t")
t("#Target# is free from %s's pincers.", "#Target# is free from %s's pincers.", "tformat")
t("-Pincer Strike", "-Pincer Strike", "_t")
t("#Source# #LIGHT_RED#strikes down at#LAST# #Target#!", "#Source# #LIGHT_RED#strikes down at#LAST# #Target#!", "logCombat")
t("Reactive Armor", "Reactive Armor", "_t")
t("Next melee or ranged attack that deals more than 8%% of maximum life is reduced by %d%% and triggers a radius %d conal explosion dealing %d%% steamgun damage. %d stacks remaining.", "Next melee or ranged attack that deals more than 8%% of maximum life is reduced by %d%% and triggers a radius %d conal explosion dealing %d%% steamgun damage. %d stacks remaining.", "tformat")
t("#LIGHT_BLUE#(%d reactive armor)#LAST#", "#LIGHT_BLUE#(%d reactive armor)#LAST#", "tformat")
t("Grenade Barrage", "Grenade Barrage", "_t")
t("Attack speed increased by %d%%. Next %d shot(s) trigger a grenade.", "Attack speed increased by %d%%. Next %d shot(s) trigger a grenade.", "tformat")
t("#Target# loads a magazine of grenades.", "#Target# loads a magazine of grenades.", "_t")
t("+Grenade Barrage", "+Grenade Barrage", "_t")
t("Miasma Adaptation", "Miasma Adaptation", "_t")
t("Immune to miasma engine effects.", "Immune to miasma engine effects.", "_t")
...
t("#Target# takes flight!", "#Target# takes flight!", "_t")
t("+Death From Above", "+Death From Above", "_t")
t("#Target# lands.", "#Target# lands.", "_t")
t("-Death From Above", "-Death From Above", "_t")
t("Corrosive Flechette", "Corrosive Flechette", "_t")
t("%d corrosive flechettes are embedded in the target. Each melee and ranged attack against them will cause a flechette to burst for %0.2f acid damage", "%d corrosive flechettes are embedded in the target. Each melee and ranged attack against them will cause a flechette to burst for %0.2f acid damage", "tformat")
--]==]
...
t("Thunder Grenade", "Thunder Grenade", "_t")
...
t("Spring Grapple", "Spring Grapple", "_t")
...
t("Helps keep your airway open and lets you hold your breath longer.", "Helps keep your airway open and lets you hold your breath longer.", "_t")
t("Moss Tread", "Moss Tread", "_t")
...
--[==[
t("smith", "smith", "_t")
t("mechanical", "mechanical", "_t")
t("electricity", "electricity", "_t")
t("therapeutics", "therapeutics", "_t")
t("chemistry", "chemistry", "_t")
t("explosives", "explosives", "_t")
--]==]
...
-- texte non traduit
--[==[
t("Pressure-enhanced Slashproof Combat Suit", "Pressure-enhanced Slashproof Combat Suit", "entity name")
...
-- texte non traduit
--[==[
t("Nektosh the One-Horned", "Nektosh the One-Horned", "entity name")
...
t("#PURPLE#%s shouts: 'YOU DO NOT GET AWAY!'", "#PURPLE#%s shouts: 'YOU DO NOT GET AWAY!'", "saySimple")
...
t("#GOLD#The light of the Amulet envelops you, then subsides. You feel stronger. (+1 Prodigy Points)", "#GOLD#The light of the Amulet envelops you, then subsides. You feel stronger. (+1 Prodigy Points)", "logPlayer")
...
t("#CRIMSON#Impossible to to control.", "#CRIMSON#Impossible to to control.", "logPlayer")
t("#CRIMSON#Impossible to to control.", "#CRIMSON#Impossible to to control.", "saySimple")
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#The yeti is not hurt enough to control.", "logPlayer")
t("#CRIMSON#The yeti is not hurt enough to control.", "#CRIMSON#The yeti is not hurt enough to control.", "saySimple")
t("#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "#AQUAMARINE#You overtake the yeti's mind and order it to report to Kruk Pride.", "logPlayer")
...
-- texte non traduit
--[==[
t("New Cosmetic Race Option: #LIGHT_GREEN#Orc Headgear", "New Cosmetic Race Option: #LIGHT_GREEN#Orc Headgear", "_t")
...
-- texte non traduit
--[==[
t("New Class Evolution: #LIGHT_GREEN#Technomancer (Archmage)", "New Class Evolution: #LIGHT_GREEN#Technomancer (Archmage)", "_t")
...
-- texte non traduit
--[==[
t("New birth option: #LIGHT_GREEN#All classes", "New birth option: #LIGHT_GREEN#All classes", "_t")
...
-- texte non traduit
--[==[
t("New birth option: #LIGHT_GREEN#Mages", "New birth option: #LIGHT_GREEN#Mages", "_t")
...
-- texte non traduit
--[==[
t("New birth option: #LIGHT_GREEN#Rogues", "New birth option: #LIGHT_GREEN#Rogues", "_t")
t([[You have freed the Prides from the Internment Camp.
...
-- texte non traduit
--[==[
t("New Age of Ascendancy birth option: #LIGHT_GREEN#Tinkers", "New Age of Ascendancy birth option: #LIGHT_GREEN#Tinkers", "_t")
...
Playing characters this way is not lore-canon, but fun!]], [[You have defeated Outpost Leader John with two different tinker classes.
You can now create new characters with any tinker classes you have unlocked #LIGHT_GREEN#in the classical Age of Ascendancy, Infinite Dungeon and Arena campaigns#WHITE#.
Also tinker escorts may start to appear in Maj'Eyal now.
...
-- texte non traduit
--[==[
t("New Race: #LIGHT_GREEN#Whitehoof", "New Race: #LIGHT_GREEN#Whitehoof", "_t")
...
]], [[A clan of minotaurs turned to necromancy when faced with imminent destruction. Ever since they have kept to themselves.
But the discovery of a strange artifact in a crashed airship changed their fate. One of them tried to assert control over the clan, a few resist and hope to free their comrades.
...
-- texte non traduit
--[==[
t("New Race: #LIGHT_GREEN#Yeti", "New Race: #LIGHT_GREEN#Yeti", "_t")
...
-- texte non traduit
--[==[
t("New Class: #LIGHT_GREEN#Annihilator (Tinker)", "New Class: #LIGHT_GREEN#Annihilator (Tinker)", "_t")
...
]], [[After researching the remains of many foes you found new ways to bring the literal heat of battle to your foes!
You can now create new characters with the #LIGHT_GREEN#Annihilator class#WHITE#.
...
-- texte non traduit
--[==[
t("New Class: #LIGHT_GREEN#Psyshot (Tinker)", "New Class: #LIGHT_GREEN#Psyshot (Tinker)", "_t")
...
-- texte non traduit
--[==[
t("New Talent Category: #LIGHT_GREEN#Undead Drake", "New Talent Category: #LIGHT_GREEN#Undead Drake", "_t")
...
t("Created tinker: %s", "Created tinker: %s", "log")
t("Created tinker: %s", "Created tinker: %s", "saySimple")
t("Learnt new tinker schematic: #LIGHT_GREEN#%s", "Learnt new tinker schematic: #LIGHT_GREEN#%s", "log")
...
-- texte non traduit
--[==[
t("#PURPLE#Automated Reflex System activated!", "#PURPLE#Automated Reflex System activated!", "saySimple")
