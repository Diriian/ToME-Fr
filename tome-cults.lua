...
t("Escapades of Fay Willows [Book 1, Chapter 3] - Shaloren Suffering", "Les Escapades de Fay Willows [Livre 1, Chapitre 3] - La Souffrance des shalorenss", "_t")
...
Nous traversâmes bientôt un champ boueux, évitant les tentes des réfugiés dressées un peu partout. Nous finîmes par arriver à un grand bâtiment, à l'intérieur duquel de nombreux shaloren gisaient blessés sur des lits, et certains même à même le sol. Nous dirigeant vers l'arrière du bâtiment, nous entrâmes dans ce que je supposai être le bureau du guérisseur. "Vous ne connaîtriez pas, par hasard, les bases du mélange des essences ?" me demanda-t-on bientôt. "Je sais mélanger des essences basiques d'engourdissement et de régénération", répondis-je. Hochant la tête à cela, le guérisseur sortit un papier et commença à y écrire.
...
The soldier led me to the center of the city where a grand building lay. After meeting with a couple of the guards clad head to toe in shiny plate armor, we were let in. It took several minutes walking through the building’s halls, seemingly walking the building’s entire length to the end of it. Eventually I came to a luxurious looking room, decorations made of stralite and gold lining the walls and displayed pictures of what I assumed to be important figures in Shaloren history. Here I was told to wait, and left by the lieutenant as he entered a nearby room.]], [[[i]Il me frappe encore aujourd'hui à quel point les shalorens sont hostiles aux infusions. Il semblerait qu'ils préfèrent tenter le sort plutôt que d'y recourir. L'un des buts des infusions est de rétablir la bonne santé après une blessure, mais pour un shalore, c'était davantage un dernier recours pour éviter la mort. Qui plus est, ils semblent incapables de comprendre que retarder l'usage des infusions ne fait que les obliger à en utiliser davantage à long terme, puisqu'au-delà de simplement guérir leur chair, ils devront aussi combattre l'infection de leurs plaies ouvertes.[/i]

Pendant les jours suivants, je mélangeai et créai plusieurs infusions destinées à l'usage des shalorens. L'atelier disposait de toutes les commodités pour dormir, et le guérisseur m'apportait souvent des denrées alimentaires de base ainsi que de quoi boire. Enfin, je devrais dire que pour un shalore, cela pouvait sembler être de la nourriture et de la boisson basiques, mais selon les critères thaloren, j'étais traitée avec un certain faste. Je veux dire, je sais que les nains considèrent l'alcool comme un bien de première nécessité, mais apparemment il en allait de même pour les shalorens, à en juger par la quantité de vin qu'on me donnait. Quoi qu'il en soit, le traitement que je recevais était bien meilleur que ce à quoi je m'étais attendue, c'est certain.

Vers le quatrième jour, après avoir créé un grand nombre d'infusions, on me demanda de monter pour aider à les appliquer. Beaucoup de ceux que je soignais étaient proches de la mort, minés par des infections purulentes causées par le simple fait de bander leurs plaies sans rien faire d'autre. Tout comme je l'avais fait pour les shalorens blessés dans cet abri, je n'utilisai les infusions qu'autant que nécessaire pour les arracher aux portes de la mort. Ce n'était pas vraiment par manque d'infusions, mais plutôt à cause de cet entêtement que les shalorens semblaient éprouver, pour une raison quelconque, envers les infusions.

Ce fut environ une semaine plus tard, alors que la plupart des réfugiés avaient été soignés, que la nouvelle arriva d'un détachement de soldats shaloren revenus de leurs batailles contre les orcs. Apparemment, ils avaient combattu du côté est du continent, aux côtés des Royaumes Humains de l'Est, lorsque la Brûlure Magique survint. Les rares survivants avaient entrepris le voyage de retour vers Elvala, mais avaient été retardés, incapables de traverser directement le centre du continent. Parmi ceux qui avaient survécu, seules quelques centaines étaient parvenues à rentrer vivantes.
...
Au bout d'un moment, le nombre de soldats blessés commença à diminuer, la plupart d'entre eux n'ayant pas besoin de repos après s'être soignés eux-mêmes. Lorsque leur nombre devint plus gérable, le guérisseur en chef s'approcha pour me remercier, au nom des shalorens, pour mes efforts. Me rappelant soudain la véritable raison de ma venue ici, je fis remarquer que je remplissais ma part du marché. Hochant la tête, le guérisseur en chef regarda derrière moi tandis qu'un soldat s'approchait, et répondit : "Le lieutenant vous escortera jusqu'au général." Je fus quelque peu surprise par cela, mais supposai que ce général détenait les réponses aux événements qui s'étaient produits.

Le soldat me conduisit au centre de la ville, où se dressait un grand bâtiment. Après une rencontre avec quelques gardes vêtus de la tête aux pieds d'une armure de plates étincelante, nous fûmes autorisés à entrer. Il fallut plusieurs minutes de marche à travers les couloirs du bâtiment, parcourant apparemment toute sa longueur jusqu'à son extrémité. Je finis par arriver dans une pièce à l'allure luxueuse, ornée de décorations en stralite et en or qui garnissaient les murs, exposant des portraits que je supposai être ceux d'importantes figures de l'histoire shaloren. On me demanda d'y attendre, et le lieutenant me laissa là tandis qu'il entrait dans une pièce voisine.]], "_t")
...
Le shalore se mit alors à me raconter les événements qui avaient conduit jusqu'à ce point. J'appris que la calamité déversée sur les terres avait été nommée la Brûlure Magique, et qu'elle avait été déclenchée dans l'espoir de vaincre les orcs qui, jusque-là, avaient déferlé sur le pays. Bien que les shalorens aient eu les meilleures intentions, les mages en charge avaient perdu le contrôle des vastes énergies qu'ils tentaient de maîtriser, et avaient embrasé les orcs, eux-mêmes, et l'ensemble de Maj'Eyal dans une vague d'énergie destructrice. Une dévastation de toutes sortes balaya le continent, certaines peut-être même n'appartenant pas à notre monde.

J'écoutai en silence tandis qu'on me racontait tout cela, jusqu'à ce que tout m'ait été relaté. Lorsqu'il termina de me conter l'histoire de la Brûlure Magique, j'éprouvai des sentiments mêlés quant à la façon de juger les actions des shalorens. D'un côté, la Brûlure Magique avait été relâchée sur les terres, y laissant des cicatrices qui ne guériraient peut-être jamais, mais je comprenais qu'ils avaient agi pour arrêter ce qu'il croyait être une menace sans précédent. En conséquence de leurs actions également, je savais que tous les shalorens souffraient désormais, et j'avais déjà décidé que c'était là une punition suffisante pour eux.
...
Après un moment, le shalore finit par demander : "Que comptez-vous faire maintenant ?" Bonne question, pensai-je. "Je n'y ai pas vraiment réfléchi", répondis-je. Bien qu'il me tournât toujours le dos, je pouvais sentir le sourire narquois à travers l'arrière de sa tête. Se tournant vers moi, il demanda apparemment : "Je suppose que vous rentrerez probablement vers votre forêt, mais peut-être pourriez-vous faire quelque chose en chemin pour nous aider, nous les shalorens. Seriez-vous intéressée par le transport de quelques provisions d'aide pour nous ?" On dirait que je vais encore être mise à contribution, pensai-je, tout en m'interrogeant un peu sur cette requête.

Avec curiosité, je déclarai : "Je pensais qu'après tout ce que vous m'avez raconté, vous chercheriez à préserver le peu de bonne volonté qu'il vous reste envers les shalorens. Toute aide ne serait-elle pas mieux envoyée par un émissaire shaloren officiel ?" Solennellement, le général répondit : "Ce n'est pas tant que je répugnerais à le faire, mais il est actuellement trop dangereux pour tout shalore de se trouver hors d'Elvala. Avant votre arrivée ici, plusieurs humains venus des terres de l'ouest se sont abattus sur nos frontières, pleins de fureur. Beaucoup des shalorens que vous avez secourus dans les villages isolés ne sont pas tombés victimes de la dévastation de la Brûlure Magique, mais plutôt de la colère des paysans et des fermiers des terres cornacs."
...
Dans mon esprit, les mots de la voix me transperçaient le crâne ; je pouvais sentir la colère qui se cachait derrière cette voix tandis qu'elle continuait de parler. Je vis ceux qui m'entouraient se laisser gagner à la fois par les mots prononcés et par les émotions qui les sous-tendaient. Beaucoup commençaient à dire des choses comme "c'est la faute de la magie" et "à bas la magie", tandis que la voix reprenait : "Bien sûr, nul besoin de vous rappeler la dévastation que vous avez déjà vue de vos propres yeux. Tout comme les actions ayant conduit à l'incendie de l'entrepôt, ce sont les mages shaloren qui ont déchaîné la destruction qui a ravagé les terres et déformé les cieux. C'est comme je continue de le dire : partout où l'on trouve la magie, elle finira par échouer et apporter le malheur."
...
En m'approchant de ce paysage surélevé, je remarquai qu'il s'élevait aussi haut qu'une montagne au loin. En gravissant une colline, je vis comment ces roches contre nature formaient des gouffres tortueux et des pics acérés qu'il serait presque assurément suicidaire de traverser. Me remémorant les soldats shaloren que j'avais soignés à Elvala, je compris rapidement pourquoi ils avaient dû remonter vers le nord pour rentrer chez eux. Le centre du continent, où s'étendaient jadis les Plaines de Midvale, n'existait plus. Les plaines avaient désormais été remplacées par ce mortel labyrinthe de roche qui tuerait assurément quiconque s'y aventurerait, et probablement tous ceux qui vivaient sur les plaines avant la Brûlure Magique.
...
Nous continuâmes à nous enfoncer dans le territoire shaloren, les éclaireurs des fanatiques continuant de nous suivre mais toujours prudents de rester en retrait, sans jamais trop s'approcher. Il nous fallut encore quelques jours avant d'atteindre la lisière du Voile. Me dirigeant vers l'endroit où j'avais initialement traversé le mur de brume pour entrer dans la ville, je fouillai dans mon sac pour récupérer la Rune de Retour que j'avais reçue il y a si longtemps. D'une main tendue, je la présentai au commandant ogre. Je m'attendais à ce qu'il la prenne, mais il se contenta de hocher la tête et de noter : "Une Rune de Retour." Pendant le bref instant suivant, je restai là, la main tendue, le commandant semblant aussi perplexe que moi quant à notre interaction. Ce ne fut clair que lorsque le stratège intervint enfin : "Tu n'as aucune idée de comment fonctionne cette rune que tu tiens, n'est-ce pas ?"
...
"Et voilà, terminé." Satisfaite de son travail, l'ogre fit le tour pour poser ses mains sur mes épaules. "Maintenant, il ne te reste plus qu'à franchir cette barrière et à faire la demande pour notre entrée. Thalore, avant que je te dise comment activer la rune, sache que je te remercie de nous avoir aidés à venir jusqu'ici. Si ce n'était pas pour toi, je... nous, les ogres... nous serions probablement tous morts." Je pus voir les larmes commencer à couler sur le visage de l'ogre tandis qu'elle continuait : "Une fois de plus, il semble que nos vies soient entre tes mains. J'espère que tu parviendras à convaincre les shalorens de nous laisser entrer, mais même si tu n'y arrives pas, je voulais te remercier, nous voulons tous te remercier." Autour de moi, je pouvais voir les autres ogres incliner la tête.

Avec un sourire, je répondis : "Je suis sûre que vous serez admis. Dis-moi ce que je dois faire." Levant la tête tout en essuyant les larmes de son visage, elle me guida à travers le processus d'activation de la rune. Je fis un signe de tête solennel aux ogres avant d'exécuter moi-même les étapes. En un instant, mon environnement changea complètement, tandis que j'entendais l'agitation des shalorens tout autour de moi. Je pouvais sentir une lourde sensation sur ma nuque, à l'endroit où la rune avait été inscrite, mais à part cela, je ne me sentais pas différente. Quelques shalore se tournèrent pour regarder dans ma direction, semblant surpris par mon entrée, bien que moins que je ne l'aurais imaginé. L'un des shalore lança bientôt : "Tu es cette thalore qui nous a aidés auparavant ? Bienvenue à nouveau !"
...
Je fus surprise de constater qu'en abordant le sujet, tant les shalorens que les ogres se montraient tout à fait disposés à m'enseigner. Chez moi, peu de gens étaient intéressés à partager leur savoir avec autrui, quelle qu'en fût la raison, et cela valait même entre membres d'une même famille. L'exception, bien sûr, survenait lorsqu'une nécessité pour la société thaloren existait, comme en temps de guerre ou d'autre calamité, mais même alors, cela restait limité. Je noterai toutefois que les shalorens auxquels je m'adressais avaient tendance à demander quelque chose en échange de leur enseignement, réclamant généralement une compensation monétaire. Les ogres, en revanche, à qui j'avais parlé, se montraient tout à fait disposés à partager leur savoir, et en fait, l'un d'entre eux en particulier semblait presque trop enthousiaste à cette idée.
...
Continuant à me contourner pour se placer devant moi avant de tourner autour vers ma droite, le nécromancien continuait à émettre des "hmm, hmm". S'arrêtant, le nécromancien se remit à méditer à voix haute : "Assez surprenant de vous voir utiliser des runes. Êtes-vous peut-être une criminelle exilée des forêts ? Attendez, qu'est-ce que cette seconde rune que vous avez inscrite ?" Bien que je ne pusse voir le nécromancien, je pouvais sentir son regard intense fixé sur la Rune de Retour inscrite à l'arrière de ma nuque. De derrière retentit une remarque : "Ahh, intéressant. Un motif shaloren, mais à en juger par les marques, il semble qu'un travail d'ogre ait été impliqué dans l'inscription de cette rune, si je ne m'abuse. Assez intrigant."
...
D'après ce que j'ai appris des éclaireurs shaloren, il se passe maintenant beaucoup de choses en dehors des murs d'Elvala pouvant servir de destinations à visiter. Des bandes d'hommes sans foi ni loi parcourent désormais les terres voisines, certains poussés au banditisme par le désespoir, d'autres y voyant une opportunité de dépouiller autrui, du fait que les Nargols ne peuvent plus exercer sur leurs terres le contrôle qu'ils exerçaient autrefois. Malgré notre réclusion, c'est un problème qui nous affecte aussi ici, à Elvala, car le peu d'interactions que nous avons avec le monde extérieur en devient encore plus difficile. On pense qu'un repaire majeur et une zone de préparation pour ces attaques se trouve dans la Vieille Forêt, juste au nord d'ici.
...
Hithre was one of The Teacher's pupils, a Shalore who became one of the first to wield entropic magic in the entirety of Eyal.]], [[In the Age of Dusk, it seemed that the world was ending to many of Eyal's inhabitants. The destruction caused by the Spellblaze left the land withered and scorched. Food was scarce, disease was rampant and everyone was desperate. For a select few, their salvation came from an unlikely visitor. An entity they simply came to knew as The Teacher visited Eyal from somewhere beyond the stars, emerging from an ancient Sher'tul farportal. It discovered a group of survivors in the depths of Eyal which begged it for knowledge, anything they could use as a weapon against the horrors ravaging their world.
...
t("Lessons of Inevitability - Entropic Backlash and Healing", "Lessons of Inevitability - Entropic Backlash and Healing", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[My first lesson to you, my students, is to understand what it means to wield entropy. When using its power, it's impossible to escape its withering touch. Your bodies will suffer from the backlash of your spells and carry a residue of those energies at all times. As such, your ability to recover from wounds and injury will be significantly impaired. However, you can learn to resist this backlash and even manipulate the threads of fate to pass it on to your enemies.

#{italic}#Go check your new spell for detailed information.#{normal}#]], "_t")
t("Lessons of Inevitability - Netherblast", "Lessons of Inevitability - Netherblast", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[For this exercise, you will learn how to manipulate and direct entropic energies. This spell will be your main defence against your foes and will teach you to manage the backlash from using it. Few beings in existence are capable of defending themselves against the Netherblast, so practice with it frequently until you have perfected it.

#{italic}#Go check your new spell for detailed information.#{normal}#]], "_t")
t("Lessons of Inevitability - Fatebreaker", "Lessons of Inevitability - Fatebreaker", "_t")
...
#{italic}#Go check your new spell for detailed information.#{normal}#]], [[This spell will be the most important you will learn from me. Fate is a force made up of many threads. Provided that you understand how the threads all connect to each other, you can manipulate it to your own ends. This spell will allow you to pass on doomed threads from you onto your opponents, escaping from your own preordained death. Remember that this spell should not be used lightly and that some threads do not bend to anyone's will, no matter how hard you pull.

The target dummies have been imbued with fake void energies; use your Fatebreaker on them and then use Netherblast on yourself while low on life. This is a difficult exercise, students. Be aware that you are now risking your life if you execute it wrong.

#{italic}#Go check your new spell for detailed information.#{normal}#]], "_t")
t("Lessons of Inevitability - Unravel Existence", "Lessons of Inevitability - Unravel Existence", "_t")
...
#{italic}#Go check your new spells for detailed information.#{normal}#]], [[The building blocks of all things are held together by innumerable laws. These very laws govern all of reality and are set in stone, in most cases. With proper use of your magic, it's entirely possible to sever these bonds and defy these laws, unraveling your foe's very existence. Not only is your opponent affected by this, but the area around them is too. It creates cracks in reality which allow things to slip through. You must use this moment to call out into the void and bring forth creatures to assist you in battle.
...
t("Lessons of Inevitability - Unravel Existence Failure", "Lessons of Inevitability - Unravel Existence Failure", "_t")
...
...It is too late. Something is coming. Even I do not know what. I knew that this was a mistake.]], [[No, no! Your minds aren't focused enough! I told you that you must have a clear image in your head! Do not let your foolish ambition get the better of you! You can't control what's out there!

...It is too late. Something is coming. Even I do not know what. I knew that this was a mistake.]], "_t")
t("Lessons of Inevitability - Epilogue", "Lessons of Inevitability - Epilogue", "_t")
...
What became of The Teacher is unknown. Perhaps it didn't survive the encounter with the Unspeakable Thing, or perhaps it returned to its home somewhere far beyond Eyal.]], [[Only one person escaped alive from the summoning of the Unspeakable Thing. She believed that, despite the failure of her fellow students and the horror of what she saw, The Teacher's wisdom still had value in the apocalyptic world created by the Spellblaze. After all, is it not better to know about the horrors out there than it is to be ignorant of their existence? She began to pass on the power of entropy onto others, and they too passed it on. The ones who learned this forbidden lore became known as the Cultists of Entropy.
...
t("Loremaster Greynot's Analysis of the Races - Chapter 12 - Krogs", "Loremaster Greynot's Analysis of the Races - Chapter 12 - Krogs", "_t")
...
t("Loremaster Greynot's Analysis of the Races - Chapter 13 - Drems", "Loremaster Greynot's Analysis of the Races - Chapter 13 - Drems", "_t")
...
My first instinct was to lead a charge into the crag and cleanse this terrible place, but I knew this would be a mistake. It will pain all of us deeply to not take action now, but there is no sense in throwing our lives away. For now, we must establish camp and observe this threat.]], [[There have often been reports among our brethren about the presence of a magical aberration near the foot of the dwarven mountains. Until today, we have not been able to trace its source. I had suspected that we would come across the foul abode of a necromancer or maybe some other form of arcane wielder... But what we found was an abomination unlike any I have seen before.
...
t("page from a logbook (2)", "page from a logbook (2)", "_t")
...
t("page from a logbook (3)", "page from a logbook (3)", "_t")
...
As you get your bearings, you can sense that there is something in here with you. Its presence looms over this entire void, filling you with a primordial sense of dread. The battle that will be fought here will be unlike any you have been through. And perhaps it will be your last.]], [[It's cold. Terribly cold. The unreality around you seems to be draining you slowly, making your body lock up and your limbs go stiff. There is entropy at work here, but you can see small patches of light defiantly standing out against the darkness. The warm glow infuses you with vigour, driving away the terrible cold. There must be an antropic force at work here, the only thing which can defeat entropy. You can plainly see that it is fighting a losing battle.
...
t("hypostasis of entropy", "hypostasis of entropy", "_t")
t("A towering manifestation of entropy stands before you. You feel tiny.", "A towering manifestation of entropy stands before you. You feel tiny.", "_t")
t("a new threat (1)", "a new threat (1)", "_t")
...
While the hide of the creature has proven too tough to break through, we have devised a clever method to rid ourselves of it. By feeding it a special artifact, we shall be able to open a portal directly into its soft, vulnerable insides. May it taste the results of our research.]], [[Long have we dwelt in the earth, the light of the surface never touching our sanctuary. We have sought power which few can even guess at and learned to wield the power of the dark ones squirming in the void. But, after our long seclusion, a creature from the depths has come to destroy our fortress. This 'maggot' is a creature which consumes anything in front of it, sliding through the earth and carving a path of destruction. This shall be where it stops. With the power we have gathered, we shall slay this intruder.
...
t("a new threat (2)", "a new threat (2)", "_t")
...
t("a new threat (3)", "a new threat (3)", "_t")
...
t("All of a sudden the floor starts to shake and opens up!", "All of a sudden the floor starts to shake and opens up!", "_t")
t("between a rock and a soft place", "between a rock and a soft place", "_t")
...
With that in mind, my only option is to kill it from the inside. Dunno how I'm going to do that just yet.]], [[You ever gotten yourself into a mess that you didn't know how to get out of? Well, that's kind of where I'm at right now. This thing, whatever it is, just burst out of the ground and swallowed me whole. Normally a girl has to get offered on an altar to monsters to get eaten like this, but it looks like this one just took a fancy to me.
...
t("godflesh", "godflesh", "_t")
t("This strange, rubbery substance appears to be the flesh of some unknown creature. Small sparks of antropic power surge from it at times, filling you with incredible vitality. You suspect that it was part of the Maggot's last meal before it transformed into the monstrosity that swallowed you.", "This strange, rubbery substance appears to be the flesh of some unknown creature. Small sparks of antropic power surge from it at times, filling you with incredible vitality. You suspect that it was part of the Maggot's last meal before it transformed into the monstrosity that swallowed you.", "_t")
...
-- texte non traduit
--[==[
t("The Place Which Does Not Exist", "The Place Which Does Not Exist", "_t")
--]==]
...
--[==[
t("The One That Writes", "The One That Writes", "entity name")
t("A strange creature sporting 7 formless tentacles each with some kind of pen attached. It is ever focused on its book and does not seem to notice you, yet you can feel its hatred and hostility towards you.", "A strange creature sporting 7 formless tentacles each with some kind of pen attached. It is ever focused on its book and does not seem to notice you, yet you can feel its hatred and hostility towards you.", "_t")
t("and written off the story", "and written off the story", "_t")
--]==]
